 ...
 (EVAL-WHEN (:COMPILE-TOPLEVEL :LOAD-TOPLEVEL :EXECUTE)
   ...
   (PROGN
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8703 42
                                   '((:UPPER . 256) (:LOWER . 512)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8826 43
                                   '((:NAN . 0) (:INFINITE . 1) (:ZERO . 2)
                                     (:SUBNORMAL . 3) (:NORMAL . 4))))
    (PROGN
     (DEFPARAMETER +SDL-FALSE+ 0)
     (DEFPARAMETER +SDL-TRUE+ 1)
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8827 44
                                   '((:FALSE . 0) (:TRUE . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8828 45
                                   '((:DUMMY-ENUM-VALUE . 0))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8829 47
    ...
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     ...
     '((#:P8830 (:POINTER SDL-ASSERT-DATA)) (#:P8831 (:STRING))
       (#:P8832 (:STRING)) (#:P8833 :INT)))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8834 50
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8835 55
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8836 63
                                   '((:STOPPED . 0) (:PLAYING . 1)
                                     (:PAUSED . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8837 65
                                   '((:O . 0) (:NO . 1) (:B . 2) (:NB . 3)
                                     (:Z . 4) (:NZ . 5) (:BE . 6) (:NBE . 7)
                                     (:S . 8) (:NS . 9) (:P . 10) (:NP . 11)
                                     (:L . 12) (:NL . 13) (:LE . 14)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8838 66
                                   '((:EQ . 0) (:LT . 1) (:LE . 2)
                                     (:UNUSED . 3) (:NE . 4) (:NLT . 5)
                                     (:NLE . 6))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8839 67
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8840 68
                                   '((:|1_2| . 0) (:P5_2 . 1) (:P5_1 . 2)
                                     (:P75_1P5 . 3))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8841 69
                                   '((:SRC . 0) (:ZERO . 1) (:NAN . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8842 70
                                   '((:A . 240) (:B . 204) (:C . 170))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8843 72
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8844 73
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8845 74
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8846 75
                                   '((:NONE . 0) (:RGB . 1) (:RGBA . 2)
                                     (:ARGB . 3) (:BGR . 4) (:BGRA . 5)
                                     (:ABGR . 6))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8847 76
                                   '((:NONE . 0) (:|332| . 1) (:|4444| . 2)
                                     (:|1555| . 3) (:|5551| . 4) (:|565| . 5)
                                     (:|8888| . 6) (:|2101010| . 7)
                                     (:|1010102| . 8))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8848 77
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8849 85
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8850 86
                                   '((:ADD . 1) (:SUBTRACT . 2)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8851 87
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8852 90
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8853 93
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8854 94
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8855 95
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8856 96
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8857 97
                                   '((:CANCEL . 0) (:BRIEFLY . 1)
                                     (:UNTIL-FOCUSED . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8858 98
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8859 99
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8860 100
                                   '((:DEBUG-FLAG . 1)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8861 101
                                   '((:NONE . 0) (:FLUSH . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8862 102
                                   '((:NO-NOTIFICATION . 0)
                                     (:LOSE-CONTEXT . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8863 103
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8864 104
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8865 105
                                   '((:UNKNOWN . 0) (:RETURN . 13)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8866 106
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8867 109
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8868 110
                                   '((:NORMAL . 0) (:FLIPPED . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8869 113
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8870 114
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8871 117
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8872 119
                                   '((:UNKNOWN . 0) (:XBOX360 . 1)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8873 120
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8874 124
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8875 125
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8876 126
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8877 128
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8878 161
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8879 173
                                   '((:DEFAULT . 0) (:NORMAL . 1)
                                     (:OVERRIDE . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8880 174
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8881 175
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8882 176
                                   '((:ERROR . 16) (:WARNING . 32)
                                     (:INFORMATION . 64)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8883 177
                                   '((:RETURNKEY-DEFAULT . 1)
                                     (:ESCAPEKEY-DEFAULT . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8884 180
                                   '((:BACKGROUND . 0) (:TEXT . 1)
                                     (:BUTTON-BORDER . 2)
                                     (:BUTTON-BACKGROUND . 3)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8885 183
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8886 184
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8887 187
                                   '((:NEAREST . 0) (:LINEAR . 1)
                                     (:BEST . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8888 188
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8889 189
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8890 190
                                   '((:NONE . 0) (:HORIZONTAL . 1)
                                     (:VERTICAL . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8891 193
    ...
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-LINKED-VERSION "TTF_Linked_Version") '(:POINTER SDL-VERSION) 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GET-FREE-TYPE-VERSION "TTF_GetFreeTypeVersion") ':VOID
     '((|major| (:POINTER :INT)) (|minor| (:POINTER :INT))
       (|patch| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GET-HARF-BUZZ-VERSION "TTF_GetHarfBuzzVersion") ':VOID
     '((|major| (:POINTER :INT)) (|minor| (:POINTER :INT))
       (|patch| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-BYTE-SWAPPED-UNICODE "TTF_ByteSwappedUNICODE") ':VOID
     '((|swapped| SDL-BOOL)))
    (AUTOWRAP:DEFINE-FOREIGN-RECORD '_TTF_FONT :STRUCT 0 0 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-ALIAS 'TTF-FONT
                                   '(AUTOWRAP::STRUCT
                                     (_TTF_FONT :BIT-SIZE 0 :BIT-ALIGNMENT 0)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-INIT "TTF_Init") ':INT 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-OPEN-FONT "TTF_OpenFont")
                                      '(:POINTER TTF-FONT)
                                      '((|file| (:STRING)) (|ptsize| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-OPEN-FONT-INDEX "TTF_OpenFontIndex") '(:POINTER TTF-FONT)
     '((|file| (:STRING)) (|ptsize| :INT) (|index| :LONG)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-OPEN-FONT-RW "TTF_OpenFontRW")
                                      '(:POINTER TTF-FONT)
                                      '((|src| (:POINTER SDL-R-WOPS))
                                        (|freesrc| :INT) (|ptsize| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-OPEN-FONT-INDEX-RW "TTF_OpenFontIndexRW") '(:POINTER TTF-FONT)
     '((|src| (:POINTER SDL-R-WOPS)) (|freesrc| :INT) (|ptsize| :INT)
       (|index| :LONG)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-OPEN-FONT-DPI "TTF_OpenFontDPI")
                                      '(:POINTER TTF-FONT)
                                      '((|file| (:STRING)) (|ptsize| :INT)
                                        (|hdpi| :UNSIGNED-INT)
                                        (|vdpi| :UNSIGNED-INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-OPEN-FONT-INDEX-DPI "TTF_OpenFontIndexDPI") '(:POINTER TTF-FONT)
     '((|file| (:STRING)) (|ptsize| :INT) (|index| :LONG)
       (|hdpi| :UNSIGNED-INT) (|vdpi| :UNSIGNED-INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-OPEN-FONT-DPIRW "TTF_OpenFontDPIRW") '(:POINTER TTF-FONT)
     '((|src| (:POINTER SDL-R-WOPS)) (|freesrc| :INT) (|ptsize| :INT)
       (|hdpi| :UNSIGNED-INT) (|vdpi| :UNSIGNED-INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-OPEN-FONT-INDEX-DPIRW "TTF_OpenFontIndexDPIRW") '(:POINTER TTF-FONT)
     '((|src| (:POINTER SDL-R-WOPS)) (|freesrc| :INT) (|ptsize| :INT)
       (|index| :LONG) (|hdpi| :UNSIGNED-INT) (|vdpi| :UNSIGNED-INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-SET-FONT-SIZE "TTF_SetFontSize")
                                      ':INT
                                      '((|font| (:POINTER TTF-FONT))
                                        (|ptsize| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-SET-FONT-SIZE-DPI "TTF_SetFontSizeDPI") ':INT
     '((|font| (:POINTER TTF-FONT)) (|ptsize| :INT) (|hdpi| :UNSIGNED-INT)
       (|vdpi| :UNSIGNED-INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-GET-FONT-STYLE "TTF_GetFontStyle")
                                      ':INT '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-SET-FONT-STYLE "TTF_SetFontStyle")
                                      ':VOID
                                      '((|font| (:POINTER TTF-FONT))
                                        (|style| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GET-FONT-OUTLINE "TTF_GetFontOutline") ':INT
     '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-SET-FONT-OUTLINE "TTF_SetFontOutline") ':VOID
     '((|font| (:POINTER TTF-FONT)) (|outline| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GET-FONT-HINTING "TTF_GetFontHinting") ':INT
     '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-SET-FONT-HINTING "TTF_SetFontHinting") ':VOID
     '((|font| (:POINTER TTF-FONT)) (|hinting| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GET-FONT-WRAPPED-ALIGN "TTF_GetFontWrappedAlign") ':INT
     '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-SET-FONT-WRAPPED-ALIGN "TTF_SetFontWrappedAlign") ':VOID
     '((|font| (:POINTER TTF-FONT)) (|align| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-FONT-HEIGHT "TTF_FontHeight") ':INT
                                      '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-FONT-ASCENT "TTF_FontAscent") ':INT
                                      '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-FONT-DESCENT "TTF_FontDescent")
                                      ':INT '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-FONT-LINE-SKIP "TTF_FontLineSkip")
                                      ':INT '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GET-FONT-KERNING "TTF_GetFontKerning") ':INT
     '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-SET-FONT-KERNING "TTF_SetFontKerning") ':VOID
     '((|font| (:POINTER TTF-FONT)) (|allowed| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-FONT-FACES "TTF_FontFaces") ':LONG
                                      '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-FONT-FACE-IS-FIXED-WIDTH "TTF_FontFaceIsFixedWidth") ':INT
     '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-FONT-FACE-FAMILY-NAME "TTF_FontFaceFamilyName") '(:STRING)
     '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-FONT-FACE-STYLE-NAME "TTF_FontFaceStyleName") '(:STRING)
     '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GLYPH-IS-PROVIDED "TTF_GlyphIsProvided") ':INT
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT16)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GLYPH-IS-PROVIDED32 "TTF_GlyphIsProvided32") ':INT
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-GLYPH-METRICS "TTF_GlyphMetrics")
                                      ':INT
                                      '((|font| (:POINTER TTF-FONT))
                                        (|ch| UINT16) (|minx| (:POINTER :INT))
                                        (|maxx| (:POINTER :INT))
                                        (|miny| (:POINTER :INT))
                                        (|maxy| (:POINTER :INT))
                                        (|advance| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GLYPH-METRICS32 "TTF_GlyphMetrics32") ':INT
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT32) (|minx| (:POINTER :INT))
       (|maxx| (:POINTER :INT)) (|miny| (:POINTER :INT))
       (|maxy| (:POINTER :INT)) (|advance| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-SIZE-TEXT "TTF_SizeText") ':INT
                                      '((|font| (:POINTER TTF-FONT))
                                        (|text| (:STRING))
                                        (|w| (:POINTER :INT))
                                        (|h| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-SIZE-UTF8 "TTF_SizeUTF8") ':INT
                                      '((|font| (:POINTER TTF-FONT))
                                        (|text| (:STRING))
                                        (|w| (:POINTER :INT))
                                        (|h| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-SIZE-UNICODE "TTF_SizeUNICODE")
                                      ':INT
                                      '((|font| (:POINTER TTF-FONT))
                                        (|text| (:POINTER UINT16))
                                        (|w| (:POINTER :INT))
                                        (|h| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-MEASURE-TEXT "TTF_MeasureText")
                                      ':INT
                                      '((|font| (:POINTER TTF-FONT))
                                        (|text| (:STRING))
                                        (|measure_width| :INT)
                                        (|extent| (:POINTER :INT))
                                        (|count| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-MEASURE-UTF8 "TTF_MeasureUTF8")
                                      ':INT
                                      '((|font| (:POINTER TTF-FONT))
                                        (|text| (:STRING))
                                        (|measure_width| :INT)
                                        ...
                                        (|count| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-MEASURE-UNICODE "TTF_MeasureUNICODE") ':INT
     '((|font| (:POINTER TTF-FONT)) (|text| (:POINTER UINT16))
       (|measure_width| :INT) (|extent| (:POINTER :INT))
       (|count| (:POINTER :INT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-TEXT-SOLID "TTF_RenderText_Solid") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UTF8-SOLID "TTF_RenderUTF8_Solid") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UNICODE-SOLID "TTF_RenderUNICODE_Solid")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:POINTER UINT16))
       (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-TEXT-SOLID-WRAPPED "TTF_RenderText_Solid_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UTF8-SOLID-WRAPPED "TTF_RenderUTF8_Solid_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UNICODE-SOLID-WRAPPED "TTF_RenderUNICODE_Solid_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:POINTER UINT16)) (|fg| SDL-COLOR)
       (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-GLYPH-SOLID "TTF_RenderGlyph_Solid") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT16) (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-GLYPH32-SOLID "TTF_RenderGlyph32_Solid")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT32) (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-TEXT-SHADED "TTF_RenderText_Shaded") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UTF8-SHADED "TTF_RenderUTF8_Shaded") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UNICODE-SHADED "TTF_RenderUNICODE_Shaded")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:POINTER UINT16)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-TEXT-SHADED-WRAPPED "TTF_RenderText_Shaded_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR) (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UTF8-SHADED-WRAPPED "TTF_RenderUTF8_Shaded_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR) (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UNICODE-SHADED-WRAPPED "TTF_RenderUNICODE_Shaded_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:POINTER UINT16)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR) (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-GLYPH-SHADED "TTF_RenderGlyph_Shaded")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT16) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-GLYPH32-SHADED "TTF_RenderGlyph32_Shaded")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT32) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-TEXT-BLENDED "TTF_RenderText_Blended")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UTF8-BLENDED "TTF_RenderUTF8_Blended")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UNICODE-BLENDED "TTF_RenderUNICODE_Blended")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:POINTER UINT16))
       (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-TEXT-BLENDED-WRAPPED "TTF_RenderText_Blended_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UTF8-BLENDED-WRAPPED "TTF_RenderUTF8_Blended_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UNICODE-BLENDED-WRAPPED "TTF_RenderUNICODE_Blended_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:POINTER UINT16)) (|fg| SDL-COLOR)
       (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-GLYPH-BLENDED "TTF_RenderGlyph_Blended")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT16) (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-GLYPH32-BLENDED "TTF_RenderGlyph32_Blended")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT32) (|fg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-TEXT-LCD "TTF_RenderText_LCD") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UTF8-LCD "TTF_RenderUTF8_LCD") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UNICODE-LCD "TTF_RenderUNICODE_LCD") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:POINTER UINT16)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-TEXT-LCD-WRAPPED "TTF_RenderText_LCD_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR) (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UTF8-LCD-WRAPPED "TTF_RenderUTF8_LCD_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:STRING)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR) (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-UNICODE-LCD-WRAPPED "TTF_RenderUNICODE_LCD_Wrapped")
     '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|text| (:POINTER UINT16)) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR) (|wrapLength| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-GLYPH-LCD "TTF_RenderGlyph_LCD") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT16) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-RENDER-GLYPH32-LCD "TTF_RenderGlyph32_LCD") '(:POINTER SDL-SURFACE)
     '((|font| (:POINTER TTF-FONT)) (|ch| UINT32) (|fg| SDL-COLOR)
       (|bg| SDL-COLOR)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-CLOSE-FONT "TTF_CloseFont") ':VOID
                                      '((|font| (:POINTER TTF-FONT))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-QUIT "TTF_Quit") ':VOID 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-WAS-INIT "TTF_WasInit") ':INT 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GET-FONT-KERNING-SIZE "TTF_GetFontKerningSize") ':INT
     '((|font| (:POINTER TTF-FONT)) (|prev_index| :INT) (|index| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GET-FONT-KERNING-SIZE-GLYPHS "TTF_GetFontKerningSizeGlyphs") ':INT
     '((|font| (:POINTER TTF-FONT)) (|previous_ch| UINT16) (|ch| UINT16)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-GET-FONT-KERNING-SIZE-GLYPHS32 "TTF_GetFontKerningSizeGlyphs32")
     ':INT
     '((|font| (:POINTER TTF-FONT)) (|previous_ch| UINT32) (|ch| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-SET-FONT-SDF "TTF_SetFontSDF")
                                      ':INT
                                      '((|font| (:POINTER TTF-FONT))
                                        (|on_off| SDL-BOOL)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-GET-FONT-SDF "TTF_GetFontSDF")
                                      'SDL-BOOL
                                      '((|font| (:POINTER TTF-FONT))))
    (PROGN
     (DEFPARAMETER +TTF-DIRECTION-LTR+ 0)
     (DEFPARAMETER +TTF-DIRECTION-RTL+ 1)
     (DEFPARAMETER +TTF-DIRECTION-TTB+ 2)
     (DEFPARAMETER +TTF-DIRECTION-BTT+ 3)
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8892 199
                                   '((:LTR . 0) (:RTL . 1) (:TTB . 2)
                                     (:BTT . 3))))
    (AUTOWRAP:DEFINE-FOREIGN-ALIAS 'TTF-DIRECTION '(:ENUM (NIL :ID 199)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-SET-DIRECTION "TTF_SetDirection")
                                      ':INT '((|direction| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(TTF-SET-SCRIPT "TTF_SetScript") ':INT
                                      '((|script| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-SET-FONT-DIRECTION "TTF_SetFontDirection") ':INT
     '((|font| (:POINTER TTF-FONT)) (|direction| TTF-DIRECTION)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(TTF-SET-FONT-SCRIPT-NAME "TTF_SetFontScriptName") ':INT
     '((|font| (:POINTER TTF-FONT)) (|script| (:STRING))))
    ...
    (DEFPARAMETER +TTF-WRAPPED-ALIGN-RIGHT+ 2)
    (DEFPARAMETER +TTF-WRAPPED-ALIGN-CENTER+ 1)
    (DEFPARAMETER +TTF-WRAPPED-ALIGN-LEFT+ 0)
    (DEFPARAMETER +TTF-HINTING-LIGHT-SUBPIXEL+ 4)
    (DEFPARAMETER +TTF-HINTING-NONE+ 3)
    (DEFPARAMETER +TTF-HINTING-MONO+ 2)
    (DEFPARAMETER +TTF-HINTING-LIGHT+ 1)
    (DEFPARAMETER +TTF-HINTING-NORMAL+ 0)
    (DEFPARAMETER +TTF-STYLE-UNDERLINE+ 4)
    (DEFPARAMETER +TTF-STYLE-STRIKETHROUGH+ 8)
    (DEFPARAMETER +TTF-STYLE-BOLD+ 1)
    (DEFPARAMETER +TTF-STYLE-ITALIC+ 2)
    (DEFPARAMETER +__DEFAULT_FN_ATTRS_CONSTEXPR+ NIL)
    (DEFPARAMETER +TTF-STYLE-NORMAL+ 0)
    ...
    (DEFPARAMETER +UNICODE-BOM-NATIVE+ 65279)
    (DEFPARAMETER +_SIDD_MOST_SIGNIFICANT+ 64)
    (DEFPARAMETER +UNICODE-BOM-SWAPPED+ 65534)
    ...
    (DEFPARAMETER +SDL-TTF-COMPILEDVERSION+ 4200)
    (DEFPARAMETER +_SIDD_POSITIVE_POLARITY+ 0)
    (DEFPARAMETER +_SIDD_CMP_EQUAL_ANY+ 0)
    (DEFPARAMETER +TTF-MAJOR-VERSION+ 2)
    ...
    (DEFPARAMETER +TTF-MINOR-VERSION+ 22)
    (DEFPARAMETER +SDL-TTF-MAJOR-VERSION+ 2)
    (DEFPARAMETER +SDL-TTF-PATCHLEVEL+ 0)
    (DEFPARAMETER +_SIDD_UWORD_OPS+ 1)
    (DEFPARAMETER +SDL-TTF-MINOR-VERSION+ 22)
    ...
    (DEFPARAMETER +TTF-SET-ERROR+ NIL)
    (DEFPARAMETER +TTF-GET-ERROR+ NIL)
   ...
   (AUTOWRAP:DEFINE-WRAPPER (:STRUCT (_TTF_FONT)) #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER TTF-FONT #<PACKAGE "DUMMY">)
   ...
   (AUTOWRAP:DEFINE-ACCESSORS (:STRUCT (_TTF_FONT)) #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS TTF-FONT #<PACKAGE "DUMMY">)
   ...
   (AUTOWRAP:DEFINE-CFUN TTF-LINKED-VERSION #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FREE-TYPE-VERSION #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-HARF-BUZZ-VERSION #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-BYTE-SWAPPED-UNICODE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-INIT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-OPEN-FONT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-OPEN-FONT-INDEX #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-OPEN-FONT-RW #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-OPEN-FONT-INDEX-RW #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-OPEN-FONT-DPI #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-OPEN-FONT-INDEX-DPI #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-OPEN-FONT-DPIRW #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-OPEN-FONT-INDEX-DPIRW #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-SIZE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-SIZE-DPI #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FONT-STYLE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-STYLE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FONT-OUTLINE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-OUTLINE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FONT-HINTING #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-HINTING #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FONT-WRAPPED-ALIGN #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-WRAPPED-ALIGN #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-FONT-HEIGHT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-FONT-ASCENT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-FONT-DESCENT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-FONT-LINE-SKIP #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FONT-KERNING #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-KERNING #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-FONT-FACES #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-FONT-FACE-IS-FIXED-WIDTH #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-FONT-FACE-FAMILY-NAME #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-FONT-FACE-STYLE-NAME #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GLYPH-IS-PROVIDED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GLYPH-IS-PROVIDED32 #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GLYPH-METRICS #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GLYPH-METRICS32 #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SIZE-TEXT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SIZE-UTF8 #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SIZE-UNICODE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-MEASURE-TEXT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-MEASURE-UTF8 #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-MEASURE-UNICODE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-TEXT-SOLID #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UTF8-SOLID #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UNICODE-SOLID #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-TEXT-SOLID-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UTF8-SOLID-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UNICODE-SOLID-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-GLYPH-SOLID #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-GLYPH32-SOLID #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-TEXT-SHADED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UTF8-SHADED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UNICODE-SHADED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-TEXT-SHADED-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UTF8-SHADED-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UNICODE-SHADED-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-GLYPH-SHADED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-GLYPH32-SHADED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-TEXT-BLENDED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UTF8-BLENDED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UNICODE-BLENDED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-TEXT-BLENDED-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UTF8-BLENDED-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UNICODE-BLENDED-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-GLYPH-BLENDED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-GLYPH32-BLENDED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-TEXT-LCD #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UTF8-LCD #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UNICODE-LCD #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-TEXT-LCD-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UTF8-LCD-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-UNICODE-LCD-WRAPPED #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-GLYPH-LCD #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-RENDER-GLYPH32-LCD #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-CLOSE-FONT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-QUIT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-WAS-INIT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FONT-KERNING-SIZE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FONT-KERNING-SIZE-GLYPHS #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FONT-KERNING-SIZE-GLYPHS32 #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-SDF #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-GET-FONT-SDF #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-DIRECTION #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-SCRIPT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-DIRECTION #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN TTF-SET-FONT-SCRIPT-NAME #<PACKAGE "DUMMY">)
   ...
   (EXPORT
    '(TTF-FONT _TTF_FONT SDL-LOCALE SDL-LOCALE SDL-VERSION SDL-VERSION
      SDL-WINDOW-SHAPE-MODE SDL-WINDOW-SHAPE-MODE SDL-WINDOW-SHAPE-PARAMS
      SDL-TEXTURE SDL-TEXTURE SDL-RENDERER SDL-RENDERER SDL-VERTEX SDL-VERTEX
      SDL-RENDERER-INFO SDL-RENDERER-INFO SDL-MESSAGE-BOX-DATA
      SDL-MESSAGE-BOX-COLOR-SCHEME SDL-MESSAGE-BOX-COLOR
      SDL-MESSAGE-BOX-BUTTON-DATA SDL-HID-DEVICE-INFO SDL-HID-DEVICE-INFO
      SDL-HID-DEVICE SDL-HID-DEVICE- SDL-HAPTIC-EFFECT SDL-HAPTIC-EFFECT
      SDL-HAPTIC-CUSTOM SDL-HAPTIC-CUSTOM SDL-HAPTIC-LEFT-RIGHT
      SDL-HAPTIC-LEFT-RIGHT SDL-HAPTIC-RAMP SDL-HAPTIC-RAMP
      SDL-HAPTIC-CONDITION SDL-HAPTIC-CONDITION SDL-HAPTIC-PERIODIC
      SDL-HAPTIC-PERIODIC SDL-HAPTIC-CONSTANT SDL-HAPTIC-CONSTANT
      SDL-HAPTIC-DIRECTION SDL-HAPTIC-DIRECTION SDL-HAPTIC _SDL_HAPTIC
      SDL-EVENT SDL-EVENT SDL-SYS-WM-EVENT SDL-SYS-WM-EVENT SDL-SYS-W-MMSG
      SDL-SYS-W-MMSG SDL-USER-EVENT SDL-USER-EVENT SDL-QUIT-EVENT
      SDL-QUIT-EVENT SDL-SENSOR-EVENT SDL-SENSOR-EVENT SDL-DROP-EVENT
      SDL-DROP-EVENT SDL-DOLLAR-GESTURE-EVENT SDL-DOLLAR-GESTURE-EVENT
      SDL-MULTI-GESTURE-EVENT SDL-MULTI-GESTURE-EVENT SDL-TOUCH-FINGER-EVENT
      SDL-TOUCH-FINGER-EVENT SDL-AUDIO-DEVICE-EVENT SDL-AUDIO-DEVICE-EVENT
      SDL-CONTROLLER-SENSOR-EVENT SDL-CONTROLLER-SENSOR-EVENT
      SDL-CONTROLLER-TOUCHPAD-EVENT SDL-CONTROLLER-TOUCHPAD-EVENT
      SDL-CONTROLLER-DEVICE-EVENT SDL-CONTROLLER-DEVICE-EVENT
      SDL-CONTROLLER-BUTTON-EVENT SDL-CONTROLLER-BUTTON-EVENT
      SDL-CONTROLLER-AXIS-EVENT SDL-CONTROLLER-AXIS-EVENT SDL-JOY-BATTERY-EVENT
      SDL-JOY-BATTERY-EVENT SDL-JOY-DEVICE-EVENT SDL-JOY-DEVICE-EVENT
      SDL-JOY-BUTTON-EVENT SDL-JOY-BUTTON-EVENT SDL-JOY-HAT-EVENT
      SDL-JOY-HAT-EVENT SDL-JOY-BALL-EVENT SDL-JOY-BALL-EVENT
      SDL-JOY-AXIS-EVENT SDL-JOY-AXIS-EVENT SDL-MOUSE-WHEEL-EVENT
      SDL-MOUSE-WHEEL-EVENT SDL-MOUSE-BUTTON-EVENT SDL-MOUSE-BUTTON-EVENT
      SDL-MOUSE-MOTION-EVENT SDL-MOUSE-MOTION-EVENT SDL-TEXT-INPUT-EVENT
      SDL-TEXT-INPUT-EVENT SDL-TEXT-EDITING-EXT-EVENT
      SDL-TEXT-EDITING-EXT-EVENT SDL-TEXT-EDITING-EVENT SDL-TEXT-EDITING-EVENT
      SDL-KEYBOARD-EVENT SDL-KEYBOARD-EVENT SDL-WINDOW-EVENT SDL-WINDOW-EVENT
      SDL-DISPLAY-EVENT SDL-DISPLAY-EVENT SDL-COMMON-EVENT SDL-COMMON-EVENT
      SDL-FINGER SDL-FINGER SDL-GAME-CONTROLLER-BUTTON-BIND
      SDL-GAME-CONTROLLER-BUTTON-BIND SDL-GAME-CONTROLLER _SDL_GAME_CONTROLLER
      SDL-SENSOR _SDL_SENSOR SDL-VIRTUAL-JOYSTICK-DESC
      SDL-VIRTUAL-JOYSTICK-DESC SDL-JOYSTICK _SDL_JOYSTICK SDL-GUID SDL-CURSOR
      SDL-CURSOR SDL-KEYSYM SDL-KEYSYM SDL-WINDOW SDL-WINDOW SDL-DISPLAY-MODE
      SDL-SURFACE SDL-SURFACE SDL-BLIT-MAP SDL-BLIT-MAP SDL-F-RECT SDL-F-RECT
      SDL-RECT SDL-RECT SDL-F-POINT SDL-F-POINT SDL-POINT SDL-POINT
      SDL-PIXEL-FORMAT SDL-PIXEL-FORMAT SDL-PALETTE SDL-PALETTE SDL-COLOR
      SDL-COLOR __TILE1024I __TILE1024I_STR __UINTR_FRAME SDL-AUDIO-STREAM
      _SDL_AUDIO_STREAM SDL-AUDIO-CVT SDL-AUDIO-CVT SDL-AUDIO-SPEC
      SDL-AUDIO-SPEC SDL-R-WOPS SDL-R-WOPS SDL-THREAD SDL-THREAD SDL-COND
      SDL-COND SDL-SEM SDL-SEMAPHORE SDL-MUTEX SDL-MUTEX SDL-ATOMIC-T
      SDL-ASSERT-DATA SDL-ASSERT-DATA SDL-ICONV-T _SDL_ICONV_T IMAXDIV-T TM
      __LOCALE_T __LOCALE_STRUCT __LOCALE_DATA MAX-ALIGN-T DRAND48-DATA
      RANDOM-DATA LLDIV-T LDIV-T DIV-T _IO_WIDE_DATA _IO_CODECVT _IO_MARKER
      FILE __FILE _IO_FILE __FPOS64_T _G_FPOS64_T __FPOS_T _G_FPOS_T
      __MBSTATE_T PTHREAD-BARRIERATTR-T PTHREAD-BARRIER-T PTHREAD-RWLOCKATTR-T
      PTHREAD-RWLOCK-T PTHREAD-COND-T PTHREAD-MUTEX-T PTHREAD-ATTR-T
      PTHREAD-ATTR-T PTHREAD-CONDATTR-T PTHREAD-MUTEXATTR-T __ONCE_FLAG
      __PTHREAD_COND_S __PTHREAD_RWLOCK_ARCH_T __PTHREAD_MUTEX_S
      __PTHREAD_SLIST_T __PTHREAD_INTERNAL_SLIST __PTHREAD_LIST_T
      __PTHREAD_INTERNAL_LIST __ATOMIC_WIDE_COUNTER FD-SET TIMESPEC TIMEVAL
      __SIGSET_T __FSID_T)
    #<PACKAGE "DUMMY">)
   (EXPORT
    '(TTF-SET-FONT-SCRIPT-NAME TTF-SET-FONT-DIRECTION TTF-SET-SCRIPT
                               TTF-SET-DIRECTION TTF-GET-FONT-SDF
                               TTF-SET-FONT-SDF
                               TTF-GET-FONT-KERNING-SIZE-GLYPHS32
                               TTF-GET-FONT-KERNING-SIZE-GLYPHS
                               TTF-GET-FONT-KERNING-SIZE TTF-WAS-INIT TTF-QUIT
                               TTF-CLOSE-FONT TTF-RENDER-GLYPH32-LCD
                               TTF-RENDER-GLYPH-LCD
                               TTF-RENDER-UNICODE-LCD-WRAPPED
                               TTF-RENDER-UTF8-LCD-WRAPPED
                               TTF-RENDER-TEXT-LCD-WRAPPED
                               TTF-RENDER-UNICODE-LCD TTF-RENDER-UTF8-LCD
                               TTF-RENDER-TEXT-LCD TTF-RENDER-GLYPH32-BLENDED
                               ...
                               TTF-RENDER-UTF8-BLENDED TTF-RENDER-TEXT-BLENDED
                               TTF-RENDER-GLYPH32-SHADED
                               TTF-RENDER-GLYPH-SHADED
                               TTF-RENDER-UNICODE-SHADED-WRAPPED
                               TTF-RENDER-UTF8-SHADED-WRAPPED
                               TTF-RENDER-TEXT-SHADED-WRAPPED
                               TTF-RENDER-UNICODE-SHADED TTF-RENDER-UTF8-SHADED
                               TTF-RENDER-TEXT-SHADED TTF-RENDER-GLYPH32-SOLID
                               TTF-RENDER-GLYPH-SOLID
                               TTF-RENDER-UNICODE-SOLID-WRAPPED
                               TTF-RENDER-UTF8-SOLID-WRAPPED
                               TTF-RENDER-TEXT-SOLID-WRAPPED
                               TTF-RENDER-UNICODE-SOLID TTF-RENDER-UTF8-SOLID
                               TTF-RENDER-TEXT-SOLID TTF-MEASURE-UNICODE
                               TTF-MEASURE-UTF8 TTF-MEASURE-TEXT
                               TTF-SIZE-UNICODE TTF-SIZE-UTF8 TTF-SIZE-TEXT
                               TTF-GLYPH-METRICS32 TTF-GLYPH-METRICS
                               TTF-GLYPH-IS-PROVIDED32 TTF-GLYPH-IS-PROVIDED
                               TTF-FONT-FACE-STYLE-NAME
                               TTF-FONT-FACE-FAMILY-NAME
                               TTF-FONT-FACE-IS-FIXED-WIDTH TTF-FONT-FACES
                               TTF-SET-FONT-KERNING TTF-GET-FONT-KERNING
                               TTF-FONT-LINE-SKIP TTF-FONT-DESCENT
                               TTF-FONT-ASCENT TTF-FONT-HEIGHT
                               TTF-SET-FONT-WRAPPED-ALIGN
                               TTF-GET-FONT-WRAPPED-ALIGN TTF-SET-FONT-HINTING
                               TTF-GET-FONT-HINTING TTF-SET-FONT-OUTLINE
                               TTF-GET-FONT-OUTLINE TTF-SET-FONT-STYLE
                               TTF-GET-FONT-STYLE TTF-SET-FONT-SIZE-DPI
                               TTF-SET-FONT-SIZE TTF-OPEN-FONT-INDEX-DPIRW
                               TTF-OPEN-FONT-DPIRW TTF-OPEN-FONT-INDEX-DPI
                               TTF-OPEN-FONT-DPI TTF-OPEN-FONT-INDEX-RW
                               TTF-OPEN-FONT-RW TTF-OPEN-FONT-INDEX
                               TTF-OPEN-FONT TTF-INIT TTF-BYTE-SWAPPED-UNICODE
                               TTF-GET-HARF-BUZZ-VERSION
                               TTF-GET-FREE-TYPE-VERSION TTF-LINKED-VERSION
                               SDL-QUIT SDL-WAS-INIT SDL-QUIT-SUB-SYSTEM
                               SDL-INIT-SUB-SYSTEM SDL-INIT SDL-OPEN-URL
                               SDL-GET-PREFERRED-LOCALES
                               SDL-GET-REVISION-NUMBER SDL-GET-REVISION
                               SDL-GET-VERSION SDL-REMOVE-TIMER SDL-ADD-TIMER
                               SDL-DELAY SDL-GET-PERFORMANCE-FREQUENCY
                               SDL-GET-PERFORMANCE-COUNTER SDL-GET-TICKS64
                               SDL-GET-TICKS
                               ...
                               SDL-GET-SHAPED-WINDOW-MODE SDL-SET-WINDOW-SHAPE
                               SDL-IS-SHAPED-WINDOW SDL-CREATE-SHAPED-WINDOW
                               SDL-RENDER-SET-V-SYNC
                               SDL-RENDER-GET-METAL-COMMAND-ENCODER
                               SDL-RENDER-GET-METAL-LAYER SDL-GL-UNBIND-TEXTURE
                               SDL-GL-BIND-TEXTURE SDL-RENDER-FLUSH
                               SDL-DESTROY-RENDERER SDL-DESTROY-TEXTURE
                               SDL-RENDER-PRESENT SDL-RENDER-READ-PIXELS
                               ...
                               SDL-RENDER-COPY-EX SDL-RENDER-COPY
                               SDL-RENDER-FILL-RECTS SDL-RENDER-FILL-RECT
                               SDL-RENDER-DRAW-RECTS SDL-RENDER-DRAW-RECT
                               SDL-RENDER-DRAW-LINES SDL-RENDER-DRAW-LINE
                               SDL-RENDER-DRAW-POINTS SDL-RENDER-DRAW-POINT
                               SDL-RENDER-CLEAR SDL-GET-RENDER-DRAW-BLEND-MODE
                               ...
                               SDL-GET-RENDER-TARGET SDL-SET-RENDER-TARGET
                               SDL-RENDER-TARGET-SUPPORTED SDL-UNLOCK-TEXTURE
                               SDL-LOCK-TEXTURE-TO-SURFACE SDL-LOCK-TEXTURE
                               SDL-UPDATE-NV-TEXTURE SDL-UPDATE-YUV-TEXTURE
                               ...
                               SDL-CREATE-TEXTURE SDL-GET-RENDERER-OUTPUT-SIZE
                               SDL-GET-RENDERER-INFO SDL-RENDER-GET-WINDOW
                               SDL-GET-RENDERER SDL-CREATE-SOFTWARE-RENDERER
                               SDL-CREATE-RENDERER
                               ...
                               SDL-LOG-GET-OUTPUT-FUNCTION SDL-LOG-MESSAGE-V
                               SDL-LOG-MESSAGE SDL-LOG-CRITICAL SDL-LOG-ERROR
                               SDL-LOG-WARN SDL-LOG-INFO SDL-LOG-DEBUG
                               SDL-LOG-VERBOSE SDL-LOG SDL-LOG-RESET-PRIORITIES
                               SDL-LOG-GET-PRIORITY SDL-LOG-SET-PRIORITY
                               SDL-LOG-SET-ALL-PRIORITY SDL-UNLOAD-OBJECT
                               SDL-LOAD-FUNCTION SDL-LOAD-OBJECT
                               SDL-CLEAR-HINTS SDL-DEL-HINT-CALLBACK
                               SDL-ADD-HINT-CALLBACK SDL-GET-HINT-BOOLEAN
                               SDL-GET-HINT SDL-RESET-HINTS SDL-RESET-HINT
                               SDL-SET-HINT SDL-SET-HINT-WITH-PRIORITY
                               SDL-HID-BLE-SCAN SDL-HID-GET-INDEXED-STRING
                               SDL-HID-GET-SERIAL-NUMBER-STRING
                               SDL-HID-GET-PRODUCT-STRING
                               SDL-HID-GET-MANUFACTURER-STRING SDL-HID-CLOSE
                               SDL-HID-GET-FEATURE-REPORT
                               SDL-HID-SEND-FEATURE-REPORT
                               SDL-HID-SET-NONBLOCKING SDL-HID-READ
                               SDL-HID-READ-TIMEOUT SDL-HID-WRITE
                               SDL-HID-OPEN-PATH SDL-HID-OPEN
                               SDL-HID-FREE-ENUMERATION SDL-HID-ENUMERATE
                               SDL-HID-DEVICE-CHANGE-COUNT SDL-HID-EXIT
                               SDL-HID-INIT SDL-HAPTIC-RUMBLE-STOP
                               SDL-HAPTIC-RUMBLE-PLAY SDL-HAPTIC-RUMBLE-INIT
                               SDL-HAPTIC-RUMBLE-SUPPORTED SDL-HAPTIC-STOP-ALL
                               SDL-HAPTIC-UNPAUSE SDL-HAPTIC-PAUSE
                               SDL-HAPTIC-SET-AUTOCENTER SDL-HAPTIC-SET-GAIN
                               SDL-HAPTIC-GET-EFFECT-STATUS
                               SDL-HAPTIC-DESTROY-EFFECT SDL-HAPTIC-STOP-EFFECT
                               SDL-HAPTIC-RUN-EFFECT SDL-HAPTIC-UPDATE-EFFECT
                               ...
                               SDL-HAPTIC-INDEX SDL-HAPTIC-OPENED
                               SDL-HAPTIC-OPEN SDL-HAPTIC-NAME SDL-NUM-HAPTICS
                               SDL-GET-PREF-PATH SDL-GET-BASE-PATH
                               SDL-REGISTER-EVENTS SDL-EVENT-STATE
                               SDL-FILTER-EVENTS SDL-DEL-EVENT-WATCH
                               SDL-ADD-EVENT-WATCH SDL-GET-EVENT-FILTER
                               SDL-SET-EVENT-FILTER SDL-PUSH-EVENT
                               SDL-WAIT-EVENT-TIMEOUT SDL-WAIT-EVENT
                               SDL-POLL-EVENT SDL-FLUSH-EVENTS SDL-FLUSH-EVENT
                               SDL-HAS-EVENTS SDL-HAS-EVENT SDL-PEEP-EVENTS
                               SDL-PUMP-EVENTS SDL-LOAD-DOLLAR-TEMPLATES
                               SDL-SAVE-DOLLAR-TEMPLATE
                               SDL-SAVE-ALL-DOLLAR-TEMPLATES SDL-RECORD-GESTURE
                               SDL-GET-TOUCH-FINGER SDL-GET-NUM-TOUCH-FINGERS
                               SDL-GET-TOUCH-DEVICE-TYPE SDL-GET-TOUCH-NAME
                               SDL-GET-TOUCH-DEVICE SDL-GET-NUM-TOUCH-DEVICES
                               SDL-GAME-CONTROLLER-GET-APPLE-SF-SYMBOLS-NAME-FOR-AXIS
                               SDL-GAME-CONTROLLER-GET-APPLE-SF-SYMBOLS-NAME-FOR-BUTTON
                               ...
                               SDL-GAME-CONTROLLER-ADD-MAPPINGS-FROM-RW
                               SDL-SENSOR-UPDATE SDL-SENSOR-CLOSE
                               SDL-SENSOR-GET-DATA-WITH-TIMESTAMP
                               SDL-SENSOR-GET-DATA SDL-SENSOR-GET-INSTANCE-ID
                               SDL-SENSOR-GET-NON-PORTABLE-TYPE
                               SDL-SENSOR-GET-TYPE SDL-SENSOR-GET-NAME
                               SDL-SENSOR-FROM-INSTANCE-ID SDL-SENSOR-OPEN
                               SDL-SENSOR-GET-DEVICE-INSTANCE-ID
                               SDL-SENSOR-GET-DEVICE-NON-PORTABLE-TYPE
                               SDL-SENSOR-GET-DEVICE-TYPE
                               SDL-SENSOR-GET-DEVICE-NAME SDL-NUM-SENSORS
                               SDL-UNLOCK-SENSORS SDL-LOCK-SENSORS
                               SDL-JOYSTICK-CURRENT-POWER-LEVEL
                               SDL-JOYSTICK-CLOSE SDL-JOYSTICK-SEND-EFFECT
                               SDL-JOYSTICK-SET-LED
                               SDL-JOYSTICK-HAS-RUMBLE-TRIGGERS
                               SDL-JOYSTICK-HAS-RUMBLE SDL-JOYSTICK-HAS-LED
                               SDL-JOYSTICK-RUMBLE-TRIGGERS SDL-JOYSTICK-RUMBLE
                               SDL-JOYSTICK-GET-BUTTON SDL-JOYSTICK-GET-BALL
                               SDL-JOYSTICK-GET-HAT
                               SDL-JOYSTICK-GET-AXIS-INITIAL-STATE
                               SDL-JOYSTICK-GET-AXIS SDL-JOYSTICK-EVENT-STATE
                               SDL-JOYSTICK-UPDATE SDL-JOYSTICK-NUM-BUTTONS
                               SDL-JOYSTICK-NUM-HATS SDL-JOYSTICK-NUM-BALLS
                               SDL-JOYSTICK-NUM-AXES SDL-JOYSTICK-INSTANCE-ID
                               SDL-JOYSTICK-GET-ATTACHED
                               SDL-GET-JOYSTICK-GUID-INFO
                               SDL-JOYSTICK-GET-GUID-FROM-STRING
                               SDL-JOYSTICK-GET-GUID-STRING
                               SDL-JOYSTICK-GET-TYPE SDL-JOYSTICK-GET-SERIAL
                               SDL-JOYSTICK-GET-FIRMWARE-VERSION
                               SDL-JOYSTICK-GET-PRODUCT-VERSION
                               SDL-JOYSTICK-GET-PRODUCT SDL-JOYSTICK-GET-VENDOR
                               SDL-JOYSTICK-GET-GUID
                               SDL-JOYSTICK-SET-PLAYER-INDEX
                               SDL-JOYSTICK-GET-PLAYER-INDEX SDL-JOYSTICK-PATH
                               SDL-JOYSTICK-NAME SDL-JOYSTICK-SET-VIRTUAL-HAT
                               ...
                               SDL-JOYSTICK-NAME-FOR-INDEX SDL-NUM-JOYSTICKS
                               SDL-UNLOCK-JOYSTICKS SDL-LOCK-JOYSTICKS
                               SDL-GUID-FROM-STRING SDL-GUID-TO-STRING
                               SDL-SHOW-CURSOR SDL-FREE-CURSOR
                               SDL-GET-DEFAULT-CURSOR SDL-GET-CURSOR
                               ...
                               SDL-WARP-MOUSE-GLOBAL SDL-WARP-MOUSE-IN-WINDOW
                               ...
                               SDL-SET-TEXT-INPUT-RECT SDL-IS-TEXT-INPUT-SHOWN
                               SDL-CLEAR-COMPOSITION SDL-STOP-TEXT-INPUT
                               SDL-IS-TEXT-INPUT-ACTIVE SDL-START-TEXT-INPUT
                               SDL-GET-KEY-FROM-NAME SDL-GET-KEY-NAME
                               SDL-GET-SCANCODE-FROM-NAME SDL-GET-SCANCODE-NAME
                               SDL-GET-SCANCODE-FROM-KEY
                               SDL-GET-KEY-FROM-SCANCODE SDL-SET-MOD-STATE
                               SDL-GET-MOD-STATE SDL-RESET-KEYBOARD
                               ...
                               SDL-SET-WINDOW-MODAL-FOR SDL-GET-WINDOW-OPACITY
                               SDL-SET-WINDOW-OPACITY SDL-GET-WINDOW-BRIGHTNESS
                               SDL-SET-WINDOW-BRIGHTNESS
                               SDL-GET-WINDOW-MOUSE-RECT
                               SDL-SET-WINDOW-MOUSE-RECT SDL-GET-GRABBED-WINDOW
                               SDL-GET-WINDOW-MOUSE-GRAB
                               SDL-GET-WINDOW-KEYBOARD-GRAB SDL-GET-WINDOW-GRAB
                               SDL-SET-WINDOW-MOUSE-GRAB
                               SDL-SET-WINDOW-KEYBOARD-GRAB SDL-SET-WINDOW-GRAB
                               SDL-DESTROY-WINDOW-SURFACE
                               SDL-UPDATE-WINDOW-SURFACE-RECTS
                               SDL-UPDATE-WINDOW-SURFACE SDL-GET-WINDOW-SURFACE
                               SDL-HAS-WINDOW-SURFACE SDL-SET-WINDOW-FULLSCREEN
                               SDL-RESTORE-WINDOW SDL-MINIMIZE-WINDOW
                               SDL-MAXIMIZE-WINDOW SDL-RAISE-WINDOW
                               SDL-HIDE-WINDOW SDL-SHOW-WINDOW
                               ...
                               SDL-GET-WINDOW-SIZE-IN-PIXELS
                               SDL-GET-WINDOW-BORDERS-SIZE SDL-GET-WINDOW-SIZE
                               SDL-SET-WINDOW-SIZE SDL-GET-WINDOW-POSITION
                               SDL-SET-WINDOW-POSITION SDL-GET-WINDOW-DATA
                               SDL-SET-WINDOW-DATA SDL-SET-WINDOW-ICON
                               SDL-GET-WINDOW-TITLE SDL-SET-WINDOW-TITLE
                               SDL-GET-WINDOW-FLAGS SDL-GET-WINDOW-FROM-ID
                               SDL-GET-WINDOW-ID SDL-CREATE-WINDOW-FROM
                               SDL-CREATE-WINDOW SDL-GET-WINDOW-PIXEL-FORMAT
                               ...
                               SDL-GET-DISPLAY-BOUNDS SDL-GET-DISPLAY-NAME
                               SDL-GET-NUM-VIDEO-DISPLAYS
                               SDL-GET-CURRENT-VIDEO-DRIVER SDL-VIDEO-QUIT
                               SDL-VIDEO-INIT SDL-GET-VIDEO-DRIVER
                               ...
                               SDL-SOFT-STRETCH-LINEAR SDL-SOFT-STRETCH
                               SDL-LOWER-BLIT SDL-UPPER-BLIT SDL-FILL-RECTS
                               SDL-FILL-RECT SDL-PREMULTIPLY-ALPHA
                               SDL-CONVERT-PIXELS SDL-CONVERT-SURFACE-FORMAT
                               SDL-CONVERT-SURFACE SDL-DUPLICATE-SURFACE
                               SDL-GET-CLIP-RECT SDL-SET-CLIP-RECT
                               ...
                               SDL-SET-SURFACE-COLOR-MOD SDL-GET-COLOR-KEY
                               SDL-HAS-COLOR-KEY SDL-SET-COLOR-KEY
                               SDL-HAS-SURFACE-RLE SDL-SET-SURFACE-RLE
                               SDL-SAVE-BMP-RW SDL-LOAD-BMP-RW
                               SDL-UNLOCK-SURFACE SDL-LOCK-SURFACE
                               ...
                               SDL-ENCLOSE-F-POINTS SDL-UNION-F-RECT
                               SDL-INTERSECT-F-RECT SDL-HAS-INTERSECTION-F
                               SDL-INTERSECT-RECT-AND-LINE SDL-ENCLOSE-POINTS
                               SDL-UNION-RECT SDL-INTERSECT-RECT
                               SDL-HAS-INTERSECTION SDL-CALCULATE-GAMMA-RAMP
                               SDL-GET-RGBA SDL-GET-RGB SDL-MAP-RGBA
                               SDL-MAP-RGB SDL-FREE-PALETTE
                               SDL-SET-PALETTE-COLORS
                               SDL-SET-PIXEL-FORMAT-PALETTE SDL-ALLOC-PALETTE
                               SDL-FREE-FORMAT SDL-ALLOC-FORMAT
                               SDL-MASKS-TO-PIXEL-FORMAT-ENUM
                               SDL-PIXEL-FORMAT-ENUM-TO-MASKS
                               SDL-GET-PIXEL-FORMAT-NAME SDL-SIMD-FREE
                               SDL-SIMD-REALLOC SDL-SIMD-ALLOC
                               SDL-SIMD-GET-ALIGNMENT SDL-GET-SYSTEM-RAM
                               SDL-HAS-LASX SDL-HAS-LSX SDL-HAS-NEON
                               SDL-HAS-ARMSIMD SDL-HAS-AVX512F SDL-HAS-AVX2
                               SDL-HAS-AVX SDL-HAS-SSE42 SDL-HAS-SSE41
                               SDL-HAS-SSE3 SDL-HAS-SSE2 SDL-HAS-SSE
                               SDL-HAS3D-NOW SDL-HAS-MMX SDL-HAS-ALTI-VEC
                               SDL-HAS-RDTSC SDL-GET-CPU-CACHE-LINE-SIZE
                               SDL-GET-CPU-COUNT __TILE_CMMRLFP16PS
                               __TILE_CMMIMFP16PS _MM_PAUSE _MM_MFENCE
                               _MM_LFENCE _MM_CLFLUSH _MM_SETCSR _MM_GETCSR
                               _MM_SFENCE POSIX-MEMALIGN
                               SDL-HAS-PRIMARY-SELECTION-TEXT
                               SDL-GET-PRIMARY-SELECTION-TEXT
                               SDL-SET-PRIMARY-SELECTION-TEXT
                               SDL-HAS-CLIPBOARD-TEXT SDL-GET-CLIPBOARD-TEXT
                               SDL-SET-CLIPBOARD-TEXT SDL-CLOSE-AUDIO-DEVICE
                               SDL-CLOSE-AUDIO SDL-UNLOCK-AUDIO-DEVICE
                               SDL-UNLOCK-AUDIO SDL-LOCK-AUDIO-DEVICE
                               SDL-LOCK-AUDIO SDL-CLEAR-QUEUED-AUDIO
                               SDL-GET-QUEUED-AUDIO-SIZE SDL-DEQUEUE-AUDIO
                               SDL-QUEUE-AUDIO SDL-MIX-AUDIO-FORMAT
                               ...
                               SDL-CONVERT-AUDIO SDL-BUILD-AUDIO-CVT
                               SDL-FREE-WAV SDL-LOAD-WAV-RW
                               ...
                               SDL-GET-NUM-AUDIO-DRIVERS SDL-WRITE-BE64
                               SDL-WRITE-LE64 SDL-WRITE-BE32 SDL-WRITE-LE32
                               SDL-WRITE-BE16 SDL-WRITE-LE16 SDL-WRITE-U8
                               SDL-READ-BE64 SDL-READ-LE64 SDL-READ-BE32
                               SDL-READ-LE32 SDL-READ-BE16 SDL-READ-LE16
                               SDL-READ-U8 SDL-LOAD-FILE SDL-LOAD-FILE-RW
                               SDL-R-WCLOSE SDL-R-WWRITE SDL-R-WREAD
                               SDL-R-WTELL SDL-R-WSEEK SDL-R-WSIZE SDL-FREE-RW
                               SDL-ALLOC-RW SDL-RW-FROM-CONST-MEM
                               SDL-RW-FROM-MEM SDL-RW-FROM-FP SDL-RW-FROM-FILE
                               SDL-TLS-CLEANUP SDL-TLS-SET SDL-TLS-GET
                               SDL-TLS-CREATE SDL-DETACH-THREAD SDL-WAIT-THREAD
                               SDL-SET-THREAD-PRIORITY SDL-GET-THREAD-ID
                               SDL-THREAD-ID SDL-GET-THREAD-NAME
                               SDL-CREATE-THREAD-WITH-STACK-SIZE
                               SDL-CREATE-THREAD SDL-COND-WAIT-TIMEOUT
                               SDL-COND-WAIT SDL-COND-BROADCAST SDL-COND-SIGNAL
                               SDL-DESTROY-COND SDL-CREATE-COND SDL-SEM-VALUE
                               SDL-SEM-POST SDL-SEM-WAIT-TIMEOUT
                               SDL-SEM-TRY-WAIT SDL-SEM-WAIT
                               SDL-DESTROY-SEMAPHORE SDL-CREATE-SEMAPHORE
                               SDL-DESTROY-MUTEX SDL-UNLOCK-MUTEX
                               SDL-TRY-LOCK-MUTEX SDL-LOCK-MUTEX
                               SDL-CREATE-MUTEX SDL-ERROR SDL-CLEAR-ERROR
                               SDL-GET-ERROR-MSG SDL-GET-ERROR SDL-SET-ERROR
                               SDL-ATOMIC-GET-PTR SDL-ATOMIC-SET-PTR
                               SDL-ATOMIC-CAS-PTR SDL-ATOMIC-ADD SDL-ATOMIC-GET
                               SDL-ATOMIC-SET SDL-ATOMIC-CAS
                               SDL-MEMORY-BARRIER-ACQUIRE-FUNCTION
                               SDL-MEMORY-BARRIER-RELEASE-FUNCTION
                               SDL-ATOMIC-UNLOCK SDL-ATOMIC-LOCK
                               SDL-ATOMIC-TRY-LOCK SDL-RESET-ASSERTION-REPORT
                               ...
                               SDL-SET-MAIN-READY SDL-MAIN SDL-ICONV-STRING
                               SDL-ICONV SDL-ICONV-CLOSE SDL-ICONV-OPEN
                               SDL-TANF SDL-TAN SDL-SQRTF SDL-SQRT SDL-SINF
                               SDL-SIN SDL-SCALBNF SDL-SCALBN SDL-LROUNDF
                               SDL-LROUND SDL-ROUNDF SDL-ROUND SDL-POWF SDL-POW
                               SDL-LOG10F SDL-LOG10 SDL-LOGF SDL-LOG SDL-FMODF
                               SDL-FMOD SDL-TRUNCF SDL-TRUNC SDL-FLOORF
                               SDL-FLOOR SDL-FABSF SDL-FABS SDL-EXPF SDL-EXP
                               SDL-COSF SDL-COS SDL-COPYSIGNF SDL-COPYSIGN
                               SDL-CEILF SDL-CEIL SDL-ATAN2F SDL-ATAN2
                               SDL-ATANF SDL-ATAN SDL-ASINF SDL-ASIN SDL-ACOSF
                               SDL-ACOS SDL-VASPRINTF SDL-ASPRINTF
                               SDL-VSNPRINTF SDL-SNPRINTF SDL-VSSCANF
                               SDL-SSCANF SDL-STRNCASECMP SDL-STRCASECMP
                               SDL-STRNCMP SDL-STRCMP SDL-STRTOD SDL-STRTOULL
                               SDL-STRTOLL SDL-STRTOUL SDL-STRTOL SDL-ATOF
                               SDL-ATOI SDL-ULLTOA SDL-LLTOA SDL-ULTOA SDL-LTOA
                               SDL-UITOA SDL-ITOA SDL-UTF8STRNLEN
                               SDL-UTF8STRLEN SDL-STRTOKR SDL-STRCASESTR
                               SDL-STRSTR SDL-STRRCHR SDL-STRCHR SDL-STRLWR
                               SDL-STRUPR SDL-STRREV SDL-STRDUP SDL-STRLCAT
                               SDL-UTF8STRLCPY SDL-STRLCPY SDL-STRLEN
                               SDL-WCSNCASECMP SDL-WCSCASECMP SDL-WCSNCMP
                               SDL-WCSCMP SDL-WCSSTR SDL-WCSDUP SDL-WCSLCAT
                               SDL-WCSLCPY SDL-WCSLEN SDL-MEMCMP SDL-MEMMOVE
                               SDL-MEMCPY SDL-MEMSET SDL-CRC32 SDL-CRC16
                               SDL-TOLOWER SDL-TOUPPER SDL-ISGRAPH SDL-ISPRINT
                               SDL-ISLOWER SDL-ISUPPER SDL-ISSPACE SDL-ISPUNCT
                               SDL-ISXDIGIT SDL-ISDIGIT SDL-ISCNTRL SDL-ISBLANK
                               SDL-ISALNUM SDL-ISALPHA SDL-ABS SDL-BSEARCH
                               SDL-QSORT SDL-SETENV SDL-GETENV
                               SDL-GET-NUM-ALLOCATIONS SDL-SET-MEMORY-FUNCTIONS
                               SDL-GET-MEMORY-FUNCTIONS
                               SDL-GET-ORIGINAL-MEMORY-FUNCTIONS SDL-FREE
                               SDL-REALLOC SDL-CALLOC SDL-MALLOC __SCALBL
                               SCALBL __FMAL FMAL __FMINL FMINL __FMAXL FMAXL
                               __FDIML FDIML __LLROUNDL LLROUNDL __LROUNDL
                               LROUNDL __LLRINTL LLRINTL __LRINTL LRINTL
                               __REMQUOL REMQUOL __TRUNCL TRUNCL __ROUNDL
                               ROUNDL __NEARBYINTL NEARBYINTL __SCALBLNL
                               SCALBLNL __ILOGBL ILOGBL __SCALBNL SCALBNL
                               __REMAINDERL REMAINDERL __NEXTTOWARDL
                               NEXTTOWARDL __NEXTAFTERL NEXTAFTERL __RINTL
                               RINTL __LGAMMAL_R LGAMMAL-R __GAMMAL GAMMAL
                               __TGAMMAL TGAMMAL __LGAMMAL LGAMMAL __ERFCL
                               ERFCL __ERFL ERFL __YNL YNL |__Y1L| Y1L |__Y0L|
                               Y0L __JNL JNL |__J1L| J1L |__J0L| J0L ISNANL
                               __NANL NANL __COPYSIGNL COPYSIGNL __SIGNIFICANDL
                               SIGNIFICANDL __DREML DREML FINITEL ISINFL
                               __FMODL FMODL __FLOORL FLOORL __FABSL FABSL
                               __CEILL CEILL __CBRTL CBRTL __HYPOTL HYPOTL
                               __SQRTL SQRTL __POWL POWL __LOG2L LOG2L __EXP2L
                               EXP2L __LOGBL LOGBL __LOG1PL LOG1PL __EXPM1L
                               EXPM1L __MODFL MODFL __LOG10L LOG10L __LOGL LOGL
                               __LDEXPL LDEXPL __FREXPL FREXPL __EXPL EXPL
                               __ATANHL ATANHL __ASINHL ASINHL __ACOSHL ACOSHL
                               __TANHL TANHL __SINHL SINHL __COSHL COSHL __TANL
                               TANL __SINL SINL __COSL COSL __ATAN2L ATAN2L
                               __ATANL ATANL __ASINL ASINL __ACOSL ACOSL
                               __ISSIGNALINGL __ISEQSIGL __ISNANL __FINITEL
                               __ISINFL __SIGNBITL __FPCLASSIFYL __SCALBF
                               SCALBF __FMAF FMAF __FMINF FMINF __FMAXF FMAXF
                               __FDIMF FDIMF __LLROUNDF LLROUNDF __LROUNDF
                               LROUNDF __LLRINTF LLRINTF __LRINTF LRINTF
                               __REMQUOF REMQUOF __TRUNCF TRUNCF __ROUNDF
                               ROUNDF __NEARBYINTF NEARBYINTF __SCALBLNF
                               SCALBLNF __ILOGBF ILOGBF __SCALBNF SCALBNF
                               __REMAINDERF REMAINDERF __NEXTTOWARDF
                               NEXTTOWARDF __NEXTAFTERF NEXTAFTERF __RINTF
                               RINTF __LGAMMAF_R LGAMMAF-R __GAMMAF GAMMAF
                               __TGAMMAF TGAMMAF __LGAMMAF LGAMMAF __ERFCF
                               ERFCF __ERFF ERFF __YNF YNF |__Y1F| Y1F |__Y0F|
                               Y0F __JNF JNF |__J1F| J1F |__J0F| J0F ISNANF
                               __NANF NANF __COPYSIGNF COPYSIGNF __SIGNIFICANDF
                               SIGNIFICANDF __DREMF DREMF FINITEF ISINFF
                               __FMODF FMODF __FLOORF FLOORF __FABSF FABSF
                               __CEILF CEILF __CBRTF CBRTF __HYPOTF HYPOTF
                               __SQRTF SQRTF __POWF POWF __LOG2F LOG2F __EXP2F
                               EXP2F __LOGBF LOGBF __LOG1PF LOG1PF __EXPM1F
                               EXPM1F __MODFF MODFF __LOG10F LOG10F __LOGF LOGF
                               __LDEXPF LDEXPF __FREXPF FREXPF __EXPF EXPF
                               __ATANHF ATANHF __ASINHF ASINHF __ACOSHF ACOSHF
                               __TANHF TANHF __SINHF SINHF __COSHF COSHF __TANF
                               TANF __SINF SINF __COSF COSF __ATAN2F ATAN2F
                               __ATANF ATANF __ASINF ASINF __ACOSF ACOSF
                               __ISSIGNALINGF __ISEQSIGF __ISNANF __FINITEF
                               __ISINFF __SIGNBITF __FPCLASSIFYF __SCALB SCALB
                               __FMA FMA __FMIN FMIN __FMAX FMAX __FDIM FDIM
                               __LLROUND LLROUND __LROUND LROUND __LLRINT
                               LLRINT __LRINT LRINT __REMQUO REMQUO __TRUNC
                               TRUNC __ROUND ROUND __NEARBYINT NEARBYINT
                               __SCALBLN SCALBLN __ILOGB ILOGB __SCALBN SCALBN
                               __REMAINDER REMAINDER __NEXTTOWARD NEXTTOWARD
                               __NEXTAFTER NEXTAFTER __RINT RINT __LGAMMA_R
                               LGAMMA-R __GAMMA GAMMA __TGAMMA TGAMMA __LGAMMA
                               LGAMMA __ERFC ERFC __ERF ERF __YN YN |__Y1| Y1
                               |__Y0| Y0 __JN JN |__J1| J1 |__J0| J0 ISNAN
                               __NAN NAN __COPYSIGN COPYSIGN __SIGNIFICAND
                               SIGNIFICAND __DREM DREM FINITE ISINF __FMOD FMOD
                               __FLOOR FLOOR __FABS FABS __CEIL CEIL __CBRT
                               CBRT __HYPOT HYPOT __SQRT SQRT __POW POW __LOG2
                               LOG2 __EXP2 EXP2 __LOGB LOGB __LOG1P LOG1P
                               __EXPM1 EXPM1 __MODF MODF __LOG10 LOG10 __LOG
                               LOG __LDEXP LDEXP __FREXP FREXP __EXP EXP
                               __ATANH ATANH __ASINH ASINH __ACOSH ACOSH __TANH
                               TANH __SINH SINH __COSH COSH __TAN TAN __SIN SIN
                               __COS COS __ATAN2 ATAN2 __ATAN ATAN __ASIN ASIN
                               __ACOS ACOS __ISSIGNALING __ISEQSIG __ISNAN
                               __FINITE __ISINF __SIGNBIT __FPCLASSIFY
                               TOUPPER-L __TOUPPER_L TOLOWER-L __TOLOWER_L
                               ISBLANK-L ISXDIGIT-L ISUPPER-L ISSPACE-L
                               ISPUNCT-L ISPRINT-L ISGRAPH-L ISLOWER-L
                               ISDIGIT-L ISCNTRL-L ISALPHA-L ISALNUM-L _TOLOWER
                               _TOUPPER TOASCII ISASCII ISBLANK TOUPPER TOLOWER
                               ISXDIGIT ISUPPER ISSPACE ISPUNCT ISPRINT ISGRAPH
                               ISLOWER ISDIGIT ISCNTRL ISALPHA ISALNUM
                               __CTYPE_TOUPPER_LOC __CTYPE_TOLOWER_LOC
                               __CTYPE_B_LOC WCSTOUMAX WCSTOIMAX STRTOUMAX
                               STRTOIMAX IMAXDIV IMAXABS WCSFTIME UNGETWC
                               FPUTWS FGETWS PUTWCHAR PUTWC FPUTWC GETWCHAR
                               GETWC FGETWC VSWSCANF VWSCANF VFWSCANF VSWSCANF
                               VWSCANF VFWSCANF SWSCANF WSCANF FWSCANF SWSCANF
                               WSCANF FWSCANF VSWPRINTF VWPRINTF VFWPRINTF
                               SWPRINTF WPRINTF FWPRINTF FWIDE OPEN-WMEMSTREAM
                               WCPNCPY WCPCPY WCSTOULL WCSTOLL WCSTOUL WCSTOL
                               WCSTOLD WCSTOF WCSTOD WCSNRTOMBS MBSNRTOWCS
                               WCSRTOMBS MBSRTOWCS MBRLEN __MBRLEN WCRTOMB
                               MBRTOWC MBSINIT WCTOB BTOWC WMEMSET WMEMMOVE
                               WMEMCPY WMEMCMP WMEMCHR WCSNLEN WCSLEN WCSTOK
                               WCSSTR WCSPBRK WCSSPN WCSCSPN WCSRCHR WCSCHR
                               WCSDUP WCSXFRM-L WCSCOLL-L WCSXFRM WCSCOLL
                               WCSNCASECMP-L WCSCASECMP-L WCSNCASECMP
                               WCSCASECMP WCSNCMP WCSCMP WCSNCAT WCSCAT WCSNCPY
                               WCSCPY STPNCPY __STPNCPY STPCPY __STPCPY
                               STRSIGNAL STRSEP EXPLICIT-BZERO STRNCASECMP-L
                               STRCASECMP-L STRNCASECMP STRCASECMP FFSLL FFSL
                               FFS RINDEX INDEX BZERO BCOPY BCMP STRERROR-L
                               STRERROR-R STRERROR STRNLEN STRLEN STRTOK-R
                               __STRTOK_R STRTOK STRSTR STRPBRK STRSPN STRCSPN
                               STRRCHR STRCHR STRNDUP STRDUP STRXFRM-L
                               STRCOLL-L STRXFRM STRCOLL STRNCMP STRCMP STRNCAT
                               STRCAT STRNCPY STRCPY MEMCHR __MEMCMPEQ MEMCMP
                               MEMSET MEMCCPY MEMMOVE MEMCPY GETLOADAVG
                               GETSUBOPT RPMATCH WCSTOMBS MBSTOWCS WCTOMB
                               MBTOWC MBLEN QFCVT-R QECVT-R FCVT-R ECVT-R QGCVT
                               QFCVT QECVT GCVT FCVT ECVT LLDIV LDIV DIV LLABS
                               LABS ABS QSORT BSEARCH REALPATH SYSTEM MKDTEMP
                               MKSTEMPS MKSTEMP MKTEMP CLEARENV UNSETENV SETENV
                               PUTENV GETENV _EXIT QUICK-EXIT EXIT ON-EXIT
                               AT-QUICK-EXIT ATEXIT ABORT ALIGNED-ALLOC
                               POSIX-MEMALIGN VALLOC ALLOCA REALLOCARRAY
                               REALLOCARRAY FREE REALLOC CALLOC MALLOC
                               ARC4RANDOM-UNIFORM ARC4RANDOM-BUF ARC4RANDOM
                               LCONG48-R SEED48-R SRAND48-R JRAND48-R MRAND48-R
                               NRAND48-R LRAND48-R ERAND48-R DRAND48-R LCONG48
                               SEED48 SRAND48 JRAND48 MRAND48 NRAND48 LRAND48
                               ERAND48 DRAND48 RAND-R SRAND RAND SETSTATE-R
                               INITSTATE-R SRANDOM-R RANDOM-R SETSTATE
                               INITSTATE SRANDOM RANDOM A64L L64A STRTOULL
                               STRTOLL STRTOUQ STRTOQ STRTOUL STRTOL STRTOLD
                               STRTOF STRTOD ATOLL ATOL ATOI ATOF
                               __CTYPE_GET_MB_CUR_MAX __OVERFLOW __UFLOW
                               FUNLOCKFILE FTRYLOCKFILE FLOCKFILE CTERMID POPEN
                               PCLOSE FILENO-UNLOCKED FILENO PERROR
                               FERROR-UNLOCKED FEOF-UNLOCKED CLEARERR-UNLOCKED
                               FERROR FEOF CLEARERR FSETPOS FGETPOS FTELLO
                               FSEEKO REWIND FTELL FSEEK FWRITE-UNLOCKED
                               FREAD-UNLOCKED FWRITE FREAD UNGETC PUTS FPUTS
                               GETLINE GETDELIM __GETDELIM FGETS PUTW GETW
                               PUTCHAR-UNLOCKED PUTC-UNLOCKED FPUTC-UNLOCKED
                               PUTCHAR PUTC FPUTC FGETC-UNLOCKED
                               GETCHAR-UNLOCKED GETC-UNLOCKED GETCHAR GETC
                               FGETC VSSCANF VSCANF VFSCANF VSSCANF VSCANF
                               VFSCANF SSCANF SCANF FSCANF SSCANF SCANF FSCANF
                               DPRINTF VDPRINTF VSNPRINTF SNPRINTF VSPRINTF
                               VPRINTF VFPRINTF SPRINTF PRINTF FPRINTF
                               SETLINEBUF SETBUFFER SETVBUF SETBUF
                               OPEN-MEMSTREAM FMEMOPEN FDOPEN FREOPEN FOPEN
                               FFLUSH-UNLOCKED FFLUSH TEMPNAM TMPNAM-R TMPNAM
                               TMPFILE FCLOSE RENAMEAT RENAME REMOVE PSELECT
                               SELECT SDL-GET-PLATFORM)
    #<PACKAGE "DUMMY">)
   (EXPORT '(SIGNGAM STDERR STDOUT STDIN) #<PACKAGE "DUMMY">)
   (EXPORT
    '(+SDL-AUDIOCVT-MAX-FILTERS+ +TTF-GET-ERROR+ +TTF-SET-ERROR+ +AUDIO-F32LSB+
      +AUDIO-F32+ +AUDIO-F32MSB+ +AUDIO-S16SYS+ +AUDIO-U16SYS+
      +_BITS_UINTN_IDENTITY_H+ +AUDIO-F32SYS+ +SDL-AUDIO-ALLOW-CHANNELS-CHANGE+
      +AUDIO-S32SYS+ +SDL-AUDIO-ALLOW-FORMAT-CHANGE+
      +SDL-AUDIO-ALLOW-FREQUENCY-CHANGE+ +SDL-AUDIO-ALLOW-SAMPLES-CHANGE+
      +SDL-AUDIO-ALLOW-ANY-CHANGE+ +_SYS_SELECT_H+ +__SIGSET_T_DEFINED+
      +_SIGSET_NWORDS+ +FLT-MANT-DIG+ +DBL-MANT-DIG+ +LDBL-MANT-DIG+
      +DECIMAL-DIG+ +FLT-DIG+ +DBL-DIG+ +_STRUCT_TIMESPEC+ +LDBL-DIG+
      +FLT-MIN-EXP+ +DBL-MIN-EXP+ +LDBL-MIN-EXP+ +FLT-MIN-10-EXP+
      +DBL-MIN-10-EXP+ +LDBL-MIN-10-EXP+ +__TIMEVAL_DEFINED+ +FLT-MAX-EXP+
      +DBL-MAX-EXP+ +NFDBITS+ +LDBL-MAX-EXP+ +FD-SETSIZE+ +FLT-MAX-10-EXP+
      +DBL-MAX-10-EXP+ +LDBL-MAX-10-EXP+ +FLT-MAX+ +__NFDBITS+ +DBL-MAX+
      +LDBL-MAX+ +FLT-EPSILON+ +SDL-WINDOWPOS-CENTERED+
      +SDL-WINDOWPOS-CENTERED-MASK+ +SDL-WINDOWPOS-UNDEFINED+
      +SDL-WINDOWPOS-UNDEFINED-MASK+ +_XABORT_DEBUG+ +_XABORT_NESTED+
      +_XABORT_CONFLICT+ +_XABORT_CAPACITY+ +_XABORT_EXPLICIT+ +_XABORT_RETRY+
      +SDL-BLIT-SCALED+ +_XBEGIN_STARTED+ +__ATTRIBUTE_DEPRECATED__+
      +__RETURNS_NONNULL+ +__ATTRIBUTE_WARN_UNUSED_RESULT__+ +SDL-BUTTON-LEFT+
      +SDL-BUTTON-MIDDLE+ +__ATTRIBUTE_ARTIFICIAL__+ +SDL-BUTTON-RIGHT+
      +SDL-BUTTON-X1+ +__ALWAYS_INLINE+ +__EXTERN_ALWAYS_INLINE+
      +__EXTERN_INLINE+ +__RESTRICT_ARR+ +__FORTIFY_FUNCTION+
      +__LDOUBLE_REDIRECTS_TO_FLOAT128_ABI+ +__HAVE_GENERIC_SELECTION+
      +__INLINE+ +__DEFAULT_FN_ATTRS_VL256+ +SDL-ICONV-E2BIG+
      +SDL-ICONV-EILSEQ+ +SDL-ICONV-EINVAL+ +_M_PSRLQI+ +_M_PSRLQ+ +_M_PSRLDI+
      +_M_PSRLD+ +__DEFAULT_FN_ATTRS_F+ +_M_PSRLWI+ +_M_PCMPEQB+
      +__DEFAULT_FN_ATTRS_Y+ +_M_PXOR+ +__GLIBC_MINOR__+ +_M_POR+ +_M_PANDN+
      +_M_PAND+ +_SYS_CDEFS_H+ +__STDC_ISO_10646__+ +_M_PCMPGTB+ +_M_PCMPGTW+
      +__STDC_IEC_60559_COMPLEX__+ +_M_PCMPEQD+ +__GLIBC__+ +__GNU_LIBRARY__+
      +_M_PCMPEQW+ +__DEFAULT_FN_ATTRS_VL128+ +__DEFAULT_FN_ATTRS_Z_MASK+
      +__DEFAULT_FN_ATTRS_Z+ +__STDC_IEC_559_COMPLEX__+ +_M_PCMPGTD+ +__PTR_T+
      +__THROW+ +__THROWNL+ +__DEFAULT_FN_ATTRS_COMPLEX+ +SDL-ICONV-ERROR+
      +__FLEXARR+ +__GLIBC_C99_FLEXARR_AVAILABLE+ +__DEFAULT_FN_ATTRS_TILE+
      +__ATTRIBUTE_CONST__+ +__DEFAULT_FN_ATTRS_INT8+ +__ATTRIBUTE_PURE__+
      +__DEFAULT_FN_ATTRS_BF16+ +__ATTRIBUTE_NOINLINE__+ +__ATTRIBUTE_USED__+
      +__ATTRIBUTE_MAYBE_UNUSED__+ +_M_FROM_INT64+ +__ATTRIBUTE_MALLOC__+
      +_M_FROM_INT+ +_M_TO_INT64+ +_M_TO_INT+ +_M_EMPTY+ +WEOF+ +WCHAR-MAX+
      +WCHAR-MIN+ +__MBSTATE_T_DEFINED+ +_WINT_T+ +__WINT_T_DEFINED+
      +__DEFAULT_FN_ATTRS_FP16+ +__WCHAR_MIN+ +__WCHAR_MAX+ +_BITS_WCHAR_H+
      +_M_PMADDWD+ +_M_PMULHW+ +_M_PMULLW+ +_M_PSLLW+ +_M_PSLLWI+ +_M_PSUBSB+
      +_M_PSUBSW+ +_M_PSUBUSB+ +_M_PSUBUSW+ +_M_PSRAW+ +_M_PSRAWI+ +_M_PSRAD+
      +_M_PSRADI+ +_M_PSRLW+ +_M_PSLLD+ +_M_PSLLDI+ +__PCONFIG_KEY_PROGRAM+
      +_M_PSLLQ+ +_M_PSLLQI+ +_M_PUNPCKHDQ+ +_M_PUNPCKLBW+ +_M_PUNPCKLWD+
      +_M_PADDB+ +_M_PUNPCKLDQ+ +_M_PACKSSDW+ +_M_PACKSSWB+ +_M_PACKUSWB+
      +_M_PUNPCKHBW+ +SDL-HAT-LEFTUP+ +_M_PUNPCKHWD+ +SDL-HAT-RIGHTDOWN+
      +SDL-HAT-LEFTDOWN+ +_M_PADDUSB+ +_M_PADDUSW+ +SDL-HAT-LEFT+
      +SDL-HAT-RIGHTUP+ +_M_PSUBW+ +_M_PSUBB+ +_M_PSUBD+ +_M_PADDW+
      +SDL-HAT-DOWN+ +_M_PADDD+ +SDL-HAT-RIGHT+ +_M_PADDSB+ +SDL-HAT-UP+
      +SDL-HAT-CENTERED+ +_M_PADDSW+ +__TIMER_T_TYPE+
      +__HAVE_FLOAT64X_LONG_DOUBLE+ +__CLOCKID_T_TYPE+ +__STDC_IEC_60559_BFP__+
      +__KEY_T_TYPE+ +__HAVE_FLOAT64X+ +__DADDR_T_TYPE+
      +__HAVE_DISTINCT_FLOAT128+ +__HAVE_FLOAT32X+ +__CPU_MASK_TYPE+
      +_STDC_PREDEF_H+ +__HAVE_FLOAT64+ +SDL-COLOUR+ +__SSIZE_T_TYPE+
      +__HAVE_FLOAT32+ +__STDC_IEC_559__+ +__HAVE_FLOAT16+ +__BLKSIZE_T_TYPE+
      +__FSID_T_TYPE+ +__STATFS_MATCHES_STATFS64+ +__RLIM_T_MATCHES_RLIM64_T+
      +__INO_T_MATCHES_INO64_T+ +__OFF_T_MATCHES_OFF64_T+ +__TIME64_T_TYPE+
      +__HAVE_FLOAT128+ +_BITS_TIME64_H+ +__FD_SETSIZE+
      +__KERNEL_OLD_TIMEVAL_MATCHES_TIMEVAL64+ +_ATFILE_SOURCE+ +_WCHAR_H+
      +__USE_POSIX_IMPLICITLY+ +__TIMESIZE+ +__WORDSIZE+ +__SUSECONDS64_T_TYPE+
      +__SUSECONDS_T_TYPE+ +__USECONDS_T_TYPE+ +__SYSCALL_WORDSIZE+
      +__WORDSIZE_TIME64_COMPAT32+ +HAS-BUILTIN-BSWAP32+ +HAS-BUILTIN-BSWAP64+
      +HAS-BUILTIN-BSWAP16+ +__CLOCK_T_DEFINED+ +__CFLOAT64X+
      +__HAVE_FLOATN_NOT_TYPEDEF+ +__CFLOAT32+ +__CFLOAT32X+ +__CFLOAT64+
      +__HAVE_DISTINCT_FLOAT32+ +__HAVE_DISTINCT_FLOAT64+ +__HAVE_FLOAT128X+
      +__HAVE_DISTINCT_FLOAT16+ +__HAVE_DISTINCT_FLOAT128X+
      +__HAVE_FLOAT128_UNLIKE_LDBL+ +__HAVE_DISTINCT_FLOAT32X+
      +__HAVE_DISTINCT_FLOAT64X+ +__USE_ISOC99+ +__USE_ISOC11+ +_FEATURES_H+
      +_BITS_STDINT_INTN_H+ +__LITTLE_ENDIAN+ +_BITS_ENDIAN_H+
      +SDL-SCOPED-CAPABILITY+ +__USE_POSIX199506+ +_BITS_ENDIANNESS_H+
      +__BIG_ENDIAN+ +__USE_POSIX199309+ +__PDP_ENDIAN+ +__USE_POSIX2+
      +__USE_POSIX+ +_ENDIAN_H+ +__USE_ISOC95+ +__BIT_TYPES_DEFINED__+
      +__TIMER_T_DEFINED+ +__CLOCKID_T_DEFINED+ +__TIME_T_DEFINED+
      +_MM_CMPINT_GE+ +HAS-BROKEN-BSWAP+ +_MM_CMPINT_GT+ +AUDIO-S32MSB+
      +AUDIO-S32+ +_POSIX_SOURCE+ +AUDIO-S32LSB+ +_POSIX_C_SOURCE+ +AUDIO-S16+
      +AUDIO-U16+ +SDL-NO-THREAD-SAFETY-ANALYSIS+ +_DEFAULT_SOURCE+ +AUDIO-U8+
      +__USE_MISC+ +LITTLE-ENDIAN+ +PDP-ENDIAN+ +BIG-ENDIAN+ +BYTE-ORDER+
      +AUDIO-S16MSB+ +__BYTE_ORDER+ +__USE_XOPEN2K8+ +AUDIO-U16MSB+
      +__FLOAT_WORD_ORDER+ +AUDIO-S16LSB+ +__USE_XOPEN2K+ +AUDIO-U16LSB+
      +AUDIO-S8+ +SDL-AUDIO-MASK-SIGNED+ +__GLIBC_USE_DEPRECATED_GETS+
      +SDL-AUDIO-MASK-ENDIAN+ +__GLIBC_USE_DEPRECATED_SCANF+
      +SDL-AUDIO-MASK-DATATYPE+ +SDL-AUDIO-MASK-BITSIZE+ +__GLIBC_USE_ISOC2X+
      +__USE_FORTIFY_LEVEL+ +_BITS_BYTESWAP_H+ +__USE_ATFILE+
      +SDL-INVALID-SHAPE-ARGUMENT+ +SDL-WINDOW-LACKS-SHAPE+
      +SDL-NONSHAPEABLE-WINDOW+ +RW-SEEK-CUR+ +RW-SEEK-END+ +RW-SEEK-SET+
      +__W_CONTINUED+ +__WCOREFLAG+ +WUNTRACED+ +WSTOPPED+ +WEXITED+
      +WCONTINUED+ +WNOWAIT+ +__WNOTHREAD+ +__WALL+ +__WCLONE+ +_MATH_H+
      +_BITS_LIBM_SIMD_DECL_STUBS_H+ +_KXOR_MASK16+ +_KXNOR_MASK16+
      +_KOR_MASK16+ +_KNOT_MASK16+ +_KANDN_MASK16+ +WNOHANG+ +_KAND_MASK16+
      +_BITS_TYPES_LOCALE_T_H+ +_BITS_TYPES___LOCALE_T_H+ +_STRING_H+
      +SDLK-SCANCODE-MASK+ +SDL-HINT-XINPUT-ENABLED+
      +SDL-HINT-SHUTDOWN-DBUS-ON-QUIT+ +SDL-HINT-KMSDRM-DEVICE-INDEX+
      +SDL-HINT-X11-FORCE-OVERRIDE-REDIRECT+ +SDL-SWSURFACE+
      +SDL-HINT-VIDEODRIVER+ +SDL-DONTFREE+ +SDL-HINT-AUDIO-INCLUDE-MONITORS+
      +SDL-VIDEO-DRIVER-KMSDRM+ +__GLIBC_USE_IEC_60559_TYPES_EXT+
      +SDL-VIDEO-DRIVER-X11+ +SDL-SIMD-ALIGNED+ +SDL-HINT-DIRECTINPUT-ENABLED+
      +SDL-VIDEO-DRIVER-X11-XCURSOR+ +SDL-VIDEO-DRIVER-OFFSCREEN+
      +SDL-PREALLOC+ +SDL-VIDEO-DRIVER-WAYLAND+ +SDL-VIDEO-DRIVER-DUMMY+
      +SDL-VIDEO-DRIVER-WAYLAND-QT-TOUCH+ +____MBSTATE_T_DEFINED+
      +SDL-RLEACCEL+ +_____FPOS_T_DEFINED+ +SDL-BLIT-SURFACE+
      +SDL-STANDARD-GRAVITY+ +SDL-THREAD-PTHREAD+ +SDL-LOADSO-DLOPEN+
      +SDL-TIMER-UNIX+ +SDL-HINT-WINRT-PRIVACY-POLICY-URL+
      +SDL-THREAD-PTHREAD-RECURSIVE-MUTEX+ +SDL-HAPTIC-LEFTRIGHT+
      +SDL-JOYSTICK-VIRTUAL+ +SDL-JOYSTICK-HIDAPI+ +SDL-ASSERT-DATA+
      +SDL-SENSOR-DUMMY+ +_____FPOS64_T_DEFINED+ +SDL-HAPTIC-LINUX+
      +SDL-INPUT-LINUXEV+ +SDL-AUDIO-DRIVER-SNDIO-DYNAMIC+ +SDL-ASSERT-STATE+
      +SDL-JOYSTICK-LINUX+ +SDL-INPUT-LINUXKD+ +__GLIBC_USE_LIB_EXT2+
      +SDL-AUDIO-DRIVER-PIPEWIRE-DYNAMIC+ +SDL-AUDIO-DRIVER-PIPEWIRE+
      +__GLIBC_USE_IEC_60559_BFP_EXT+ +SDL-AUDIO-DRIVER-SNDIO+
      +__GLIBC_USE_IEC_60559_BFP_EXT_C2X+ +SDL-AUDIO-DRIVER-PULSEAUDIO+
      +SDL-AUDIO-DRIVER-DUMMY+ +__GLIBC_USE_IEC_60559_EXT+
      +SDL-AUDIO-DRIVER-DISK+ +SDL-HINT-QUIT-ON-LAST-WINDOW-CLOSE+
      +__GLIBC_USE_IEC_60559_FUNCS_EXT+ +SDL-HINT-X11-WINDOW-TYPE+
      +SDL-AUDIO-DRIVER-OSS+ +HAVE-LIBUDEV-H+ +HAVE-IMMINTRIN-H+
      +SDL-AUDIO-DRIVER-ALSA+ +HAVE-LIBDECOR-H+
      +__GLIBC_USE_IEC_60559_FUNCS_EXT_C2X+ +HAVE-LIBSAMPLERATE-H+
      +SDL-HINT-XINPUT-USE-OLD-JOYSTICK-MAPPING+
      +SDL-HINT-TRACKPAD-IS-TOUCH-ONLY+ +SDL-HINT-AUDIODRIVER+ +_SYS_TYPES_H+
      +DYNAPI-NEEDS-DLOPEN+ +SDL-USE-IME+ +SDL-UDEV-DYNAMIC+
      +SDL-HAVE-LIBDECOR-GET-MIN-MAX+ +SDL-VIDEO-OPENGL-GLX+ +SDL-VIDEO-VULKAN+
      +SDL-POWER-LINUX+ +SDL-FILESYSTEM-UNIX+ +SDL-VIDEO-RENDER-OGL-ES2+
      +____FILE_DEFINED+ +SDL-VIDEO-OPENGL+ +SDL-VIDEO-OPENGL-ES2+
      +__FILE_DEFINED+ +SDL-VIDEO-OPENGL-EGL+ +__STRUCT_FILE_DEFINED+
      +SDL-VIDEO-DRIVER-X11-SUPPORTS-GENERIC-EVENTS+ +_MM_DENORMALS_ZERO_MASK+
      +SDL-VIDEO-DRIVER-X11-HAS-XKBKEYCODETOKEYSYM+ +SDL-VIDEO-RENDER-OGL+
      +SDL-VIDEO-DRIVER-X11-XFIXES+ +SDL-VIDEO-DRIVER-X11-XRANDR+
      +SDL-VIDEO-DRIVER-X11-XSCRNSAVER+ +SDL-VIDEO-DRIVER-X11-XSHAPE+
      +SDL-VIDEO-DRIVER-X11-XDBE+ +SDL-VIDEO-DRIVER-X11-XINPUT2+
      +SDL-VIDEO-DRIVER-X11-XINPUT2-SUPPORTS-MULTITOUCH+ +INT32-MAX+
      +INT16-MAX+ +UINT8-MAX+ +INT64-MAX+ +INT-LEAST16-MIN+ +UINT32-MAX+
      +UINT16-MAX+ +EXIT-SUCCESS+ +MB-CUR-MAX+ +INT-LEAST8-MIN+ +EXIT-FAILURE+
      +UINT64-MAX+ +INT16-MIN+ +INT8-MIN+ +INT8-MAX+ +INT64-MIN+ +INT32-MIN+
      +INT-FAST8-MIN+ +UINT-LEAST64-MAX+ +INT-FAST32-MIN+ +INT-FAST16-MIN+
      +INT-FAST64-MIN+ +INT-FAST8-MAX+ +INT-FAST32-MAX+ +INT-FAST16-MAX+
      +INT-FAST64-MAX+ +SDL-FLOATWORDORDER+ +INT-LEAST64-MIN+ +RAND-MAX+
      +INT-LEAST16-MAX+ +INT-LEAST32-MIN+ +__LLDIV_T_DEFINED+ +SDL-BYTEORDER+
      +INT-LEAST8-MAX+ +INT-LEAST64-MAX+ +__LDIV_T_DEFINED+ +UINT-LEAST8-MAX+
      +INT-LEAST32-MAX+ +SDL-LIL-ENDIAN+ +SDL-BIG-ENDIAN+ +UINT-LEAST32-MAX+
      +UINT-LEAST16-MAX+ +UINTMAX-MAX+ +HAVE-INOTIFY+ +PTRDIFF-MIN+
      +HAVE-IBUS-IBUS-H+ +__ONCE_FLAG_INIT+ +HAVE-INOTIFY-INIT+ +PTRDIFF-MAX+
      +HAVE-INOTIFY-INIT1+ +SIG-ATOMIC-MIN+ +HAVE-FCITX+ +SIG-ATOMIC-MAX+
      +SIZE-MAX+ +WINT-MIN+ +HAVE-SYS-INOTIFY-H+ +WINT-MAX+ +HAVE-DBUS-DBUS-H+
      +UINT-FAST8-MAX+ +__HAVE_PTHREAD_ATTR_T+ +UINT-FAST16-MAX+
      +UINT-FAST32-MAX+ +UINT-FAST64-MAX+ +INTPTR-MIN+ +_STDIO_H+ +INTPTR-MAX+
      +INTMAX-MIN+ +UINTPTR-MAX+ +INTMAX-MAX+ +SDL-HAPTIC-TRIANGLE+
      +SDL-HINT-VIDEO-X11-NET-WM-PING+ +SDL-HAPTIC-CONSTANT+
      +SDL-HINT-VIDEO-X11-WINDOW-VISUALID+ +SDL-HAPTIC-SINE+
      +SDL-HINT-VIDEO-X11-XINERAMA+ +SDL-HAPTIC-RAMP+
      +SDL-HINT-VIDEO-FOREIGN-WINDOW-VULKAN+ +__RESTORE_GPRBX+
      +SDL-HINT-VIDEO-X11-FORCE-EGL+ +SDL-HAPTIC-SPRING+
      +SDL-HINT-VIDEO-WIN-D3DCOMPILER+ +__TMPGPR+ +SDL-HAPTIC-SAWTOOTHUP+
      +SDL-HINT-VIDEO-X11-NET-WM-BYPASS-COMPOSITOR+ +SDL-HAPTIC-SAWTOOTHDOWN+
      +__SAVE_GPRBX+ +SDL-HINT-WAVE-TRUNCATION+ +SDL-CACHELINE-SIZE+
      +SDL-HINT-WINDOWS-DISABLE-THREAD-NAMING+
      +SDL-HINT-WINDOWS-ENABLE-MENU-MNEMONICS+ +SDL-HINT-VIDEO-X11-XRANDR+
      +SDL-HINT-VIDEO-X11-XVIDMODE+ +SDL-HINT-WAVE-FACT-CHUNK+
      +SDL-HINT-WINDOWS-INTRESOURCE-ICON-SMALL+ +SDL-HINT-WAVE-RIFF-CHUNK-SIZE+
      +_DEFAULT_FN_ATTRS+ +SDL-HAPTIC-SPHERICAL+
      +SDL-HINT-WINDOWS-INTRESOURCE-ICON+ +SDL-HAPTIC-STEERING-AXIS+
      +SDL-HINT-WINDOWS-NO-CLOSE-ON-ALT-F4+ +SDL-HAPTIC-POLAR+
      +SDL-HAPTIC-CARTESIAN+ +SDL-HINT-WINDOWS-ENABLE-MESSAGELOOP+
      +SDL-HINT-WINDOWS-FORCE-MUTEX-CRITICAL-SECTIONS+ +SDL-HAPTIC-INFINITY+
      +SDL-HINT-WINDOWS-FORCE-SEMAPHORE-KERNEL+
      +SDL-HINT-WINDOW-FRAME-USABLE-WHILE-CURSOR-HIDDEN+ +SDL-HAPTIC-FRICTION+
      +SDL-HINT-WINDOW-NO-ACTIVATION-WHEN-SHOWN+ +SDL-HAPTIC-CUSTOM+
      +SDL-HINT-WINRT-HANDLE-BACK-BUTTON+ +SDL-HAPTIC-DAMPER+
      +SDL-HINT-WINRT-PRIVACY-POLICY-LABEL+ +SDL-HAPTIC-INERTIA+
      +SDL-HINT-WINDOWS-USE-D3D9EX+ +SDL-HAPTIC-STATUS+
      +SDL-HINT-WINDOWS-DPI-AWARENESS+ +SDL-HAPTIC-PAUSE+
      +SDL-HINT-WINDOWS-DPI-SCALING+ +SDL-HAPTIC-GAIN+ +SDL-HAPTIC-AUTOCENTER+
      +SDL-HINT-RPI-VIDEO-LAYER+ +SDL-HINT-RETURN-KEY-HIDES-IME+
      +SDL-HINT-SCREENSAVER-INHIBIT-ACTIVITY-NAME+
      +SDL-HINT-ROG-GAMEPAD-MICE-EXCLUDED+ +SDL-HINT-ROG-GAMEPAD-MICE+
      +SDL-HINT-PS2-DYNAMIC-VSYNC+ +SDL-HINT-VITA-TOUCH-MOUSE-DEVICE+
      +SDL-HINT-TOUCH-MOUSE-EVENTS+ +SDL-HINT-TV-REMOTE-AS-JOYSTICK+
      +SDL-HINT-THREAD-PRIORITY-POLICY+ +__MATH_DECLARE_LDOUBLE+
      +SDL-HINT-THREAD-FORCE-REALTIME-TIME-CRITICAL+
      +SDL-HINT-TIMER-RESOLUTION+ +SDL-HINT-THREAD-STACK-SIZE+
      +SDL-HINT-VIDEO-HIGHDPI-DISABLED+ +SDL-HINT-VIDEO-MINIMIZE-ON-FOCUS-LOSS+
      +SDL-HINT-VIDEO-MAC-FULLSCREEN-SPACES+ +SDL-HINT-VIDEO-DOUBLE-BUFFER+
      +SDL-HINT-VIDEO-ALLOW-SCREENSAVER+ +SDL-HINT-VIDEO-EXTERNAL-CONTEXT+
      +SDL-HINT-VIDEO-EGL-ALLOW-TRANSPARENCY+
      +SDL-HINT-VIDEO-WINDOW-SHARE-PIXEL-FORMAT+
      +SDL-HINT-VIDEO-WAYLAND-EMULATE-MOUSE-WARP+
      +SDL-HINT-VIDEO-FOREIGN-WINDOW-OPENGL+
      +SDL-HINT-RENDER-METAL-PREFER-LOW-POWER-DEVICE+
      +SDL-HINT-MOUSE-RELATIVE-WARP-MOTION+
      +SDL-HINT-VIDEO-WAYLAND-MODE-EMULATION+
      +SDL-HINT-VIDEO-WAYLAND-PREFER-LIBDECOR+
      +SDL-HINT-VIDEO-WAYLAND-ALLOW-LIBDECOR+
      +SDL-HINT-MOUSE-RELATIVE-SPEED-SCALE+ +SDL-HINT-NO-SIGNAL-HANDLERS+
      +SDL-HINT-MOUSE-RELATIVE-SCALING+ +SDL-HINT-MOUSE-RELATIVE-MODE-WARP+
      +SDL-HINT-MOUSE-NORMAL-SPEED-SCALE+ +SDL-HINT-MOUSE-RELATIVE-MODE-CENTER+
      +SDL-HINT-MOUSE-AUTO-CAPTURE+ +SDL-HINT-OPENGL-ES-DRIVER+
      +SDL-HINT-ORIENTATIONS+ +SDL-HINT-RENDER-LINE-METHOD+
      +SDL-HINT-MOUSE-TOUCH-EVENTS+ +SDL-HINT-MOUSE-RELATIVE-SYSTEM-SCALE+
      +SDL-HINT-QTWAYLAND-WINDOW-FLAGS+ +SDL-HINT-RENDER-DIRECT3D11-DEBUG+
      +SDL-HINT-RENDER-BATCHING+ +SDL-HINT-PREFERRED-LOCALES+
      +SDL-HINT-QTWAYLAND-CONTENT-ORIENTATION+ +SDL-HINT-POLL-SENTINEL+
      +SDL-HINT-RENDER-SCALE-QUALITY+ +SDL-HINT-RENDER-VSYNC+
      +SDL-HINT-RENDER-OPENGL-SHADERS+ +_MM512_MASKZ_CVTPS_PH+
      +SDL-HINT-RENDER-LOGICAL-SIZE-MODE+ +_MM512_MASK_CVTPS_PH+
      +SDL-HINT-RENDER-DIRECT3D-THREADSAFE+ +_MM512_CVTPS_PH+
      +SDL-HINT-RENDER-DRIVER+ +SDL-ALPHA-OPAQUE+ +SDL-ALPHA-TRANSPARENT+
      +SDL-HINT-ANDROID-APK-EXPANSION-MAIN-FILE-VERSION+ +SDL-RELEASED+
      +SDL-HINT-ALLOW-TOPMOST+ +SC-NX-FAST16+ +SC-NX-FAST32+
      +__SIZEOF_PTHREAD_MUTEXATTR_T+ +__SIZEOF_PTHREAD_COND_T+ +SC-NX-FAST64+
      +__SIZEOF_PTHREAD_CONDATTR_T+ +SC-ND-MAX+ +SC-NI-MAX+ +SDL-PRESSED+
      +__SIZEOF_PTHREAD_RWLOCKATTR_T+ +__SIZEOF_PTHREAD_BARRIERATTR_T+
      +SC-NX-LEAST16+ +SC-NX-LEAST32+ +SC-NX-LEAST64+ +_INTTYPES_H+
      +SC-NX-FAST8+ +_BITS_PTHREADTYPES_COMMON_H+ +_THREAD_SHARED_TYPES_H+
      +_BITS_PTHREADTYPES_ARCH_H+ +_STDINT_H+ +__SIZEOF_PTHREAD_MUTEX_T+
      +_BITS_STDINT_UINTN_H+ +SC-NO-MAX+ +__SIZEOF_PTHREAD_ATTR_T+ +SC-NU-MAX+
      +__SIZEOF_PTHREAD_RWLOCK_T+ +SC-NX-MAX+ +__SIZEOF_PTHREAD_BARRIER_T+
      +SDL-HINT-ANDROID-APK-EXPANSION-PATCH-FILE-VERSION+
      +SDL-HINT-ALLOW-ALT-TAB-WHILE-GRABBED+ +SDL-TOUCH-MOUSEID+
      +SDL-HINT-ANDROID-BLOCK-ON-PAUSE+ +SC-NO64+ +SC-NO32+ +SC-NO-LEAST8+
      +SDL-HINT-ACCELEROMETER-AS-JOYSTICK+ +SC-NO-LEAST16+
      +_THREAD_MUTEX_INTERNAL_H+ +SC-NO-LEAST32+ +SC-NU-FAST32+ +_CMP_NLE_UQ+
      +SC-NU-FAST16+ +SC-NU-FAST64+ +SDL-MOUSE-TOUCHID+ +SC-NO8+ +SC-NO16+
      +SC-NX8+ +HAVE-ATOF+ +HAVE-STRCMP+ +SC-NX16+ +HAVE-STRNCMP+ +SC-NX64+
      +SC-NX32+ +HAVE-STRCASECMP+ +SC-NX-LEAST8+ +HAVE-STRTOLL+ +HAVE-STRTOUL+
      +_CMP_TRUE_US+ +SC-NO-LEAST64+ +HAVE-STRTOULL+ +SC-NO-FAST8+
      +HAVE-STRTOD+ +SC-NO-FAST32+ +SC-NO-FAST16+ +SC-NO-FAST64+ +HAVE-ATOI+
      +BUFSIZ+ +EOF+ +SC-NI-FAST8+ +_CMP_GT_OQ+ +SC-NI-LEAST64+ +_IONBF+
      +_CMP_NEQ_OS+ +_CMP_GE_OQ+ +SC-NI-FAST64+ +_IOLBF+ +_IOFBF+
      +SC-NI-FAST16+ +SC-NI-FAST32+ +SEEK-END+ +_CMP_FALSE_OS+ +P-TMPDIR+
      +SC-NI-LEAST8+ +SC-NI32+ +SC-NI64+ +_CMP_EQ_US+ +SC-NI-LEAST32+
      +_CMP_NGE_UQ+ +SEEK-CUR+ +_CMP_NGT_UQ+ +_CMP_NLT_UQ+ +SEEK-SET+
      +SC-NI-LEAST16+ +SC-NU-LEAST32+ +_CMP_UNORD_S+ +SDL-INLINE+ +_CMP_ORD_S+
      +SC-NU-LEAST16+ +_CMP_ORD_Q+ +SC-NU-FAST8+ +_CMP_NEQ_US+ +_IO_USER_LOCK+
      +SC-NU-LEAST64+ +SC-NU16+ +_CMP_LE_OQ+ +SC-NU8+ +_CMP_EQ_OS+
      +_CMP_TRUE_UQ+ +SC-NU-LEAST8+ +SC-NU32+ +_CMP_NEQ_UQ+ +_CMP_LT_OQ+
      +SC-NU64+ +_CMP_UNORD_Q+ +SC-ND16+ +_CMP_GE_OS+ +SC-ND8+ +_CMP_NEQ_OQ+
      +_CMP_GT_OS+ +_CMP_FALSE_OQ+ +SC-ND-LEAST8+ +_CMP_NGE_US+ +SC-ND64+
      +__ATTR_DEALLOC_FCLOSE+ +SC-ND32+ +PR-IO-PTR+ +_CMP_EQ_UQ+ +PR-II-PTR+
      +_CMP_NGT_US+ +PR-ID-PTR+ +PRIXPTR+ +_CMP_NLE_US+ +PR-IX-PTR+ +PR-IU-PTR+
      +L-CTERMID+ +SC-ND-FAST64+ +_CMP_NLT_US+ +SC-ND-FAST32+ +SC-ND-FAST16+
      +FILENAME-MAX+ +_CMP_LE_OS+ +SC-NI16+ +TMP-MAX+ +SC-NI8+
      +_BITS_STDIO_LIM_H+ +L-TMPNAM+ +SC-ND-LEAST32+ +SC-ND-LEAST16+ +STDERR+
      +STDIN+ +STDOUT+ +SC-ND-FAST8+ +FOPEN-MAX+ +SC-ND-LEAST64+
      +SDL-HINT-ENABLE-STEAM-CONTROLLERS+ +SDL-HINT-EVENT-LOGGING+
      +SDL-HINT-FORCE-RAISEWINDOW+ +SDL-HINT-EMSCRIPTEN-ASYNCIFY+
      +SDL-HINT-DISPLAY-USABLE-BOUNDS+ +SDL-HINT-ENABLE-SCREEN-KEYBOARD+
      +SDL-HINT-GAMECONTROLLER-USE-BUTTON-LABELS+
      +SDL-HINT-EMSCRIPTEN-KEYBOARD-ELEMENT+
      +SDL-HINT-GAMECONTROLLER-IGNORE-DEVICES+ +PR-IX-MAX+ +PRIXMAX+
      +PR-II-MAX+ +SDL-HINT-GAMECONTROLLER-IGNORE-DEVICES-EXCEPT+ +PR-IO-MAX+
      +PR-IU-MAX+ +SDL-HINT-GAMECONTROLLERCONFIG+ +PRIXFAST64+
      +SDL-HINT-FRAMEBUFFER-ACCELERATION+ +PR-ID-MAX+
      +SDL-HINT-GAMECONTROLLERTYPE+ +SDL-HINT-GAMECONTROLLERCONFIG-FILE+
      +SDL-DISABLE+ +SDL-HINT-APPLE-TV-CONTROLLER-UI-EVENTS+ +SDL-IGNORE+
      +SDL-QUERY+ +SDL-HINT-AUDIO-CATEGORY+
      +SDL-HINT-APPLE-TV-REMOTE-ALLOW-ROTATION+
      +SDL-HINT-ANDROID-BLOCK-ON-PAUSE-PAUSEAUDIO+ +SDL-HINT-APP-NAME+
      +SDL-HINT-ANDROID-TRAP-BACK-BUTTON+ +SDL-HINT-AUTO-UPDATE-JOYSTICKS+
      +SDL-HINT-BMP-SAVE-LEGACY-FORMAT+ +SDL-HINT-AUTO-UPDATE-SENSORS+
      +SDL-HINT-AUDIO-DEVICE-STREAM-NAME+ +SDL-HINT-AUDIO-DEVICE-APP-NAME+
      +SDL-HINT-AUDIO-RESAMPLING-MODE+ +SDL-HINT-AUDIO-DEVICE-STREAM-ROLE+
      +SDL-ENABLE+ +SDL-HINT-JOYSTICK-HIDAPI+
      +SDL-HINT-JOYSTICK-HIDAPI-GAMECUBE+
      +SDL-HINT-JOYSTICK-GAMECUBE-RUMBLE-BRAKE+
      +SDL-HINT-JOYSTICK-FLIGHTSTICK-DEVICES-EXCLUDED+
      +SDL-HINT-JOYSTICK-GAMECUBE-DEVICES+
      +SDL-HINT-JOYSTICK-GAMECUBE-DEVICES-EXCLUDED+
      +SDL-HINT-JOYSTICK-HIDAPI-LUNA+
      +SDL-HINT-JOYSTICK-HIDAPI-NINTENDO-CLASSIC+
      +SDL-HINT-JOYSTICK-HIDAPI-SHIELD+ +SDL-HINT-JOYSTICK-HIDAPI-JOY-CONS+
      +SDL-HINT-JOYSTICK-HIDAPI-COMBINE-JOY-CONS+
      +SDL-HINT-JOYSTICK-HIDAPI-VERTICAL-JOY-CONS+
      +SDL-HINT-IME-INTERNAL-EDITING+ +SDL-HINT-IME-SHOW-UI+
      +SDL-HINT-IME-SUPPORT-EXTENDED-TEXT+ +SDL-HINT-IOS-HIDE-HOME-INDICATOR+
      +SDL-HINT-GRAB-KEYBOARD+ +SDL-HINT-HIDAPI-IGNORE-DEVICES+
      +SDL-HINT-IDLE-TIMER-DISABLED+ +SDL-HINT-JOYSTICK-BLACKLIST-DEVICES+
      +SDL-HINT-LINUX-HAT-DEADZONES+
      ...
      +SDL-HINT-JOYSTICK-ARCADESTICK-DEVICES+ +SDL-HINT-LINUX-JOYSTICK-CLASSIC+
      +SDL-HINT-JOYSTICK-ARCADESTICK-DEVICES-EXCLUDED+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-360+ +SDL-HINT-JOYSTICK-HIDAPI-XBOX+
      +SDL-HINT-JOYSTICK-HIDAPI-WII-PLAYER-LED+
      +SDL-HINT-MAC-OPENGL-ASYNC-DISPATCH+ +SDL-HINT-LOGGING+
      +SDL-HINT-MOUSE-DOUBLE-CLICK-RADIUS+ +SDL-HINT-JOYSTICK-HIDAPI-XBOX-ONE+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-360-WIRELESS+
      +SDL-HINT-KMSDRM-REQUIRE-DRM-MASTER+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-360-PLAYER-LED+ +SDL-HINT-JOYSTICK-MFI+
      +SDL-HINT-JOYSTICK-THROTTLE-DEVICES-EXCLUDED+
      +SDL-HINT-MOUSE-FOCUS-CLICKTHROUGH+ +SDL-HINT-JOYSTICK-IOKIT+
      +SDL-HINT-JOYSTICK-ZERO-CENTERED-DEVICES+ +SDL-HINT-JOYSTICK-WGI+
      +SDL-HINT-MAC-BACKGROUND-APP+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-ONE-HOME-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-SWITCH-HOME-LED+
      +SDL-HINT-JOYSTICK-WHEEL-DEVICES-EXCLUDED+ +SDL-HINT-JOYSTICK-THREAD+
      +SDL-HINT-LINUX-JOYSTICK-DEADZONES+ +SDL-HINT-LINUX-DIGITAL-HATS+
      +SDL-HINT-JOYSTICK-ROG-CHAKRAM+ +SDL-HINT-JOYSTICK-HIDAPI-PS4-RUMBLE+
      +SDL-HINT-JOYSTICK-HIDAPI-STEAM+
      +SDL-HINT-JOYSTICK-RAWINPUT-CORRELATE-XINPUT+
      +SDL-HINT-JOYSTICK-RAWINPUT+ +SDL-MAX-LOG-MESSAGE+
      +SDL-HINT-JOYSTICK-HIDAPI-PS5+ +SDL-HINT-JOYSTICK-HIDAPI-PS3+
      +SDL-HINT-JOYSTICK-HIDAPI-PS4+
      +SDL-HINT-MAC-CTRL-CLICK-EMULATE-RIGHT-CLICK+
      +SDL-HINT-JOYSTICK-THROTTLE-DEVICES+
      +SDL-HINT-JOYSTICK-HIDAPI-PS5-RUMBLE+ +SDL-HINT-JOYSTICK-WHEEL-DEVICES+
      +SDL-HINT-JOYSTICK-HIDAPI-STADIA+ +SDL-HINT-JOYSTICK-HIDAPI-WII+
      +SDL-HINT-JOYSTICK-HIDAPI-PS5-PLAYER-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-SWITCH+ +SDL-HINT-JOYSTICK-HIDAPI-STEAMDECK+
      +SDL-HINT-JOYSTICK-HIDAPI-JOYCON-HOME-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-SWITCH-PLAYER-LED+ +SDL-HINT-JOYSTICK-DEVICE+
      +_MM512_MASK_PERMUTEVAR_EPI32+ +_MM_FROUND_RINT+ +_MM_FROUND_TRUNC+
      +HAVE-SIN+ +HAVE-SQRT+ +HAVE-SINF+ +HAVE-SCALBN+ +HAVE-SCALBNF+
      +__MATHCALL_NARROW_ARGS_3+ +HAVE-TANF+ +__MATHCALL_NARROW_ARGS_1+
      +__MATHCALL_NARROW_ARGS_2+ +HAVE-TRUNC+ +_MM_FROUND_RAISE_EXC+
      +HAVE-SQRTF+ +__LINUX__+ +HAVE-TAN+ +HAVE-FSEEKO64+ +HAVE-FSEEKO+
      +HAVE-SIGACTION+ +_MM_FROUND_NO_EXC+ +HAVE-TRUNCF+ +HAVE-FOPEN64+
      +HAVE-NANOSLEEP+ +_MM_FROUND_NINT+ +_MM_FROUND_NEARBYINT+
      +_MM_FROUND_CUR_DIRECTION+ +HAVE-SYSCONF+ +HAVE-SA-SIGACTION+
      +HAVE-SETJMP+ +_MM_FROUND_CEIL+ +_MM_FROUND_FLOOR+ +__DEFAULT_FN_ATTRS+
      +HAVE-ICONV+ +MATH-ERREXCEPT+ +_IO_EOF_SEEN+ +HAVE-PTHREAD-SETNAME-NP+
      +MATH-ERRNO+ +HAVE-CLOCK-GETTIME+ +_IO_ERR_SEEN+ +HAVE-MPROTECT+
      +HAVE--EXIT+ +_MM_FROUND_TO_POS_INF+ +_MM_FROUND_TO_ZERO+
      +HAVE-O-CLOEXEC+ +HAVE-SEM-TIMEDWAIT+ +_MM_FROUND_TO_NEG_INF+
      +HAVE-GETAUXVAL+ +HAVE-POLL+ +M-PI-4+ +_MM_FROUND_TO_NEAREST_INT+ +M-PI+
      +M-PI-2+ +M-LN10+ +M-LN2+ +M-LOG2E+ +M-LOG10E+ +M-E+ +MATH-ERRHANDLING+
      +__DEFAULT_FN_ATTRS256+ +_MM_DENORMALS_ZERO_OFF+ +HAVE-VSNPRINTF+
      +HAVE-VSSCANF+ +_MM_DENORMALS_ZERO_ON+ +HAVE-STRCASESTR+ +M-SQRT2+
      +HAVE-STRNCASECMP+ +HAVE-ATAN+ +M-2-SQRTPI+ +HAVE-ASINF+ +M-SQRT1-2+
      +HAVE-ASIN+ +M-1-PI+ +HAVE-ACOSF+ +HAVE-ACOS+ +M-2-PI+ +HAVE-CEIL+
      +HAVE-ATAN2F+ +FLT-ROUNDS+ +FLT-EVAL-METHOD+ +HAVE-ATAN2+ +FLT-RADIX+
      +HAVE-ATANF+ +HAVE-COSF+ +HAVE-COS+ +HAVE-COPYSIGNF+
      +__GCC_HAVE_DWARF2_CFI_ASM+ +HAVE-COPYSIGN+ +HAVE-CEILF+ +HAVE-FABSF+
      +HAVE-FABS+ +HAVE-EXPF+ +HAVE-EXP+ +HAVE-LOG+ +HAVE-FMODF+ +HAVE-FLOORF+
      +HAVE-FMOD+ +HAVE-FLOOR+ +HAVE-LROUND+ +HAVE-LOG10F+ +_CMP_EQ_OQ+
      +HAVE-LOG10+ +HAVE-LOGF+ +HAVE-ROUNDF+ +HAVE-ROUND+ +HAVE-POWF+
      +HAVE-LROUNDF+ +HAVE-POW+ +_MM_ROUND_NEAREST+ +_MM_MASK_MASK+
      +_MM_ROUND_UP+ +_MM_ROUND_DOWN+ +_MM_ROUND_MASK+ +_MM_FLUSH_ZERO_ON+
      +_MM_ROUND_TOWARD_ZERO+ +_MM_MASK_DENORM+ +_MM_FLUSH_ZERO_MASK+
      +_MM_EXCEPT_MASK+ +HAVE-STRCHR+ +HAVE-STRSTR+ +_MM_EXCEPT_INEXACT+
      +HAVE-STRRCHR+ +HAVE-STRTOK-R+ +_MM_MASK_INVALID+ +HAVE-STRTOL+
      +HAVE-WCSNCASECMP+ +_MM_MASK_OVERFLOW+ +HAVE-STRLEN+ +_MM_MASK_DIV_ZERO+
      +_MM_MASK_INEXACT+ +HAVE-INDEX+ +_MM_MASK_UNDERFLOW+ +HAVE-RINDEX+
      +_M_PAVGB+ +_M_MASKMOVQ+ +_MM_EXCEPT_INVALID+ +_M_+ +_MM_EXCEPT_DIV_ZERO+
      +_MM_EXCEPT_DENORM+ +_MM_EXCEPT_UNDERFLOW+ +_MM_EXCEPT_OVERFLOW+
      +_M_PMINUB+ +_CMP_LT_OS+ +_M_PSADBW+ +_M_PSHUFW+ +_M_PMOVMSKB+ +_M_PAVGW+
      +_MM_ALIGN16+ +HAVE-CALLOC+ +HAVE-MALLOC+ +HAVE-ALLOCA+ +HAVE-FREE+
      +HAVE-REALLOC+ +HAVE-WCHAR-H+ +_M_PMAXSW+ +HAVE-SYS-TYPES-H+
      +HAVE-DLOPEN+ +_M_PMINSW+ +HAVE-LINUX-INPUT-H+ +_M_PEXTRW+ +_M_PINSRW+
      +HAVE-STDIO-H+ +HAVE-STDINT-H+ +HAVE-STRING-H+ +_M_PMAXUB+
      +HAVE-STRINGS-H+ +HAVE-STDLIB-H+ +HAVE-MEMORY-H+ +HAVE-MATH-H+
      +_M_PMULHUW+ +HAVE-STDARG-H+ +HAVE-SIGNAL-H+ +HAVE-WCSSTR+ +HAVE-WCSCMP+
      +HAVE-WCSDUP+ +HAVE-WCSCASECMP+ +HAVE-WCSNCMP+ +HAVE-MEMMOVE+
      +HAVE-MEMCPY+ +HAVE-WCSLEN+ +HAVE-MEMCMP+ +_MM512_PERMUTEVAR_EPI32+
      +HAVE-BSEARCH+ +_MM_FLUSH_ZERO_OFF+ +HAVE-QSORT+ +HAVE-MEMSET+ +HAVE-ABS+
      +HAVE-BCOPY+ +HAVE-SETENV+ +HAVE-GETENV+ +HAVE-UNSETENV+ +HAVE-PUTENV+
      +SDL-FORCE-INLINE+ +HAVE-INTTYPES-H+ +HAVE-LIMITS-H+ +HAVE-MALLOC-H+
      +HAVE-FLOAT-H+ +HAVE-ICONV-H+ +HAVE-ALLOCA-H+ +HAVE-CTYPE-H+
      +HAVE-GCC-ATOMICS+ +HAVE-LIBC+ +STDC-HEADERS+ +SIZEOF-VOIDP+
      +SDL-FALLTHROUGH+ +SDL-HAS-FALLTHROUGH+ +NULL+ +__DEFAULT_FN_ATTRS_MMX+
      +__DEFAULT_FN_ATTRS128+ +SDL-BUTTON-X2+ +SDL-BUTTON-X1MASK+
      +SDL-BUTTON-RMASK+ +SDL-BUTTON-MMASK+ +SDL-BUTTON-LMASK+
      +SDL-BUTTON-X2MASK+ +HUGE-VALF+ +HUGE-VALL+ +HUGE-VAL+ +_MM_HINT_ET0+
      +_MM_HINT_T1+ +_MM_HINT_NTA+ +_MM_HINT_T2+ +_MM_HINT_ET1+ +_MM_HINT_T0+
      +SDL-IPHONE-MAX-GFORCE+ +SDL-VIRTUAL-JOYSTICK-DESC-VERSION+
      +SDL-JOYSTICK-AXIS-MAX+ +_MM_MASK_CVTPS_PH+
      +SDL-TEXTEDITINGEVENT-TEXT-SIZE+ +__PTHREAD_MUTEX_HAVE_PREV+
      +__PTHREAD_RWLOCK_ELISION_EXTRA+ +NAN+ +SDL-JOYSTICK-AXIS-MIN+ +INFINITY+
      +__FP_LOGB0_IS_MIN+ +SDL-TEXTINPUTEVENT-TEXT-SIZE+
      +__GLIBC_FLT_EVAL_METHOD+ +FP-ILOGBNAN+ +FP-ILOGB0+ +__FP_LOGBNAN_IS_MIN+
      +__MATH_DECLARING_FLOATN+ +__MATH_DECLARING_DOUBLE+ +_MDOUBLE_+
      +PRIXFAST32+ +_MM512_SETZERO+ +PRIX64+ +_STRINGS_H+ +PRIXLEAST8+ +PRIX16+
      +PRIX8+ +PRIX32+ +PRIXFAST8+ +__TIME_T_TYPE+ +PRIXFAST16+ +PRIXLEAST32+
      +PRIXLEAST16+ +__ID_T_TYPE+ +PRIXLEAST64+ +__CLOCK_T_TYPE+
      +_MM_MASKZ_CVTPS_PH+ +PR-IX-LEAST32+ +PR-IX-LEAST16+ +PR-IX-LEAST64+
      +_MM512_SETZERO_EPI32+ +PR-IX64+ +_MM256_MASK_CVTPS_PH+ +PR-IX-LEAST8+
      +PR-IX-FAST32+ +SDL-PRIX32+ +PR-IX-FAST64+ +PR-IX-FAST8+ +SDL-PR-IS64+
      +PR-IX-FAST16+ +SDL-FLT-EPSILON+ +__OFF64_T_TYPE+ +PR-IU-FAST16+
      +__OFF_T_TYPE+ +SDL-PR-IS32+ +PR-IU-FAST8+ +SDL-MIN-UINT64+
      +PR-IU-LEAST64+ +__FSWORD_T_TYPE+ +PR-IU-LEAST16+ +PR-IU-LEAST32+
      +__NLINK_T_TYPE+ +__DEFAULT_FN_ATTRS512+ +PR-IX32+ +__MODE_T_TYPE+
      +SDL-PRIX64+ +PR-IX8+ +__INO_T_TYPE+ +__INO64_T_TYPE+ +PR-IX16+
      +PR-IU-FAST64+ +__GID_T_TYPE+ +SDL-PR-IU64+ +__UID_T_TYPE+ +PR-IU-FAST32+
      +SDL-PR-IX64+ +PR-IO-FAST64+ +__FSFILCNT64_T_TYPE+ +PR-IO-FAST32+
      +__FSFILCNT_T_TYPE+ +SDL-PR-IU32+ +PR-IO-FAST16+ +__FSBLKCNT64_T_TYPE+
      +SDL-PR-IX32+ +PR-IO-FAST8+ +__FSBLKCNT_T_TYPE+ +PR-IU-LEAST8+
      +__BLKCNT64_T_TYPE+ +PR-IU64+ +__BLKCNT_T_TYPE+ +__RLIM_T_TYPE+ +PR-IU32+
      +__RLIM64_T_TYPE+ +__PID_T_TYPE+ +PR-IU8+ +PR-IU16+ +PR-IO32+ +PR-IO8+
      +__UWORD_TYPE+ +PR-IO16+ +__SWORD_TYPE+ +__UQUAD_TYPE+ +PR-II-FAST64+
      +__SQUAD_TYPE+ +PR-II-FAST32+ +PR-IO-LEAST64+ +__ULONGWORD_TYPE+
      +PR-IO-LEAST32+ +__SLONGWORD_TYPE+ +PR-IO-LEAST16+ +__U32_TYPE+
      +PR-IO-LEAST8+ +__S32_TYPE+ +PR-IO64+ +PR-II-LEAST8+ +__DEV_T_TYPE+
      +__SYSCALL_ULONG_TYPE+ +PR-II64+ +__SYSCALL_SLONG_TYPE+ +PR-II32+
      +SDL-MAX-SINT64+ +PR-II16+ +_BITS_TYPESIZES_H+ +SDL-MIN-SINT64+ +PR-II8+
      +__STD_TYPE+ +PR-II-FAST16+ +SDL-MAX-UINT64+ +__U64_TYPE+ +PR-II-FAST8+
      +PR-II-LEAST64+ +__S64_TYPE+ +PR-II-LEAST32+ +__ULONG32_TYPE+
      +__SLONG32_TYPE+ +PR-II-LEAST16+ +SDL-MUTEX-MAXWAIT+ +SDL-FUNCTION+
      +SDL-ASSERT-LEVEL+ +__INLINE__+ +__RELAXED_FN_ATTRS+ +SDL-MUTEX-TIMEDOUT+
      +_ALLOCA_H+ +SDL-NULL-WHILE-LOOP-CONDITION+ +SDL-LINE+ +SDL-FILE+
      +_MM256_MASKZ_CVTPS_PH+ +SDL-RWOPS-WINFILE+ +SDL-RWOPS-UNKNOWN+
      +SDL-RWOPS-MEMORY-RO+ +SDL-RWOPS-MEMORY+ +SDL-RWOPS-JNIFILE+
      +SDL-RWOPS-STDFILE+ +PR-ID-FAST8+ +PR-ID-FAST16+ +PR-ID-FAST32+
      +PR-ID-FAST64+ +PR-ID64+ +PR-ID-LEAST8+ +PR-ID-LEAST16+ +PR-ID-LEAST32+
      +PR-ID-LEAST64+ +__PRI64_PREFIX+ +__PRIPTR_PREFIX+ +PR-ID8+ +PR-ID16+
      +PR-ID32+ +____GWCHAR_T_DEFINED+ +SDL-MAJOR-VERSION+ +SDL-PATCHLEVEL+
      +SDL-COMPILEDVERSION+ +SDL-MINOR-VERSION+ +SDL-MIX-MAXVOLUME+ +_CTYPE_H+
      +SDL-INIT-TIMER+ +TTF-PATCHLEVEL+ +SDL-INIT-JOYSTICK+ +SDL-INIT-VIDEO+
      +SDL-INIT-HAPTIC+ +SDL-INIT-AUDIO+ +SDL-INIT-SENSOR+
      +SDL-INIT-NOPARACHUTE+ +SDL-INIT-EVENTS+ +SDL-INIT-GAMECONTROLLER+
      +SDL-INIT-EVERYTHING+ +_SIDD_UBYTE_OPS+ +SDL-TTF-MINOR-VERSION+
      +_SIDD_UWORD_OPS+ +SDL-TTF-PATCHLEVEL+ +SDL-TTF-MAJOR-VERSION+
      +TTF-MINOR-VERSION+ +_SIDD_CMP_RANGES+ +_SIDD_CMP_EQUAL_EACH+
      +_SIDD_SBYTE_OPS+ +_SIDD_SWORD_OPS+ +TTF-MAJOR-VERSION+
      +_SIDD_CMP_EQUAL_ANY+ +_SIDD_POSITIVE_POLARITY+ +SDL-TTF-COMPILEDVERSION+
      +_SIDD_CMP_EQUAL_ORDERED+ +_SIDD_NEGATIVE_POLARITY+
      +_SIDD_MASKED_NEGATIVE_POLARITY+ +_SIDD_MASKED_POSITIVE_POLARITY+
      +UNICODE-BOM-SWAPPED+ +_SIDD_MOST_SIGNIFICANT+ +UNICODE-BOM-NATIVE+
      +_SIDD_LEAST_SIGNIFICANT+ +_SIDD_UNIT_MASK+ +_SIDD_BIT_MASK+ +SC-NX-PTR+
      +SC-NI-PTR+ +SC-NO-PTR+ +SC-NU-PTR+ +SC-ND-PTR+ +TTF-STYLE-NORMAL+
      +__DEFAULT_FN_ATTRS_CONSTEXPR+ +TTF-STYLE-ITALIC+ +TTF-STYLE-BOLD+
      +TTF-STYLE-STRIKETHROUGH+ +TTF-STYLE-UNDERLINE+ +TTF-HINTING-NORMAL+
      +TTF-HINTING-LIGHT+ +TTF-HINTING-MONO+ +TTF-HINTING-NONE+
      +TTF-HINTING-LIGHT-SUBPIXEL+ +TTF-WRAPPED-ALIGN-LEFT+
      +TTF-WRAPPED-ALIGN-CENTER+ +TTF-WRAPPED-ALIGN-RIGHT+ +SDL-MIN-SINT8+
      +SDL-MAX-SINT8+ +SDL-SIZE-MAX+ +LDBL-HAS-SUBNORM+ +DBL-HAS-SUBNORM+
      +FLT-HAS-SUBNORM+ +LDBL-DECIMAL-DIG+ +DBL-DECIMAL-DIG+ +FLT-DECIMAL-DIG+
      +LDBL-TRUE-MIN+ +DBL-TRUE-MIN+ +FLT-TRUE-MIN+ +LDBL-MIN+ +DBL-MIN+
      +FLT-MIN+ +LDBL-EPSILON+ +DBL-EPSILON+ +SDL-MIN-UINT32+ +SDL-MIN-SINT32+
      +SDL-MAX-UINT32+ +SDL-MIN-UINT16+ +SDL-MAX-SINT32+ +SDL-MAX-UINT16+
      +SDL-MAX-SINT16+ +SDL-MIN-SINT16+ +SDL-MAX-UINT8+ +SDL-MIN-UINT8+
      +__S16_TYPE+ +__U16_TYPE+ +_MM_CVTSS_I32+ +_MM_CVTI32_SD+ +_MM_CVTSD_I32+
      +_BITS_TYPES_H+ +_STDLIB_H+ +_MM_CVTSD_I64+ +_MM_CVTI64_SD+
      +_MM_CVTI32_SS+ +_MM_CVTSS_I64+ +_MM_CVTI64_SS+ +TTF-DIRECTION-BTT+
      +TTF-DIRECTION-TTB+ +TTF-DIRECTION-RTL+ +TTF-DIRECTION-LTR+
      ...
      +DUMMY-ENUM-VALUE+ +SDL-TRUE+ +SDL-FALSE+ +FP-NORMAL+ +FP-SUBNORMAL+
      +FP-ZERO+ +FP-INFINITE+ +FP-NAN+ +_I_SALNUM+ +_I_SPUNCT+ +_I_SCNTRL+
      +_I_SBLANK+ +_I_SGRAPH+ +_I_SPRINT+ +_I_SSPACE+ +_I_SXDIGIT+ +_I_SDIGIT+
      +_I_SALPHA+ +_I_SLOWER+ +_I_SUPPER+)
    #<PACKAGE "DUMMY">)
   (EXPORT
    '(TTF-DIRECTION SDL-TIMER-ID SDL-TIMER-CALLBACK WINDOW-SHAPE-MODE
      SDL-RENDERER-FLIP SDL-TEXTURE-MODULATE SDL-TEXTURE-ACCESS SDL-SCALE-MODE
      SDL-RENDERER-FLAGS SDL-POWER-STATE SDL-MESSAGE-BOX-COLOR-TYPE
      SDL-MESSAGE-BOX-BUTTON-FLAGS SDL-MESSAGE-BOX-FLAGS
      SDL-LOG-OUTPUT-FUNCTION SDL-LOG-PRIORITY SDL-LOG-CATEGORY
      SDL-HINT-CALLBACK SDL-HINT-PRIORITY SDL-EVENT-FILTER SDL-EVENTACTION
      SDL-EVENT-TYPE SDL-GESTURE-ID SDL-TOUCH-DEVICE-TYPE SDL-FINGER-ID
      SDL-TOUCH-ID SDL-GAME-CONTROLLER-BUTTON SDL-GAME-CONTROLLER-AXIS
      SDL-GAME-CONTROLLER-BIND-TYPE SDL-GAME-CONTROLLER-TYPE SDL-SENSOR-TYPE
      SDL-SENSOR-ID SDL-JOYSTICK-POWER-LEVEL SDL-JOYSTICK-TYPE SDL-JOYSTICK-ID
      ...
      SINT32 UINT16 SINT16 UINT8 SINT8 SDL-BOOL DOUBLE-T FLOAT-T __GWCHAR_T
      UINTMAX-T INTMAX-T UINTPTR-T INTPTR-T UINT-FAST64-T UINT-FAST32-T
      UINT-FAST16-T UINT-FAST8-T INT-FAST64-T INT-FAST32-T INT-FAST16-T
      INT-FAST8-T UINT-LEAST64-T UINT-LEAST32-T UINT-LEAST16-T UINT-LEAST8-T
      INT-LEAST64-T INT-LEAST32-T INT-LEAST16-T INT-LEAST8-T UINT64-T UINT32-T
      UINT16-T UINT8-T MBSTATE-T WINT-T LOCALE-T PTRDIFF-T __COMPAR_FN_T
      WCHAR-T _FLOAT64X _FLOAT32X _FLOAT64 _FLOAT32 FPOS-T VA-LIST _IO_LOCK_T
      ...
      U-LONG U-INT U-SHORT U-CHAR __SIG_ATOMIC_T __SOCKLEN_T __INTPTR_T
      __LOFF_T __SYSCALL_ULONG_T __SYSCALL_SLONG_T __SSIZE_T __FSWORD_T
      __FSFILCNT64_T __FSFILCNT_T __FSBLKCNT64_T __FSBLKCNT_T __BLKCNT64_T
      __BLKCNT_T __BLKSIZE_T __CLOCKID_T __KEY_T __DADDR_T __SUSECONDS64_T
      __SUSECONDS_T __USECONDS_T __TIME_T __ID_T __RLIM64_T __RLIM_T __CLOCK_T
      __PID_T __OFF64_T __OFF_T __NLINK_T __MODE_T __INO64_T __INO_T __GID_T
      __UID_T __DEV_T __UINTMAX_T __INTMAX_T __U_QUAD_T __QUAD_T
      __UINT_LEAST64_T __INT_LEAST64_T __UINT_LEAST32_T __INT_LEAST32_T
      __UINT_LEAST16_T __INT_LEAST16_T __UINT_LEAST8_T __INT_LEAST8_T
