 ...
 (EVAL-WHEN (:COMPILE-TOPLEVEL :LOAD-TOPLEVEL :EXECUTE)
   ...
   (PROGN
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8156 42
                                   '((:UPPER . 256) (:LOWER . 512)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8279 43
                                   '((:NAN . 0) (:INFINITE . 1) (:ZERO . 2)
                                     (:SUBNORMAL . 3) (:NORMAL . 4))))
    (PROGN
     (DEFPARAMETER +SDL-FALSE+ 0)
     (DEFPARAMETER +SDL-TRUE+ 1)
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8280 44
                                   '((:FALSE . 0) (:TRUE . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8281 45
                                   '((:DUMMY-ENUM-VALUE . 0))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8282 47
    ...
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     ...
     '((#:P8283 (:POINTER SDL-ASSERT-DATA)) (#:P8284 (:STRING))
       (#:P8285 (:STRING)) (#:P8286 :INT)))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8287 50
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8288 55
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8289 63
                                   '((:STOPPED . 0) (:PLAYING . 1)
                                     (:PAUSED . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8290 65
                                   '((:O . 0) (:NO . 1) (:B . 2) (:NB . 3)
                                     (:Z . 4) (:NZ . 5) (:BE . 6) (:NBE . 7)
                                     (:S . 8) (:NS . 9) (:P . 10) (:NP . 11)
                                     (:L . 12) (:NL . 13) (:LE . 14)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8291 66
                                   '((:EQ . 0) (:LT . 1) (:LE . 2)
                                     (:UNUSED . 3) (:NE . 4) (:NLT . 5)
                                     (:NLE . 6))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8292 67
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8293 68
                                   '((:|1_2| . 0) (:P5_2 . 1) (:P5_1 . 2)
                                     (:P75_1P5 . 3))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8294 69
                                   '((:SRC . 0) (:ZERO . 1) (:NAN . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8295 70
                                   '((:A . 240) (:B . 204) (:C . 170))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8296 72
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8297 73
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8298 74
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8299 75
                                   '((:NONE . 0) (:RGB . 1) (:RGBA . 2)
                                     (:ARGB . 3) (:BGR . 4) (:BGRA . 5)
                                     (:ABGR . 6))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8300 76
                                   '((:NONE . 0) (:|332| . 1) (:|4444| . 2)
                                     (:|1555| . 3) (:|5551| . 4) (:|565| . 5)
                                     (:|8888| . 6) (:|2101010| . 7)
                                     (:|1010102| . 8))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8301 77
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8302 85
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8303 86
                                   '((:ADD . 1) (:SUBTRACT . 2)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8304 87
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8305 90
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8306 93
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8307 94
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8308 95
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8309 96
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8310 97
                                   '((:CANCEL . 0) (:BRIEFLY . 1)
                                     (:UNTIL-FOCUSED . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8311 98
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8312 99
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8313 100
                                   '((:DEBUG-FLAG . 1)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8314 101
                                   '((:NONE . 0) (:FLUSH . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8315 102
                                   '((:NO-NOTIFICATION . 0)
                                     (:LOSE-CONTEXT . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8316 103
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8317 104
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8318 105
                                   '((:UNKNOWN . 0) (:RETURN . 13)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8319 106
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8320 109
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8321 110
                                   '((:NORMAL . 0) (:FLIPPED . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8322 113
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8323 114
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8324 117
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8325 119
                                   '((:UNKNOWN . 0) (:XBOX360 . 1)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8326 120
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8327 124
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8328 125
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8329 126
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8330 128
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8331 161
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8332 173
                                   '((:DEFAULT . 0) (:NORMAL . 1)
                                     (:OVERRIDE . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8333 174
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8334 175
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8335 176
                                   '((:ERROR . 16) (:WARNING . 32)
                                     (:INFORMATION . 64)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8336 177
                                   '((:RETURNKEY-DEFAULT . 1)
                                     (:ESCAPEKEY-DEFAULT . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8337 180
                                   '((:BACKGROUND . 0) (:TEXT . 1)
                                     (:BUTTON-BORDER . 2)
                                     (:BUTTON-BACKGROUND . 3)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8338 183
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8339 184
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8340 187
                                   '((:NEAREST . 0) (:LINEAR . 1)
                                     (:BEST . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8341 188
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8342 189
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8343 190
                                   '((:NONE . 0) (:HORIZONTAL . 1)
                                     (:VERTICAL . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8344 193
   ...
   (EXPORT
    ...
    #<PACKAGE "DUMMY">)
   (EXPORT
    '(SDL-QUIT SDL-WAS-INIT SDL-QUIT-SUB-SYSTEM SDL-INIT-SUB-SYSTEM SDL-INIT
               SDL-OPEN-URL SDL-GET-PREFERRED-LOCALES SDL-GET-REVISION-NUMBER
               SDL-GET-REVISION SDL-GET-VERSION SDL-REMOVE-TIMER SDL-ADD-TIMER
               ...
               SDL-RENDER-GET-METAL-COMMAND-ENCODER SDL-RENDER-GET-METAL-LAYER
               SDL-GL-UNBIND-TEXTURE SDL-GL-BIND-TEXTURE SDL-RENDER-FLUSH
               SDL-DESTROY-RENDERER SDL-DESTROY-TEXTURE SDL-RENDER-PRESENT
               SDL-RENDER-READ-PIXELS SDL-RENDER-GEOMETRY-RAW
               SDL-RENDER-GEOMETRY SDL-RENDER-COPY-EX-F SDL-RENDER-COPY-F
               ...
               SDL-RENDER-FILL-RECT SDL-RENDER-DRAW-RECTS SDL-RENDER-DRAW-RECT
               SDL-RENDER-DRAW-LINES SDL-RENDER-DRAW-LINE
               SDL-RENDER-DRAW-POINTS SDL-RENDER-DRAW-POINT SDL-RENDER-CLEAR
               ...
               SDL-UNLOCK-TEXTURE SDL-LOCK-TEXTURE-TO-SURFACE SDL-LOCK-TEXTURE
               SDL-UPDATE-NV-TEXTURE SDL-UPDATE-YUV-TEXTURE SDL-UPDATE-TEXTURE
               SDL-GET-TEXTURE-USER-DATA SDL-SET-TEXTURE-USER-DATA
               SDL-GET-TEXTURE-SCALE-MODE SDL-SET-TEXTURE-SCALE-MODE
               SDL-GET-TEXTURE-BLEND-MODE SDL-SET-TEXTURE-BLEND-MODE
               SDL-GET-TEXTURE-ALPHA-MOD SDL-SET-TEXTURE-ALPHA-MOD
               SDL-GET-TEXTURE-COLOR-MOD SDL-SET-TEXTURE-COLOR-MOD
               SDL-QUERY-TEXTURE SDL-CREATE-TEXTURE-FROM-SURFACE
               SDL-CREATE-TEXTURE SDL-GET-RENDERER-OUTPUT-SIZE
               SDL-GET-RENDERER-INFO SDL-RENDER-GET-WINDOW SDL-GET-RENDERER
               ...
               SDL-LOG-MESSAGE-V SDL-LOG-MESSAGE SDL-LOG-CRITICAL SDL-LOG-ERROR
               SDL-LOG-WARN SDL-LOG-INFO SDL-LOG-DEBUG SDL-LOG-VERBOSE SDL-LOG
               SDL-LOG-RESET-PRIORITIES SDL-LOG-GET-PRIORITY
               SDL-LOG-SET-PRIORITY SDL-LOG-SET-ALL-PRIORITY SDL-UNLOAD-OBJECT
               SDL-LOAD-FUNCTION SDL-LOAD-OBJECT SDL-CLEAR-HINTS
               SDL-DEL-HINT-CALLBACK SDL-ADD-HINT-CALLBACK SDL-GET-HINT-BOOLEAN
               SDL-GET-HINT SDL-RESET-HINTS SDL-RESET-HINT SDL-SET-HINT
               ...
               SDL-HID-SEND-FEATURE-REPORT SDL-HID-SET-NONBLOCKING SDL-HID-READ
               ...
               SDL-HAPTIC-EFFECT-SUPPORTED SDL-HAPTIC-NUM-AXES SDL-HAPTIC-QUERY
               SDL-HAPTIC-NUM-EFFECTS-PLAYING SDL-HAPTIC-NUM-EFFECTS
               SDL-HAPTIC-CLOSE SDL-HAPTIC-OPEN-FROM-JOYSTICK
               SDL-JOYSTICK-IS-HAPTIC SDL-HAPTIC-OPEN-FROM-MOUSE
               SDL-MOUSE-IS-HAPTIC SDL-HAPTIC-INDEX SDL-HAPTIC-OPENED
               SDL-HAPTIC-OPEN SDL-HAPTIC-NAME SDL-NUM-HAPTICS
               SDL-GET-PREF-PATH SDL-GET-BASE-PATH SDL-REGISTER-EVENTS
               SDL-EVENT-STATE SDL-FILTER-EVENTS SDL-DEL-EVENT-WATCH
               SDL-ADD-EVENT-WATCH SDL-GET-EVENT-FILTER SDL-SET-EVENT-FILTER
               SDL-PUSH-EVENT SDL-WAIT-EVENT-TIMEOUT SDL-WAIT-EVENT
               SDL-POLL-EVENT SDL-FLUSH-EVENTS SDL-FLUSH-EVENT SDL-HAS-EVENTS
               ...
               SDL-GAME-CONTROLLER-RUMBLE-TRIGGERS SDL-GAME-CONTROLLER-RUMBLE
               SDL-GAME-CONTROLLER-GET-SENSOR-DATA-WITH-TIMESTAMP
               ...
               SDL-GAME-CONTROLLER-GET-FIRMWARE-VERSION
               SDL-GAME-CONTROLLER-GET-PRODUCT-VERSION
               SDL-GAME-CONTROLLER-GET-PRODUCT SDL-GAME-CONTROLLER-GET-VENDOR
               ...
               SDL-GAME-CONTROLLER-NAME SDL-GAME-CONTROLLER-FROM-PLAYER-INDEX
               ...
               SDL-GAME-CONTROLLER-MAPPING SDL-GAME-CONTROLLER-MAPPING-FOR-GUID
               SDL-GAME-CONTROLLER-MAPPING-FOR-INDEX
               SDL-GAME-CONTROLLER-NUM-MAPPINGS SDL-GAME-CONTROLLER-ADD-MAPPING
               ...
               SDL-SENSOR-GET-NAME SDL-SENSOR-FROM-INSTANCE-ID SDL-SENSOR-OPEN
               ...
               SDL-JOYSTICK-PATH SDL-JOYSTICK-NAME SDL-JOYSTICK-SET-VIRTUAL-HAT
               SDL-JOYSTICK-SET-VIRTUAL-BUTTON SDL-JOYSTICK-SET-VIRTUAL-AXIS
               SDL-JOYSTICK-IS-VIRTUAL SDL-JOYSTICK-DETACH-VIRTUAL
               SDL-JOYSTICK-ATTACH-VIRTUAL-EX SDL-JOYSTICK-ATTACH-VIRTUAL
               SDL-JOYSTICK-FROM-PLAYER-INDEX SDL-JOYSTICK-FROM-INSTANCE-ID
               SDL-JOYSTICK-OPEN SDL-JOYSTICK-GET-DEVICE-INSTANCE-ID
               SDL-JOYSTICK-GET-DEVICE-TYPE
               SDL-JOYSTICK-GET-DEVICE-PRODUCT-VERSION
               SDL-JOYSTICK-GET-DEVICE-PRODUCT SDL-JOYSTICK-GET-DEVICE-VENDOR
               SDL-JOYSTICK-GET-DEVICE-GUID
               SDL-JOYSTICK-GET-DEVICE-PLAYER-INDEX SDL-JOYSTICK-PATH-FOR-INDEX
               SDL-JOYSTICK-NAME-FOR-INDEX SDL-NUM-JOYSTICKS
               SDL-UNLOCK-JOYSTICKS SDL-LOCK-JOYSTICKS SDL-GUID-FROM-STRING
               ...
               SDL-CREATE-CURSOR SDL-GET-RELATIVE-MOUSE-MODE SDL-CAPTURE-MOUSE
               ...
               SDL-GL-CREATE-CONTEXT SDL-GL-GET-ATTRIBUTE SDL-GL-SET-ATTRIBUTE
               SDL-GL-RESET-ATTRIBUTES SDL-GL-EXTENSION-SUPPORTED
               SDL-GL-UNLOAD-LIBRARY SDL-GL-GET-PROC-ADDRESS
               SDL-GL-LOAD-LIBRARY SDL-DISABLE-SCREEN-SAVER
               SDL-ENABLE-SCREEN-SAVER SDL-IS-SCREEN-SAVER-ENABLED
               SDL-DESTROY-WINDOW SDL-FLASH-WINDOW SDL-SET-WINDOW-HIT-TEST
               ...
               SDL-SET-WINDOW-FULLSCREEN SDL-RESTORE-WINDOW SDL-MINIMIZE-WINDOW
               ...
               SDL-GET-WINDOW-SIZE SDL-SET-WINDOW-SIZE SDL-GET-WINDOW-POSITION
               SDL-SET-WINDOW-POSITION SDL-GET-WINDOW-DATA SDL-SET-WINDOW-DATA
               SDL-SET-WINDOW-ICON SDL-GET-WINDOW-TITLE SDL-SET-WINDOW-TITLE
               ...
               SDL-CREATE-RGB-SURFACE-WITH-FORMAT-FROM
               SDL-CREATE-RGB-SURFACE-FROM SDL-CREATE-RGB-SURFACE-WITH-FORMAT
               SDL-CREATE-RGB-SURFACE SDL-COMPOSE-CUSTOM-BLEND-MODE
               SDL-INTERSECT-F-RECT-AND-LINE SDL-ENCLOSE-F-POINTS
               SDL-UNION-F-RECT SDL-INTERSECT-F-RECT SDL-HAS-INTERSECTION-F
               SDL-INTERSECT-RECT-AND-LINE SDL-ENCLOSE-POINTS SDL-UNION-RECT
               SDL-INTERSECT-RECT SDL-HAS-INTERSECTION SDL-CALCULATE-GAMMA-RAMP
               SDL-GET-RGBA SDL-GET-RGB SDL-MAP-RGBA SDL-MAP-RGB
               SDL-FREE-PALETTE SDL-SET-PALETTE-COLORS
               SDL-SET-PIXEL-FORMAT-PALETTE SDL-ALLOC-PALETTE SDL-FREE-FORMAT
               SDL-ALLOC-FORMAT SDL-MASKS-TO-PIXEL-FORMAT-ENUM
               SDL-PIXEL-FORMAT-ENUM-TO-MASKS SDL-GET-PIXEL-FORMAT-NAME
               SDL-SIMD-FREE SDL-SIMD-REALLOC SDL-SIMD-ALLOC
               SDL-SIMD-GET-ALIGNMENT SDL-GET-SYSTEM-RAM SDL-HAS-LASX
               SDL-HAS-LSX SDL-HAS-NEON SDL-HAS-ARMSIMD SDL-HAS-AVX512F
               SDL-HAS-AVX2 SDL-HAS-AVX SDL-HAS-SSE42 SDL-HAS-SSE41
               SDL-HAS-SSE3 SDL-HAS-SSE2 SDL-HAS-SSE SDL-HAS3D-NOW SDL-HAS-MMX
               SDL-HAS-ALTI-VEC SDL-HAS-RDTSC SDL-GET-CPU-CACHE-LINE-SIZE
               SDL-GET-CPU-COUNT __TILE_CMMRLFP16PS __TILE_CMMIMFP16PS
               _MM_PAUSE _MM_MFENCE _MM_LFENCE _MM_CLFLUSH _MM_SETCSR
               _MM_GETCSR _MM_SFENCE POSIX-MEMALIGN
               SDL-HAS-PRIMARY-SELECTION-TEXT SDL-GET-PRIMARY-SELECTION-TEXT
               SDL-SET-PRIMARY-SELECTION-TEXT SDL-HAS-CLIPBOARD-TEXT
               SDL-GET-CLIPBOARD-TEXT SDL-SET-CLIPBOARD-TEXT
               SDL-CLOSE-AUDIO-DEVICE SDL-CLOSE-AUDIO SDL-UNLOCK-AUDIO-DEVICE
               SDL-UNLOCK-AUDIO SDL-LOCK-AUDIO-DEVICE SDL-LOCK-AUDIO
               SDL-CLEAR-QUEUED-AUDIO SDL-GET-QUEUED-AUDIO-SIZE
               SDL-DEQUEUE-AUDIO SDL-QUEUE-AUDIO SDL-MIX-AUDIO-FORMAT
               SDL-MIX-AUDIO SDL-FREE-AUDIO-STREAM SDL-AUDIO-STREAM-CLEAR
               SDL-AUDIO-STREAM-FLUSH SDL-AUDIO-STREAM-AVAILABLE
               SDL-AUDIO-STREAM-GET SDL-AUDIO-STREAM-PUT SDL-NEW-AUDIO-STREAM
               ...
               SDL-FREE-RW SDL-ALLOC-RW SDL-RW-FROM-CONST-MEM SDL-RW-FROM-MEM
               SDL-RW-FROM-FP SDL-RW-FROM-FILE SDL-TLS-CLEANUP SDL-TLS-SET
               SDL-TLS-GET SDL-TLS-CREATE SDL-DETACH-THREAD SDL-WAIT-THREAD
               SDL-SET-THREAD-PRIORITY SDL-GET-THREAD-ID SDL-THREAD-ID
               SDL-GET-THREAD-NAME SDL-CREATE-THREAD-WITH-STACK-SIZE
               SDL-CREATE-THREAD SDL-COND-WAIT-TIMEOUT SDL-COND-WAIT
               SDL-COND-BROADCAST SDL-COND-SIGNAL SDL-DESTROY-COND
               SDL-CREATE-COND SDL-SEM-VALUE SDL-SEM-POST SDL-SEM-WAIT-TIMEOUT
               ...
               SDL-ATOMIC-LOCK SDL-ATOMIC-TRY-LOCK SDL-RESET-ASSERTION-REPORT
               SDL-GET-ASSERTION-REPORT SDL-GET-ASSERTION-HANDLER
               SDL-GET-DEFAULT-ASSERTION-HANDLER SDL-SET-ASSERTION-HANDLER
               SDL-REPORT-ASSERTION SDL-SET-MAIN-READY SDL-MAIN
               SDL-ICONV-STRING SDL-ICONV SDL-ICONV-CLOSE SDL-ICONV-OPEN
               SDL-TANF SDL-TAN SDL-SQRTF SDL-SQRT SDL-SINF SDL-SIN SDL-SCALBNF
               SDL-SCALBN SDL-LROUNDF SDL-LROUND SDL-ROUNDF SDL-ROUND SDL-POWF
               SDL-POW SDL-LOG10F SDL-LOG10 SDL-LOGF SDL-LOG SDL-FMODF SDL-FMOD
               SDL-TRUNCF SDL-TRUNC SDL-FLOORF SDL-FLOOR SDL-FABSF SDL-FABS
               SDL-EXPF SDL-EXP SDL-COSF SDL-COS SDL-COPYSIGNF SDL-COPYSIGN
               SDL-CEILF SDL-CEIL SDL-ATAN2F SDL-ATAN2 SDL-ATANF SDL-ATAN
               SDL-ASINF SDL-ASIN SDL-ACOSF SDL-ACOS SDL-VASPRINTF SDL-ASPRINTF
               SDL-VSNPRINTF SDL-SNPRINTF SDL-VSSCANF SDL-SSCANF
               SDL-STRNCASECMP SDL-STRCASECMP SDL-STRNCMP SDL-STRCMP SDL-STRTOD
               SDL-STRTOULL SDL-STRTOLL SDL-STRTOUL SDL-STRTOL SDL-ATOF
               SDL-ATOI SDL-ULLTOA SDL-LLTOA SDL-ULTOA SDL-LTOA SDL-UITOA
               SDL-ITOA SDL-UTF8STRNLEN SDL-UTF8STRLEN SDL-STRTOKR
               ...
               SDL-ISALNUM SDL-ISALPHA SDL-ABS SDL-BSEARCH SDL-QSORT SDL-SETENV
               SDL-GETENV SDL-GET-NUM-ALLOCATIONS SDL-SET-MEMORY-FUNCTIONS
               SDL-GET-MEMORY-FUNCTIONS SDL-GET-ORIGINAL-MEMORY-FUNCTIONS
               SDL-FREE SDL-REALLOC SDL-CALLOC SDL-MALLOC __SCALBL SCALBL
               __FMAL FMAL __FMINL FMINL __FMAXL FMAXL __FDIML FDIML __LLROUNDL
               LLROUNDL __LROUNDL LROUNDL __LLRINTL LLRINTL __LRINTL LRINTL
               __REMQUOL REMQUOL __TRUNCL TRUNCL __ROUNDL ROUNDL __NEARBYINTL
               NEARBYINTL __SCALBLNL SCALBLNL __ILOGBL ILOGBL __SCALBNL SCALBNL
               __REMAINDERL REMAINDERL __NEXTTOWARDL NEXTTOWARDL __NEXTAFTERL
               NEXTAFTERL __RINTL RINTL __LGAMMAL_R LGAMMAL-R __GAMMAL GAMMAL
               __TGAMMAL TGAMMAL __LGAMMAL LGAMMAL __ERFCL ERFCL __ERFL ERFL
               __YNL YNL |__Y1L| Y1L |__Y0L| Y0L __JNL JNL |__J1L| J1L |__J0L|
               J0L ISNANL __NANL NANL __COPYSIGNL COPYSIGNL __SIGNIFICANDL
               SIGNIFICANDL __DREML DREML FINITEL ISINFL __FMODL FMODL __FLOORL
               FLOORL __FABSL FABSL __CEILL CEILL __CBRTL CBRTL __HYPOTL HYPOTL
               __SQRTL SQRTL __POWL POWL __LOG2L LOG2L __EXP2L EXP2L __LOGBL
               LOGBL __LOG1PL LOG1PL __EXPM1L EXPM1L __MODFL MODFL __LOG10L
               LOG10L __LOGL LOGL __LDEXPL LDEXPL __FREXPL FREXPL __EXPL EXPL
               __ATANHL ATANHL __ASINHL ASINHL __ACOSHL ACOSHL __TANHL TANHL
               __SINHL SINHL __COSHL COSHL __TANL TANL __SINL SINL __COSL COSL
               __ATAN2L ATAN2L __ATANL ATANL __ASINL ASINL __ACOSL ACOSL
               __ISSIGNALINGL __ISEQSIGL __ISNANL __FINITEL __ISINFL __SIGNBITL
               __FPCLASSIFYL __SCALBF SCALBF __FMAF FMAF __FMINF FMINF __FMAXF
               FMAXF __FDIMF FDIMF __LLROUNDF LLROUNDF __LROUNDF LROUNDF
               __LLRINTF LLRINTF __LRINTF LRINTF __REMQUOF REMQUOF __TRUNCF
               TRUNCF __ROUNDF ROUNDF __NEARBYINTF NEARBYINTF __SCALBLNF
               SCALBLNF __ILOGBF ILOGBF __SCALBNF SCALBNF __REMAINDERF
               REMAINDERF __NEXTTOWARDF NEXTTOWARDF __NEXTAFTERF NEXTAFTERF
               __RINTF RINTF __LGAMMAF_R LGAMMAF-R __GAMMAF GAMMAF __TGAMMAF
               TGAMMAF __LGAMMAF LGAMMAF __ERFCF ERFCF __ERFF ERFF __YNF YNF
               |__Y1F| Y1F |__Y0F| Y0F __JNF JNF |__J1F| J1F |__J0F| J0F ISNANF
               __NANF NANF __COPYSIGNF COPYSIGNF __SIGNIFICANDF SIGNIFICANDF
               __DREMF DREMF FINITEF ISINFF __FMODF FMODF __FLOORF FLOORF
               __FABSF FABSF __CEILF CEILF __CBRTF CBRTF __HYPOTF HYPOTF
               __SQRTF SQRTF __POWF POWF __LOG2F LOG2F __EXP2F EXP2F __LOGBF
               LOGBF __LOG1PF LOG1PF __EXPM1F EXPM1F __MODFF MODFF __LOG10F
               LOG10F __LOGF LOGF __LDEXPF LDEXPF __FREXPF FREXPF __EXPF EXPF
               __ATANHF ATANHF __ASINHF ASINHF __ACOSHF ACOSHF __TANHF TANHF
               __SINHF SINHF __COSHF COSHF __TANF TANF __SINF SINF __COSF COSF
               __ATAN2F ATAN2F __ATANF ATANF __ASINF ASINF __ACOSF ACOSF
               __ISSIGNALINGF __ISEQSIGF __ISNANF __FINITEF __ISINFF __SIGNBITF
               __FPCLASSIFYF __SCALB SCALB __FMA FMA __FMIN FMIN __FMAX FMAX
               __FDIM FDIM __LLROUND LLROUND __LROUND LROUND __LLRINT LLRINT
               __LRINT LRINT __REMQUO REMQUO __TRUNC TRUNC __ROUND ROUND
               __NEARBYINT NEARBYINT __SCALBLN SCALBLN __ILOGB ILOGB __SCALBN
               SCALBN __REMAINDER REMAINDER __NEXTTOWARD NEXTTOWARD __NEXTAFTER
               NEXTAFTER __RINT RINT __LGAMMA_R LGAMMA-R __GAMMA GAMMA __TGAMMA
               TGAMMA __LGAMMA LGAMMA __ERFC ERFC __ERF ERF __YN YN |__Y1| Y1
               |__Y0| Y0 __JN JN |__J1| J1 |__J0| J0 ISNAN __NAN NAN __COPYSIGN
               COPYSIGN __SIGNIFICAND SIGNIFICAND __DREM DREM FINITE ISINF
               __FMOD FMOD __FLOOR FLOOR __FABS FABS __CEIL CEIL __CBRT CBRT
               __HYPOT HYPOT __SQRT SQRT __POW POW __LOG2 LOG2 __EXP2 EXP2
               __LOGB LOGB __LOG1P LOG1P __EXPM1 EXPM1 __MODF MODF __LOG10
               LOG10 __LOG LOG __LDEXP LDEXP __FREXP FREXP __EXP EXP __ATANH
               ATANH __ASINH ASINH __ACOSH ACOSH __TANH TANH __SINH SINH __COSH
               COSH __TAN TAN __SIN SIN __COS COS __ATAN2 ATAN2 __ATAN ATAN
               __ASIN ASIN __ACOS ACOS __ISSIGNALING __ISEQSIG __ISNAN __FINITE
               __ISINF __SIGNBIT __FPCLASSIFY TOUPPER-L __TOUPPER_L TOLOWER-L
               __TOLOWER_L ISBLANK-L ISXDIGIT-L ISUPPER-L ISSPACE-L ISPUNCT-L
               ISPRINT-L ISGRAPH-L ISLOWER-L ISDIGIT-L ISCNTRL-L ISALPHA-L
               ISALNUM-L _TOLOWER _TOUPPER TOASCII ISASCII ISBLANK TOUPPER
               TOLOWER ISXDIGIT ISUPPER ISSPACE ISPUNCT ISPRINT ISGRAPH ISLOWER
               ISDIGIT ISCNTRL ISALPHA ISALNUM __CTYPE_TOUPPER_LOC
               __CTYPE_TOLOWER_LOC __CTYPE_B_LOC WCSTOUMAX WCSTOIMAX STRTOUMAX
               STRTOIMAX IMAXDIV IMAXABS WCSFTIME UNGETWC FPUTWS FGETWS
               PUTWCHAR PUTWC FPUTWC GETWCHAR GETWC FGETWC VSWSCANF VWSCANF
               VFWSCANF VSWSCANF VWSCANF VFWSCANF SWSCANF WSCANF FWSCANF
               SWSCANF WSCANF FWSCANF VSWPRINTF VWPRINTF VFWPRINTF SWPRINTF
               WPRINTF FWPRINTF FWIDE OPEN-WMEMSTREAM WCPNCPY WCPCPY WCSTOULL
               WCSTOLL WCSTOUL WCSTOL WCSTOLD WCSTOF WCSTOD WCSNRTOMBS
               MBSNRTOWCS WCSRTOMBS MBSRTOWCS MBRLEN __MBRLEN WCRTOMB MBRTOWC
               MBSINIT WCTOB BTOWC WMEMSET WMEMMOVE WMEMCPY WMEMCMP WMEMCHR
               WCSNLEN WCSLEN WCSTOK WCSSTR WCSPBRK WCSSPN WCSCSPN WCSRCHR
               WCSCHR WCSDUP WCSXFRM-L WCSCOLL-L WCSXFRM WCSCOLL WCSNCASECMP-L
               ...
               STRNCASECMP STRCASECMP FFSLL FFSL FFS RINDEX INDEX BZERO BCOPY
               BCMP STRERROR-L STRERROR-R STRERROR STRNLEN STRLEN STRTOK-R
               __STRTOK_R STRTOK STRSTR STRPBRK STRSPN STRCSPN STRRCHR STRCHR
               STRNDUP STRDUP STRXFRM-L STRCOLL-L STRXFRM STRCOLL STRNCMP
               STRCMP STRNCAT STRCAT STRNCPY STRCPY MEMCHR __MEMCMPEQ MEMCMP
               MEMSET MEMCCPY MEMMOVE MEMCPY GETLOADAVG GETSUBOPT RPMATCH
               WCSTOMBS MBSTOWCS WCTOMB MBTOWC MBLEN QFCVT-R QECVT-R FCVT-R
               ECVT-R QGCVT QFCVT QECVT GCVT FCVT ECVT LLDIV LDIV DIV LLABS
               LABS ABS QSORT BSEARCH REALPATH SYSTEM MKDTEMP MKSTEMPS MKSTEMP
               MKTEMP CLEARENV UNSETENV SETENV PUTENV GETENV _EXIT QUICK-EXIT
               EXIT ON-EXIT AT-QUICK-EXIT ATEXIT ABORT ALIGNED-ALLOC
               POSIX-MEMALIGN VALLOC ALLOCA REALLOCARRAY REALLOCARRAY FREE
               REALLOC CALLOC MALLOC ARC4RANDOM-UNIFORM ARC4RANDOM-BUF
               ARC4RANDOM LCONG48-R SEED48-R SRAND48-R JRAND48-R MRAND48-R
               NRAND48-R LRAND48-R ERAND48-R DRAND48-R LCONG48 SEED48 SRAND48
               JRAND48 MRAND48 NRAND48 LRAND48 ERAND48 DRAND48 RAND-R SRAND
               RAND SETSTATE-R INITSTATE-R SRANDOM-R RANDOM-R SETSTATE
               INITSTATE SRANDOM RANDOM A64L L64A STRTOULL STRTOLL STRTOUQ
               STRTOQ STRTOUL STRTOL STRTOLD STRTOF STRTOD ATOLL ATOL ATOI ATOF
               ...
               FERROR FEOF CLEARERR FSETPOS FGETPOS FTELLO FSEEKO REWIND FTELL
               FSEEK FWRITE-UNLOCKED FREAD-UNLOCKED FWRITE FREAD UNGETC PUTS
               FPUTS GETLINE GETDELIM __GETDELIM FGETS PUTW GETW
               PUTCHAR-UNLOCKED PUTC-UNLOCKED FPUTC-UNLOCKED PUTCHAR PUTC FPUTC
               FGETC-UNLOCKED GETCHAR-UNLOCKED GETC-UNLOCKED GETCHAR GETC FGETC
               VSSCANF VSCANF VFSCANF VSSCANF VSCANF VFSCANF SSCANF SCANF
               FSCANF SSCANF SCANF FSCANF DPRINTF VDPRINTF VSNPRINTF SNPRINTF
               VSPRINTF VPRINTF VFPRINTF SPRINTF PRINTF FPRINTF SETLINEBUF
               SETBUFFER SETVBUF SETBUF OPEN-MEMSTREAM FMEMOPEN FDOPEN FREOPEN
               FOPEN FFLUSH-UNLOCKED FFLUSH TEMPNAM TMPNAM-R TMPNAM TMPFILE
               FCLOSE RENAMEAT RENAME REMOVE PSELECT SELECT SDL-GET-PLATFORM)
    #<PACKAGE "DUMMY">)
   (EXPORT '(SIGNGAM STDERR STDOUT STDIN) #<PACKAGE "DUMMY">)
   (EXPORT
    '(+_ALLOCA_H+ +SDL-PR-IU32+ +SDL-PR-IX32+ +SDL-PRIX32+ +SDL-PRIX64+
      +SDL-PR-IS32+ +SDL-PR-IU64+ +SDL-PR-IX64+ +SDL-FLT-EPSILON+ +SDL-PR-IS64+
      +SDL-MIN-UINT64+ +SDL-MIN-SINT64+ +SDL-MAX-UINT64+ +SDL-MAX-SINT64+
      +PR-IX32+ +__UWORD_TYPE+ +PR-IX16+ +__SWORD_TYPE+ +PR-IX8+ +__UQUAD_TYPE+
      +PR-IU-FAST64+ +__SQUAD_TYPE+ +PR-IU-FAST32+ +__ULONGWORD_TYPE+
      +PR-IU-FAST16+ +__U64_TYPE+ +PR-IU-FAST8+ +__S64_TYPE+ +PR-IU-LEAST64+
      +__ULONG32_TYPE+ +PR-IU-LEAST32+ +__SLONG32_TYPE+ +PR-IU-LEAST16+
      +PR-IX-FAST64+ +__SYSCALL_ULONG_TYPE+ +PR-IX-FAST32+
      +__SYSCALL_SLONG_TYPE+ +PR-IX-FAST16+ +_BITS_TYPESIZES_H+ +PR-IX-FAST8+
      +PR-IX-LEAST64+ +__STD_TYPE+ +__INO64_T_TYPE+ +PR-IX-LEAST32+
      +__INO_T_TYPE+ +PR-IX-LEAST16+ +__GID_T_TYPE+ +__UID_T_TYPE+
      +PR-IX-LEAST8+ +PR-IX64+ +__DEV_T_TYPE+ +__OFF_T_TYPE+ +PRIXFAST16+
      +__FSWORD_T_TYPE+ +PRIXLEAST64+ +PRIXFAST8+ +__NLINK_T_TYPE+
      +PRIXLEAST32+ +PRIXLEAST16+ +__MODE_T_TYPE+ +PRIXLEAST8+
      +__BLKCNT_T_TYPE+ +PRIX64+ +__RLIM64_T_TYPE+ +PRIX16+ +PRIX32+
      +__RLIM_T_TYPE+ +PRIX8+ +__OFF64_T_TYPE+ +__PID_T_TYPE+
      +__FSFILCNT_T_TYPE+ +__FSBLKCNT64_T_TYPE+ +__FSBLKCNT_T_TYPE+
      +__BLKCNT64_T_TYPE+ +__TIME_T_TYPE+ +__CLOCK_T_TYPE+ +__ID_T_TYPE+
      +PRIXFAST32+ +__FSFILCNT64_T_TYPE+ +SDL-ASSERT-LEVEL+ +SDL-FUNCTION+
      +SDL-NULL-WHILE-LOOP-CONDITION+ +SDL-LINE+ +SDL-FILE+
      +SDL-MUTEX-TIMEDOUT+ +SDL-MUTEX-MAXWAIT+
      +SDL-HINT-WINDOWS-FORCE-SEMAPHORE-KERNEL+
      +SDL-HINT-WINRT-PRIVACY-POLICY-URL+ +SDL-HINT-AUDIODRIVER+
      +SDL-HINT-DIRECTINPUT-ENABLED+ +SDL-HINT-WINDOW-NO-ACTIVATION-WHEN-SHOWN+
      +SDL-HINT-WINRT-PRIVACY-POLICY-LABEL+ +SDL-HINT-X11-WINDOW-TYPE+
      +SDL-HAPTIC-TRIANGLE+ +SDL-HINT-QUIT-ON-LAST-WINDOW-CLOSE+
      +SDL-HINT-X11-FORCE-OVERRIDE-REDIRECT+ +SDL-HINT-VIDEO-WIN-D3DCOMPILER+
      +SDL-HINT-WINDOWS-INTRESOURCE-ICON+
      +SDL-HINT-WINDOWS-FORCE-MUTEX-CRITICAL-SECTIONS+
      +SDL-HINT-WINDOW-FRAME-USABLE-WHILE-CURSOR-HIDDEN+ +SDL-HINT-VIDEODRIVER+
      +SDL-HINT-WINRT-HANDLE-BACK-BUTTON+ +SDL-HINT-WINDOWS-USE-D3D9EX+
      +SDL-HINT-WINDOWS-DISABLE-THREAD-NAMING+
      +SDL-HINT-AUDIO-INCLUDE-MONITORS+ +SDL-HAPTIC-STEERING-AXIS+
      +SDL-HAPTIC-INFINITY+ +SDL-HINT-XINPUT-ENABLED+
      +SDL-HINT-XINPUT-USE-OLD-JOYSTICK-MAPPING+ +SDL-HINT-WINDOWS-DPI-SCALING+
      +SDL-HINT-VIDEO-WINDOW-SHARE-PIXEL-FORMAT+
      +SDL-HINT-WINDOWS-INTRESOURCE-ICON-SMALL+ +SDL-HINT-WAVE-RIFF-CHUNK-SIZE+
      +SDL-HAPTIC-SPHERICAL+ +SDL-HINT-WINDOWS-ENABLE-MESSAGELOOP+
      +SDL-HINT-WAVE-TRUNCATION+ +SDL-HAPTIC-INERTIA+ +SDL-HAPTIC-FRICTION+
      +SDL-HINT-WINDOWS-ENABLE-MENU-MNEMONICS+ +SDL-HAPTIC-SPRING+
      +SDL-HAPTIC-DAMPER+ +SDL-HAPTIC-SAWTOOTHDOWN+ +SDL-HAPTIC-RAMP+
      +SDL-HAPTIC-SAWTOOTHUP+ +SDL-HAPTIC-CARTESIAN+ +SDL-HAPTIC-POLAR+
      +SDL-HINT-WINDOWS-NO-CLOSE-ON-ALT-F4+ +SDL-HAPTIC-PAUSE+
      +SDL-HINT-VIDEO-X11-FORCE-EGL+ +SDL-HAPTIC-AUTOCENTER+
      +SDL-HAPTIC-STATUS+ +SDL-HINT-WINDOWS-DPI-AWARENESS+ +SDL-HAPTIC-CUSTOM+
      +SDL-HAPTIC-GAIN+ +__RELAXED_FN_ATTRS+ +_BITS_TYPES_H+
      +SDL-HINT-VIDEO-WAYLAND-EMULATE-MOUSE-WARP+
      +SDL-HINT-VIDEO-FOREIGN-WINDOW-OPENGL+
      +SDL-HINT-VIDEO-FOREIGN-WINDOW-VULKAN+ +SDL-HAPTIC-LEFTRIGHT+
      +SDL-HINT-VIDEO-X11-NET-WM-PING+
      +SDL-HINT-VIDEO-X11-NET-WM-BYPASS-COMPOSITOR+ +SDL-HAPTIC-SINE+
      +SDL-HAPTIC-CONSTANT+ +SDL-HINT-VIDEO-X11-XINERAMA+
      +SDL-HINT-VIDEO-X11-XRANDR+ +SDL-HINT-VIDEO-X11-WINDOW-VISUALID+
      +SDL-HINT-WAVE-FACT-CHUNK+ +SDL-HINT-VIDEO-X11-XVIDMODE+
      +SDL-HINT-TOUCH-MOUSE-EVENTS+ +__DEFAULT_FN_ATTRS_VL128+
      +SDL-HINT-TV-REMOTE-AS-JOYSTICK+ +__DEFAULT_FN_ATTRS_Z+
      +SDL-HINT-VITA-TOUCH-MOUSE-DEVICE+ +SDL-HINT-VIDEO-DOUBLE-BUFFER+
      +SDL-HINT-VIDEO-WAYLAND-PREFER-LIBDECOR+
      +SDL-HINT-VIDEO-ALLOW-SCREENSAVER+
      +SDL-HINT-VIDEO-EGL-ALLOW-TRANSPARENCY+
      +SDL-HINT-VIDEO-MINIMIZE-ON-FOCUS-LOSS+ +SDL-HINT-VIDEO-HIGHDPI-DISABLED+
      +__U16_TYPE+ +SDL-HINT-VIDEO-EXTERNAL-CONTEXT+ +__S32_TYPE+
      +SDL-HINT-RETURN-KEY-HIDES-IME+ +__U32_TYPE+
      +SDL-HINT-VIDEO-MAC-FULLSCREEN-SPACES+ +__SLONGWORD_TYPE+
      +SDL-HINT-THREAD-PRIORITY-POLICY+ +SDL-HINT-THREAD-STACK-SIZE+
      +SDL-HINT-VIDEO-WAYLAND-ALLOW-LIBDECOR+ +SDL-HINT-TIMER-RESOLUTION+
      +SDL-HINT-RENDER-OPENGL-SHADERS+
      +SDL-HINT-SCREENSAVER-INHIBIT-ACTIVITY-NAME+
      +SDL-HINT-VIDEO-WAYLAND-MODE-EMULATION+ +SDL-HINT-ROG-GAMEPAD-MICE+
      +SDL-HINT-PS2-DYNAMIC-VSYNC+ +SDL-HINT-POLL-SENTINEL+ +__S16_TYPE+
      +SDL-HINT-RENDER-VSYNC+ +SDL-HINT-RENDER-BATCHING+
      +SDL-HINT-ROG-GAMEPAD-MICE-EXCLUDED+ +SDL-HINT-RENDER-SCALE-QUALITY+
      +SDL-HINT-RENDER-METAL-PREFER-LOW-POWER-DEVICE+
      +SDL-HINT-OPENGL-ES-DRIVER+
      +SDL-HINT-THREAD-FORCE-REALTIME-TIME-CRITICAL+ +SDL-HINT-ORIENTATIONS+
      +SDL-HINT-QTWAYLAND-CONTENT-ORIENTATION+ +SDL-HINT-RPI-VIDEO-LAYER+
      +SDL-HINT-MOUSE-AUTO-CAPTURE+ +_MM512_MASK_CVTPS_PH+ +_MM512_CVTPS_PH+
      +SDL-HINT-NO-SIGNAL-HANDLERS+ +SDL-HINT-PREFERRED-LOCALES+
      +SDL-HINT-RENDER-LINE-METHOD+ +SDL-HINT-RENDER-DIRECT3D11-DEBUG+
      +SDL-HINT-QTWAYLAND-WINDOW-FLAGS+ +SDL-HINT-MOUSE-TOUCH-EVENTS+
      +SDL-HINT-RENDER-DRIVER+ +SDL-HINT-RENDER-LOGICAL-SIZE-MODE+
      +SDL-HINT-RENDER-DIRECT3D-THREADSAFE+
      +SDL-HINT-MOUSE-RELATIVE-WARP-MOTION+ +SDL-HINT-MOUSE-NORMAL-SPEED-SCALE+
      +__DEFAULT_FN_ATTRS_Z_MASK+ +SDL-HINT-MOUSE-RELATIVE-SYSTEM-SCALE+
      +SDL-HINT-MOUSE-RELATIVE-SCALING+ +SDL-HINT-MOUSE-RELATIVE-MODE-WARP+
      +SDL-HINT-MOUSE-RELATIVE-SPEED-SCALE+
      +SDL-HINT-MOUSE-RELATIVE-MODE-CENTER+ +_MM512_MASKZ_CVTPS_PH+
      +__DEFAULT_FN_ATTRS_VL256+ +_M_PEXTRW+ +_M_PINSRW+ +_M_PMAXSW+
      +_M_PMAXUB+ +_M_MASKMOVQ+ +_M_PAVGB+ +_M_PAVGW+ +_M_+ +_M_PSADBW+
      +_M_PCMPGTD+ +_M_PMINUB+ +_M_PMINSW+ +_M_PCMPGTW+ +_M_PMOVMSKB+
      +_M_PCMPGTB+ +_M_PMULHUW+ +_M_PCMPEQD+ +_M_PCMPEQW+ +_M_PSHUFW+
      +_M_PCMPEQB+ +_M_PXOR+ +__DEFAULT_FN_ATTRS_Y+ +_M_POR+ +_M_PANDN+
      +_M_PAND+ +_M_PSRLQI+ +_M_PSRLQ+ +_M_PSRLDI+ +_M_PSRLD+ +_M_PSRLWI+
      +_MM_ALIGN16+ +_MM_EXCEPT_INEXACT+ +_MM_EXCEPT_UNDERFLOW+
      +_MM_MASK_INVALID+ +_MM_EXCEPT_MASK+ +_MM_EXCEPT_DENORM+
      +_MM_EXCEPT_INVALID+ +_MM_EXCEPT_OVERFLOW+ +_MM_EXCEPT_DIV_ZERO+
      +_MM_MASK_MASK+ +_MM_MASK_INEXACT+ +_MM_ROUND_UP+ +_MM_ROUND_NEAREST+
      +_MM_ROUND_DOWN+ +_MM_MASK_DIV_ZERO+ +_MM_MASK_DENORM+
      +_MM_MASK_UNDERFLOW+ +_MM_MASK_OVERFLOW+ +_MM_FLUSH_ZERO_OFF+
      +_MM_ROUND_MASK+ +_MM_ROUND_TOWARD_ZERO+ +_MM_FLUSH_ZERO_ON+
      +_MM_FLUSH_ZERO_MASK+ +SDL-WINDOW-LACKS-SHAPE+ +SDL-NONSHAPEABLE-WINDOW+
      +__DEFAULT_FN_ATTRS256+ +____GWCHAR_T_DEFINED+ +__PRIPTR_PREFIX+
      +__PRI64_PREFIX+ +PR-ID16+ +PR-ID32+ +PR-ID8+
      +SDL-INVALID-SHAPE-ARGUMENT+ +SDL-TOUCH-MOUSEID+ +PRIXFAST64+ +PR-ID-MAX+
      +PR-II8+ +PR-II32+ +PR-II16+ +SC-ND-LEAST8+ +PR-II64+ +PR-IX-PTR+
      +PR-ID-FAST8+ +PR-II-LEAST8+ +PR-IX-MAX+ +SC-NI16+ +PR-II-LEAST16+
      +PRIXMAX+ +PR-II-LEAST32+ +PR-II-MAX+ +PR-II-FAST8+ +PR-II-LEAST64+
      +PR-IU-MAX+ +PR-II-FAST16+ +PR-IO-MAX+ +PR-ID64+ +PR-IU-PTR+ +PRIXPTR+
      +PR-ID-LEAST8+ +PR-ID-PTR+ +PR-II-PTR+ +PR-ID-LEAST16+ +PR-IO-PTR+
      +SC-ND64+ +PR-ID-LEAST32+ +PR-ID-FAST16+ +SC-ND32+ +PR-ID-LEAST64+
      +SC-ND8+ +PR-ID-FAST32+ +SC-ND-LEAST64+ +PR-ID-FAST64+ +SC-ND-FAST32+
      +SC-ND16+ +PR-IO-LEAST64+ +SC-NI-LEAST8+ +PR-IO-FAST8+ +SC-NI32+
      +SC-ND-FAST8+ +PR-IO-FAST16+ +SC-ND-LEAST16+ +PR-IO-FAST32+
      +SC-ND-LEAST32+ +PR-IO-FAST64+ +PR-IU8+ +SC-NI8+ +PR-IU16+
      +SC-NI-LEAST32+ +PR-IU32+ +SC-ND-FAST16+ +PR-IU64+ +PR-IU-LEAST8+
      +SC-ND-FAST64+ +SC-NI-LEAST16+ +PR-II-FAST32+ +PR-IO8+ +PR-II-FAST64+
      +SC-NI64+ +PR-IO16+ +PR-IO32+ +SC-NI-FAST16+ +PR-IO-LEAST8+
      +SC-NI-FAST32+ +PR-IO64+ +SC-NI-FAST64+ +PR-IO-LEAST16+ +SC-NI-LEAST64+
      +SC-NI-FAST8+ +PR-IO-LEAST32+ +__ATTRIBUTE_WARN_UNUSED_RESULT__+
      +SC-NU16+ +SC-NU8+ +SC-NU-LEAST8+ +SC-NU64+ +__RETURNS_NONNULL+
      +MATH-ERREXCEPT+ +SC-NU32+ +SC-NU-LEAST32+ +MATH-ERRNO+ +SC-NU-LEAST16+
      +SC-NU-FAST8+ +SC-NU-LEAST64+ +SC-NU-FAST64+ +M-LOG10E+ +M-E+
      +SC-NU-FAST32+ +SC-NU-FAST16+ +M-LOG2E+ +MATH-ERRHANDLING+ +SC-NO16+
      +SC-NO8+ +SC-NO-LEAST8+ +M-PI-4+ +M-PI-2+ +SC-NO64+ +SC-NO32+ +M-LN10+
      +M-PI+ +SC-NO-LEAST32+ +SC-NO-LEAST16+ +M-LN2+ +__ATTRIBUTE_DEPRECATED__+
      +__MATHCALL_NARROW_ARGS_3+ +SC-NO-FAST8+ +SC-NO-LEAST64+
      +__MATHCALL_NARROW_ARGS_2+ +SC-NO-FAST64+ +__MATHCALL_NARROW_ARGS_1+
      +SC-NO-FAST16+ +SC-NO-FAST32+ +SC-NX16+ +__RESTRICT_ARR+ +SC-NX8+
      +__DEFAULT_FN_ATTRS512+ +__FORTIFY_FUNCTION+ +SC-NX-LEAST8+ +SC-NX32+
      +__EXTERN_ALWAYS_INLINE+ +SC-NX64+ +__EXTERN_INLINE+ +SC-NX-LEAST32+
      +SDL-MOUSE-TOUCHID+ +SC-NX-LEAST16+ +SC-NX-FAST8+ +SC-NX-LEAST64+
      +__ATTRIBUTE_ARTIFICIAL__+ +SC-NX-FAST64+ +SC-NX-FAST16+ +SC-NX-FAST32+
      +__ALWAYS_INLINE+ +SC-NI-MAX+ +SC-ND-MAX+ +SC-NU-MAX+ +SC-NO-MAX+
      +SC-NX-MAX+ +_MM512_SETZERO+ +_MM512_SETZERO_EPI32+
      +__LDOUBLE_REDIRECTS_TO_FLOAT128_ABI+ +M-SQRT2+ +M-SQRT1-2+ +M-2-PI+
      +M-1-PI+ +M-2-SQRTPI+ +FLT-EVAL-METHOD+ +__HAVE_GENERIC_SELECTION+
      +FLT-ROUNDS+ +FLT-RADIX+ +SDL-HINT-ACCELEROMETER-AS-JOYSTICK+
      ...
      +SDL-AUDIOCVT-MAX-FILTERS+ +SDL-HINT-ANDROID-TRAP-BACK-BUTTON+
      +SDL-HINT-ANDROID-BLOCK-ON-PAUSE+
      +SDL-HINT-ANDROID-BLOCK-ON-PAUSE-PAUSEAUDIO+
      +SDL-HINT-APPLE-TV-REMOTE-ALLOW-ROTATION+ +SDL-HINT-AUDIO-CATEGORY+
      +SDL-HINT-APP-NAME+ +SDL-HINT-APPLE-TV-CONTROLLER-UI-EVENTS+
      +SDL-HINT-AUDIO-DEVICE-STREAM-ROLE+ +SDL-HINT-AUDIO-DEVICE-APP-NAME+
      +SDL-HINT-AUDIO-DEVICE-STREAM-NAME+ +SDL-AUDIO-ALLOW-SAMPLES-CHANGE+
      +SDL-AUDIO-ALLOW-ANY-CHANGE+ +_BITS_UINTN_IDENTITY_H+
      +SDL-AUDIO-ALLOW-FREQUENCY-CHANGE+ +AUDIO-F32SYS+
      +SDL-AUDIO-ALLOW-CHANNELS-CHANGE+ +SDL-AUDIO-ALLOW-FORMAT-CHANGE+
      +_SYS_SELECT_H+ +AUDIO-U16SYS+ +AUDIO-F32+ +AUDIO-S32SYS+ +AUDIO-S16SYS+
      +AUDIO-F32MSB+ +AUDIO-F32LSB+ +SDL-HINT-JOYSTICK-HIDAPI-SHIELD+
      +SDL-HINT-JOYSTICK-BLACKLIST-DEVICES+
      +SDL-HINT-JOYSTICK-ARCADESTICK-DEVICES-EXCLUDED+
      +SDL-HINT-JOYSTICK-GAMECUBE-DEVICES+
      +SDL-HINT-JOYSTICK-BLACKLIST-DEVICES-EXCLUDED+ +_STRUCT_TIMESPEC+
      +SDL-HINT-JOYSTICK-FLIGHTSTICK-DEVICES+
      +SDL-HINT-JOYSTICK-FLIGHTSTICK-DEVICES-EXCLUDED+ +__NFDBITS+ +FD-SETSIZE+
      +SDL-HINT-JOYSTICK-GAMECUBE-DEVICES-EXCLUDED+
      +SDL-HINT-JOYSTICK-HIDAPI-GAMECUBE+ +SDL-HINT-JOYSTICK-HIDAPI+
      +SDL-HINT-JOYSTICK-GAMECUBE-RUMBLE-BRAKE+ +NFDBITS+
      ...
      +SDL-HINT-JOYSTICK-HIDAPI-PS5-RUMBLE+ +SDL-HINT-JOYSTICK-HIDAPI-STADIA+
      +__SIGSET_T_DEFINED+ +SDL-HINT-JOYSTICK-HIDAPI-STEAM+
      +SDL-HINT-JOYSTICK-HIDAPI-STEAMDECK+ +_SIGSET_NWORDS+ +__TIMEVAL_DEFINED+
      +SDL-HINT-JOYSTICK-HIDAPI-SWITCH+ +SDL-HINT-AUTO-UPDATE-JOYSTICKS+
      +SDL-HINT-AUDIO-RESAMPLING-MODE+ +SDL-HINT-BMP-SAVE-LEGACY-FORMAT+
      +SDL-HINT-AUTO-UPDATE-SENSORS+ +SDL-HINT-EMSCRIPTEN-ASYNCIFY+
      +SDL-HINT-DISPLAY-USABLE-BOUNDS+ +SDL-HINT-EMSCRIPTEN-KEYBOARD-ELEMENT+
      +SDL-HINT-ENABLE-STEAM-CONTROLLERS+ +SDL-HINT-ENABLE-SCREEN-KEYBOARD+
      +SDL-HINT-FORCE-RAISEWINDOW+ +SDL-HINT-EVENT-LOGGING+
      +__GCC_HAVE_DWARF2_CFI_ASM+ +SDL-HINT-FRAMEBUFFER-ACCELERATION+
      +SDL-HINT-GAMECONTROLLERCONFIG-FILE+ +SDL-HINT-GAMECONTROLLERCONFIG+
      +SDL-HINT-GAMECONTROLLER-IGNORE-DEVICES+ +SDL-HINT-GAMECONTROLLERTYPE+
      +__LINUX__+ +SDL-HINT-GAMECONTROLLER-IGNORE-DEVICES-EXCEPT+
      +SDL-HINT-GRAB-KEYBOARD+ +SDL-HINT-GAMECONTROLLER-USE-BUTTON-LABELS+
      +SDL-HINT-IDLE-TIMER-DISABLED+ +SDL-HINT-HIDAPI-IGNORE-DEVICES+
      +SDL-HINT-IME-SHOW-UI+ +SDL-HINT-IME-INTERNAL-EDITING+
      +SDL-HINT-IME-SUPPORT-EXTENDED-TEXT+
      +SDL-HINT-JOYSTICK-ALLOW-BACKGROUND-EVENTS+
      +SDL-HINT-IOS-HIDE-HOME-INDICATOR+
      +SDL-HINT-JOYSTICK-ARCADESTICK-DEVICES+ +SDL-ENABLE+ +SDL-IGNORE+
      +SDL-QUERY+ +SDL-DISABLE+ +__MATH_DECLARE_LDOUBLE+ +SDL-INLINE+
      +_CMP_TRUE_UQ+ +SDL-TEXTEDITINGEVENT-TEXT-SIZE+ +_CMP_EQ_OS+ +_CMP_LT_OQ+
      +_CMP_UNORD_S+ +_CMP_LE_OQ+ +_CMP_FALSE_OQ+ +_CMP_NGT_US+ +_CMP_NEQ_OQ+
      +_CMP_GE_OS+ +_CMP_GT_OS+ +_CMP_NLE_US+ +SDL-TEXTINPUTEVENT-TEXT-SIZE+
      +_CMP_ORD_Q+ +_CMP_EQ_UQ+ +_CMP_NGE_US+ +_CMP_UNORD_Q+ +_CMP_LE_OS+
      +_CMP_NEQ_UQ+ +_CMP_NLT_US+ +__ATTRIBUTE_CONST__+ +__ATTRIBUTE_PURE__+
      +_CMP_GE_OQ+ +_CMP_GT_OQ+ +_CMP_TRUE_US+ +__ATTRIBUTE_MALLOC__+
      +_CMP_EQ_US+ +_CMP_NGE_UQ+ +_CMP_NGT_UQ+ +_CMP_FALSE_OS+ +_CMP_NEQ_OS+
      +__ATTRIBUTE_NOINLINE__+ +_CMP_NEQ_US+ +__ATTRIBUTE_USED__+ +_CMP_NLT_UQ+
      +__ATTRIBUTE_MAYBE_UNUSED__+ +_CMP_NLE_UQ+ +_CMP_ORD_S+ +SDL-BLIT-SCALED+
      +SDL-WINDOWPOS-CENTERED+ +__STDC_IEC_60559_COMPLEX__+ +SDL-BLIT-SURFACE+
      +__STDC_IEC_559_COMPLEX__+ +__GNU_LIBRARY__+ +__GLIBC__+
      +__STDC_ISO_10646__+ +__GLIBC_MINOR__+ +SDL-WINDOWPOS-CENTERED-MASK+
      +_SYS_CDEFS_H+ +__STRUCT_FILE_DEFINED+ +__FILE_DEFINED+
      +SDL-WINDOWPOS-UNDEFINED+ +____FILE_DEFINED+ +SDL-ICONV-E2BIG+
      +SDL-ICONV-EILSEQ+ +SDL-ICONV-EINVAL+ +_____FPOS64_T_DEFINED+
      +UINT64-MAX+ +INT-LEAST8-MIN+ +INT-LEAST16-MIN+ +UINT16-MAX+ +UINT32-MAX+
      +INT64-MAX+ +UINT8-MAX+ +SDL-ICONV-ERROR+ +INT16-MAX+ +INT32-MAX+
      +UINT-LEAST16-MAX+ +UINT-LEAST32-MAX+ +INT-LEAST32-MAX+ +INT-LEAST64-MAX+
      +UINT-LEAST8-MAX+ +INT-LEAST8-MAX+ +__FLEXARR+ +INT-LEAST16-MAX+
      +__GLIBC_C99_FLEXARR_AVAILABLE+ +INT-LEAST32-MIN+ +INT-LEAST64-MIN+
      +__PTR_T+ +INT32-MIN+ +INT8-MAX+ +INT64-MIN+ +INT8-MIN+ +__THROW+
      +INT16-MIN+ +__THROWNL+ +_MM_DENORMALS_ZERO_MASK+ +SIZE-MAX+ +WINT-MIN+
      +SIG-ATOMIC-MAX+ +WINT-MAX+ +PTRDIFF-MIN+ +UINTMAX-MAX+ +SIG-ATOMIC-MIN+
      +PTRDIFF-MAX+ +__ONCE_FLAG_INIT+ +INT-FAST8-MAX+ +INT-FAST64-MIN+
      +INT-FAST64-MAX+ +INT-FAST32-MAX+ +INT-FAST16-MAX+ +INT-FAST8-MIN+
      +UINT-LEAST64-MAX+ +INT-FAST32-MIN+ +INT-FAST16-MIN+ +INTPTR-MAX+
      +INTPTR-MIN+ +INTMAX-MAX+ +INTMAX-MIN+ +UINTPTR-MAX+ +UINT-FAST16-MAX+
      +UINT-FAST8-MAX+ +UINT-FAST64-MAX+ +UINT-FAST32-MAX+
      +SDL-STANDARD-GRAVITY+ +_____FPOS_T_DEFINED+ +____MBSTATE_T_DEFINED+
      +SDL-WINDOWPOS-UNDEFINED-MASK+ +__GLIBC_USE_IEC_60559_TYPES_EXT+
      +__GLIBC_USE_IEC_60559_FUNCS_EXT_C2X+ +SDL-HINT-SHUTDOWN-DBUS-ON-QUIT+
      +SDL-HINT-TRACKPAD-IS-TOUCH-ONLY+ +__GLIBC_USE_IEC_60559_FUNCS_EXT+
      +SDL-HINT-KMSDRM-DEVICE-INDEX+ +__GLIBC_USE_IEC_60559_EXT+
      +__GLIBC_USE_IEC_60559_BFP_EXT_C2X+ +__GLIBC_USE_IEC_60559_BFP_EXT+
      +__GLIBC_USE_LIB_EXT2+ +_CMP_EQ_OQ+ +_STDIO_H+ +__HAVE_PTHREAD_ATTR_T+
      +_CMP_LT_OS+ +__DEFAULT_FN_ATTRS128+ +_BITS_LIBM_SIMD_DECL_STUBS_H+
      +_MATH_H+ +SDL-MAX-LOG-MESSAGE+ +SDL-BUTTON-MIDDLE+ +SDL-BUTTON-RIGHT+
      +SDL-BUTTON-X1+ +SDL-BUTTON-LEFT+ +_MM_FROUND_FLOOR+ +_MM_FROUND_NINT+
      +_MM_FROUND_NO_EXC+ +_MM_FROUND_RAISE_EXC+ +_MM_FROUND_NEARBYINT+
      +_MM_FROUND_RINT+ +_MM_FROUND_TRUNC+ +_MM_FROUND_CEIL+
      +_MM_FROUND_TO_NEAREST_INT+ +_MM_FROUND_CUR_DIRECTION+
      +_MM_FROUND_TO_ZERO+ +_MM_FROUND_TO_POS_INF+ +_MM_FROUND_TO_NEG_INF+
      +HAS-BROKEN-BSWAP+ +WEOF+ +__MBSTATE_T_DEFINED+ +WCHAR-MIN+ +WCHAR-MAX+
      +HAS-BUILTIN-BSWAP32+ +__WCHAR_MIN+ +HAS-BUILTIN-BSWAP64+
      +__WINT_T_DEFINED+ +HAS-BUILTIN-BSWAP16+ +_WINT_T+
      +SDL-SCOPED-CAPABILITY+ +__CLOCK_T_DEFINED+ +__TIME_T_DEFINED+
      +__CLOCKID_T_DEFINED+ +__HAVE_FLOAT128X+ +__WORDSIZE+ +__HAVE_FLOAT32X+
      +__HAVE_FLOAT64+ +_STRINGS_H+ +__SYSCALL_WORDSIZE+ +__HAVE_FLOAT32+
      +__HAVE_FLOAT16+ +__WORDSIZE_TIME64_COMPAT32+
      +__HAVE_FLOAT64X_LONG_DOUBLE+ +__TIMESIZE+ +__HAVE_FLOAT64X+
      +__HAVE_DISTINCT_FLOAT128+ +_STDC_PREDEF_H+ +__HAVE_FLOAT128_UNLIKE_LDBL+
      +__HAVE_DISTINCT_FLOAT128X+ +__STDC_IEC_559__+ +__HAVE_DISTINCT_FLOAT64X+
      +__HAVE_DISTINCT_FLOAT32X+ +__HAVE_DISTINCT_FLOAT64+
      +__STDC_IEC_60559_BFP__+ +__HAVE_DISTINCT_FLOAT32+
      +__HAVE_DISTINCT_FLOAT16+ +__CFLOAT32X+ +__CFLOAT64+ +__WCHAR_MAX+
      +__CFLOAT32+ +_BITS_WCHAR_H+ +__HAVE_FLOATN_NOT_TYPEDEF+ +__CFLOAT64X+
      +LITTLE-ENDIAN+ +__USE_FORTIFY_LEVEL+ +BIG-ENDIAN+ +__USE_ATFILE+
      +PDP-ENDIAN+ +BYTE-ORDER+ +__GLIBC_USE_DEPRECATED_GETS+
      +__GLIBC_USE_DEPRECATED_SCANF+ +_BITS_BYTESWAP_H+ +__GLIBC_USE_ISOC2X+
      +__INLINE__+ +_DEFAULT_SOURCE+ +_POSIX_SOURCE+ +_POSIX_C_SOURCE+
      +__USE_POSIX_IMPLICITLY+ +_ATFILE_SOURCE+ +_MM_MASKZ_CVTPS_PH+
      +_MM_CMPINT_GE+ +_MM_MASK_CVTPS_PH+ +__TIMER_T_DEFINED+ +__USE_ISOC99+
      +__USE_ISOC11+ +_MM_CMPINT_GT+ +_FEATURES_H+ +_BITS_STDINT_INTN_H+
      +__USE_POSIX2+ +__USE_POSIX+ +__USE_ISOC95+ +_MM256_MASK_CVTPS_PH+
      +__BIT_TYPES_DEFINED__+ +__USE_POSIX199506+
      +SDL-NO-THREAD-SAFETY-ANALYSIS+ +__USE_POSIX199309+
      +_MM256_MASKZ_CVTPS_PH+ +_BITS_ENDIAN_H+ +__LITTLE_ENDIAN+ +_ENDIAN_H+
      +__USE_XOPEN2K8+ +__PDP_ENDIAN+ +__BIG_ENDIAN+ +__USE_XOPEN2K+
      +__USE_MISC+ +__BYTE_ORDER+ +_BITS_ENDIANNESS_H+ +__FLOAT_WORD_ORDER+
      +__TIME64_T_TYPE+ +SDL-ALPHA-OPAQUE+ +_BITS_TIME64_H+ +__FD_SETSIZE+
      +SDL-AUDIO-MASK-SIGNED+ +SDL-AUDIO-MASK-ENDIAN+ +SDL-AUDIO-MASK-DATATYPE+
      +SDL-AUDIO-MASK-BITSIZE+ +__OFF_T_MATCHES_OFF64_T+ +SDL-BUTTON-X2MASK+
      +AUDIO-S16MSB+ +__CPU_MASK_TYPE+ +AUDIO-U16MSB+ +AUDIO-S16LSB+
      +SDL-BUTTON-RMASK+ +__SSIZE_T_TYPE+ +AUDIO-U16LSB+ +SDL-BUTTON-LMASK+
      +SDL-BUTTON-X1MASK+ +AUDIO-S8+ +__KERNEL_OLD_TIMEVAL_MATCHES_TIMEVAL64+
      +SDL-ALPHA-TRANSPARENT+ +AUDIO-U8+ +__STATFS_MATCHES_STATFS64+
      +SDL-BUTTON-MMASK+ +__RLIM_T_MATCHES_RLIM64_T+ +__INO_T_MATCHES_INO64_T+
      +__DADDR_T_TYPE+ +__SUSECONDS64_T_TYPE+ +__SUSECONDS_T_TYPE+
      +__USECONDS_T_TYPE+ +__FSID_T_TYPE+ +__BLKSIZE_T_TYPE+ +AUDIO-S32+
      +AUDIO-S32MSB+ +__TIMER_T_TYPE+ +AUDIO-S32LSB+ +AUDIO-S16+
      +__CLOCKID_T_TYPE+ +AUDIO-U16+ +__KEY_T_TYPE+ +_MM_HINT_NTA+
      +_MM_HINT_T1+ +_MM_HINT_T2+ +_MM_HINT_ET1+ +_MM_HINT_ET0+ +_MM_HINT_T0+
      +SDL-IPHONE-MAX-GFORCE+ +SDL-SWSURFACE+ +SDL-PREALLOC+ +SDL-RLEACCEL+
      +SDL-DONTFREE+ +SDL-SIMD-ALIGNED+ +SDL-VIRTUAL-JOYSTICK-DESC-VERSION+
      +_DEFAULT_FN_ATTRS+ +__PCONFIG_KEY_PROGRAM+ +SDL-CACHELINE-SIZE+
      +__TMPGPR+ +__SAVE_GPRBX+ +__RESTORE_GPRBX+ +SDL-HAT-LEFT+
      +SDL-HAT-RIGHTUP+ +SDL-HAT-LEFTUP+ +SDL-HAT-RIGHTDOWN+ +SDL-HAT-CENTERED+
      +SDL-HAT-LEFTDOWN+ +SDL-HAT-UP+ +SDL-HAT-RIGHT+ +SDL-HAT-DOWN+
      +SDL-JOYSTICK-AXIS-MAX+ +SDL-JOYSTICK-AXIS-MIN+ +SDL-COLOUR+
      +__DEFAULT_FN_ATTRS_COMPLEX+ +SDL-VIDEO-DRIVER-X11-XSCRNSAVER+
      +SDL-VIDEO-DRIVER-X11-XRANDR+
      +SDL-VIDEO-DRIVER-X11-SUPPORTS-GENERIC-EVENTS+
      +SDL-VIDEO-DRIVER-X11-XSHAPE+
      +SDL-VIDEO-DRIVER-X11-HAS-XKBKEYCODETOKEYSYM+ +SDL-FLOATWORDORDER+
      +SDL-VIDEO-RENDER-OGL-ES2+ +SDL-VIDEO-RENDER-OGL+
      +SDL-VIDEO-DRIVER-OFFSCREEN+ +SDL-BYTEORDER+ +SDL-LIL-ENDIAN+
      +SDL-VIDEO-DRIVER-KMSDRM+ +SDL-VIDEO-DRIVER-X11-XDBE+ +SDL-BIG-ENDIAN+
      +SDL-VIDEO-DRIVER-X11-XCURSOR+ +SDL-VIDEO-DRIVER-X11-XINPUT2+
      +SDL-VIDEO-DRIVER-X11-XFIXES+ +__DEFAULT_FN_ATTRS_FP16+
      +SDL-VIDEO-DRIVER-X11-XINPUT2-SUPPORTS-MULTITOUCH+ +SDL-UDEV-DYNAMIC+
      +SDL-USE-IME+ +__DEFAULT_FN_ATTRS_BF16+ +_SYS_TYPES_H+
      +__DEFAULT_FN_ATTRS_INT8+ +__DEFAULT_FN_ATTRS_TILE+
      +SDL-HAVE-LIBDECOR-GET-MIN-MAX+ +SDL-VIDEO-OPENGL-ES2+ +SDL-VIDEO-OPENGL+
      +SDL-VIDEO-OPENGL-GLX+ +_MM512_MASK_PERMUTEVAR_EPI32+
      +SDL-VIDEO-OPENGL-EGL+ +SDL-POWER-LINUX+ +SDL-VIDEO-VULKAN+
      +DYNAPI-NEEDS-DLOPEN+ +_MM512_PERMUTEVAR_EPI32+ +SDL-FILESYSTEM-UNIX+
      +SDL-AUDIO-DRIVER-PIPEWIRE+ +SDL-AUDIO-DRIVER-DUMMY+
      +SDL-AUDIO-DRIVER-OSS+ +SDL-AUDIO-DRIVER-SNDIO+
      +SDL-AUDIO-DRIVER-SNDIO-DYNAMIC+ +SDL-AUDIO-DRIVER-PIPEWIRE-DYNAMIC+
      +SDL-AUDIO-DRIVER-PULSEAUDIO+ +HAVE-IBUS-IBUS-H+ +HAVE-IMMINTRIN-H+
      +HAVE-INOTIFY-INIT1+ +HAVE-INOTIFY+ +SDL-AUDIO-DRIVER-ALSA+
      +SDL-AUDIO-DRIVER-DISK+ +HAVE-LIBUDEV-H+ +HAVE-LIBDECOR-H+
      +HAVE-LIBSAMPLERATE-H+ +SDL-TIMER-UNIX+ +SDL-VIDEO-DRIVER-DUMMY+
      +SDL-THREAD-PTHREAD+ +SDL-THREAD-PTHREAD-RECURSIVE-MUTEX+
      +SDL-VIDEO-DRIVER-WAYLAND-QT-TOUCH+ +SDL-VIDEO-DRIVER-X11+ +_CTYPE_H+
      +SDL-VIDEO-DRIVER-WAYLAND+ +SDL-JOYSTICK-LINUX+ +SC-ND-PTR+
      +SDL-JOYSTICK-HIDAPI+ +SDL-INPUT-LINUXEV+ +SDL-INPUT-LINUXKD+ +SC-NX-PTR+
      +SDL-SENSOR-DUMMY+ +SDL-LOADSO-DLOPEN+ +SC-NO-PTR+ +SC-NI-PTR+
      +SDL-JOYSTICK-VIRTUAL+ +SC-NU-PTR+ +SDL-HAPTIC-LINUX+ +RW-SEEK-CUR+
      +RW-SEEK-END+ +SDL-ASSERT-STATE+ +RW-SEEK-SET+ +HAVE-INOTIFY-INIT+
      +HAVE-SYS-INOTIFY-H+ +HAVE-FCITX+ +HAVE-DBUS-DBUS-H+ +SDL-ASSERT-DATA+
      +SDL-HINT-LINUX-DIGITAL-HATS+ +__W_CONTINUED+ +SDL-HINT-JOYSTICK-DEVICE+
      +SDL-HINT-KMSDRM-REQUIRE-DRM-MASTER+ +__WCOREFLAG+
      +SDL-HINT-JOYSTICK-ZERO-CENTERED-DEVICES+
      +SDL-HINT-JOYSTICK-WHEEL-DEVICES-EXCLUDED+
      +SDL-HINT-JOYSTICK-WHEEL-DEVICES+ +SDL-HINT-JOYSTICK-WGI+
      +SDL-HINT-JOYSTICK-THROTTLE-DEVICES-EXCLUDED+
      +SDL-HINT-JOYSTICK-THROTTLE-DEVICES+ +SDL-HINT-JOYSTICK-THREAD+
      +SDL-HINT-JOYSTICK-ROG-CHAKRAM+
      +SDL-HINT-JOYSTICK-RAWINPUT-CORRELATE-XINPUT+
      +SDL-HINT-JOYSTICK-RAWINPUT+ +SDL-HINT-JOYSTICK-MFI+ +__LLDIV_T_DEFINED+
      +SDL-HINT-JOYSTICK-IOKIT+ +SDL-HINT-JOYSTICK-HIDAPI-XBOX-ONE-HOME-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-ONE+ +RAND-MAX+ +EXIT-FAILURE+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-360-WIRELESS+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-360-PLAYER-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-360+ +__LDIV_T_DEFINED+ +_STRING_H+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX+ +SDL-HINT-JOYSTICK-HIDAPI-WII-PLAYER-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-WII+
      +SDL-HINT-JOYSTICK-HIDAPI-SWITCH-PLAYER-LED+ +EXIT-SUCCESS+ +MB-CUR-MAX+
      +SDL-HINT-JOYSTICK-HIDAPI-JOYCON-HOME-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-SWITCH-HOME-LED+ +SDLK-SCANCODE-MASK+
      +WUNTRACED+ +WNOHANG+ +SDL-HINT-MOUSE-FOCUS-CLICKTHROUGH+
      +SDL-HINT-MOUSE-DOUBLE-CLICK-RADIUS+ +SDL-HINT-MOUSE-DOUBLE-CLICK-TIME+
      +SDL-HINT-MAC-CTRL-CLICK-EMULATE-RIGHT-CLICK+
      +SDL-HINT-LINUX-HAT-DEADZONES+ +__WCLONE+
      +SDL-HINT-MAC-OPENGL-ASYNC-DISPATCH+ +__WALL+
      +SDL-HINT-MAC-BACKGROUND-APP+ +SDL-HINT-LINUX-JOYSTICK-DEADZONES+
      +WEXITED+ +SDL-HINT-LOGGING+ +WSTOPPED+ +WNOWAIT+ +__WNOTHREAD+
      +WCONTINUED+ +SDL-HINT-LINUX-JOYSTICK-CLASSIC+ +_KNOT_MASK16+
      +_KANDN_MASK16+ +_KAND_MASK16+ +_KXOR_MASK16+ +_KXNOR_MASK16+
      +_KOR_MASK16+ +__HAVE_FLOAT128+ +_WCHAR_H+ +_BITS_TYPES_LOCALE_T_H+
      +HAVE-SA-SIGACTION+ +HAVE-SIGACTION+ +HAVE-FSEEKO64+
      +_BITS_TYPES___LOCALE_T_H+ +HAVE-FSEEKO+ +HAVE-FOPEN64+ +HAVE-TRUNCF+
      +HAVE-TRUNC+ +HAVE-TANF+ +HAVE-TAN+ +HAVE-SQRTF+ +HAVE-SQRT+ +HAVE-SINF+
      +HAVE-SIN+ +HAVE-SCALBNF+ +_MM_DENORMALS_ZERO_OFF+ +HAVE-SCALBN+
      +HAVE-ROUNDF+ +HAVE-ROUND+ +HAVE-POWF+ +_MM_DENORMALS_ZERO_ON+
      +HAVE-O-CLOEXEC+ +HAVE--EXIT+ +HAVE-POLL+ +HAVE-GETAUXVAL+
      +HAVE-SEM-TIMEDWAIT+ +HAVE-PTHREAD-SETNAME-NP+ +HAVE-ICONV+
      +HAVE-CLOCK-GETTIME+ +HAVE-MPROTECT+ +HAVE-SYSCONF+ +HAVE-NANOSLEEP+
      +HAVE-SETJMP+ +HAVE-COPYSIGNF+ +HAVE-COS+ +HAVE-COSF+ +HAVE-EXP+
      +HAVE-EXPF+ +HAVE-FABS+ +HAVE-FABSF+ +HAVE-FLOOR+ +HAVE-FLOORF+
      +HAVE-FMOD+ +HAVE-FMODF+ +HAVE-LOG+ +HAVE-LOGF+ +HAVE-LOG10+
      +__PTHREAD_RWLOCK_ELISION_EXTRA+ +HAVE-LOG10F+ +HAVE-LROUND+
      +HAVE-LROUNDF+ +HAVE-POW+ +HAVE-STRNCMP+ +HAVE-STRCASECMP+
      +HAVE-STRNCASECMP+ +HAVE-STRCASESTR+ +HAVE-VSSCANF+ +HAVE-VSNPRINTF+
      +SDL-RELEASED+ +SDL-PRESSED+ +HAVE-ACOSF+ +_THREAD_MUTEX_INTERNAL_H+
      +HAVE-ACOS+ +HAVE-ASIN+ +HAVE-ASINF+ +HAVE-ATAN+ +HAVE-ATANF+
      +HAVE-ATAN2+ +HAVE-ATAN2F+ +_STDINT_H+ +HAVE-CEILF+ +HAVE-CEIL+
      +_BITS_STDINT_UINTN_H+ +__PTHREAD_MUTEX_HAVE_PREV+ +HAVE-COPYSIGN+
      +__SIZEOF_PTHREAD_BARRIERATTR_T+ +__SIZEOF_PTHREAD_RWLOCKATTR_T+
      +_INTTYPES_H+ +__SIZEOF_PTHREAD_COND_T+ +__SIZEOF_PTHREAD_MUTEXATTR_T+
      +__SIZEOF_PTHREAD_CONDATTR_T+ +HAVE-STRTOLL+ +HAVE-STRTOD+
      +HAVE-STRTOULL+ +HAVE-ATOF+ +HAVE-STRCMP+ +HAVE-ATOI+
      +__ATTR_DEALLOC_FCLOSE+ +__SIZEOF_PTHREAD_ATTR_T+
      +__SIZEOF_PTHREAD_MUTEX_T+ +__SIZEOF_PTHREAD_BARRIER_T+
      +__SIZEOF_PTHREAD_RWLOCK_T+ +_BITS_PTHREADTYPES_COMMON_H+
      +_BITS_PTHREADTYPES_ARCH_H+ +_THREAD_SHARED_TYPES_H+ +DBL-MANT-DIG+
      +LDBL-MANT-DIG+ +DECIMAL-DIG+ +FLT-DIG+ +FLT-MANT-DIG+ +FLT-MAX+
      +DBL-MAX+ +LDBL-MAX+ +FLT-EPSILON+ +DBL-EPSILON+ +DBL-MAX-EXP+
      +LDBL-MAX-EXP+ +FLT-MAX-10-EXP+ +DBL-MAX-10-EXP+ +LDBL-MAX-10-EXP+
      +FLT-MIN-10-EXP+ +DBL-MIN-10-EXP+ +LDBL-MIN-10-EXP+ +FLT-MAX-EXP+
      +DBL-DIG+ +LDBL-DIG+ +FLT-MIN-EXP+ +DBL-MIN-EXP+ +LDBL-MIN-EXP+
      +SDL-MIN-UINT32+ +SDL-MIN-SINT32+ +SDL-MAX-UINT32+ +SDL-MAX-SINT16+
      +__GLIBC_FLT_EVAL_METHOD+ +SDL-MIN-SINT16+ +__FP_LOGB0_IS_MIN+
      +HUGE-VALL+ +SDL-MAX-UINT8+ +INFINITY+ +SDL-MIN-UINT8+ +NAN+ +HUGE-VAL+
      +SDL-MIN-UINT16+ +HUGE-VALF+ +SDL-MAX-SINT32+ +SDL-MAX-UINT16+
      +LDBL-HAS-SUBNORM+ +DBL-HAS-SUBNORM+ +FLT-HAS-SUBNORM+ +LDBL-DECIMAL-DIG+
      +SDL-SIZE-MAX+ +FLT-TRUE-MIN+ +LDBL-MIN+ +DBL-MIN+ +FLT-MIN+
      +LDBL-EPSILON+ +DBL-DECIMAL-DIG+ +FLT-DECIMAL-DIG+ +LDBL-TRUE-MIN+
      +DBL-TRUE-MIN+ +SDL-MIN-SINT8+ +SDL-MAX-SINT8+ +_M_PACKSSDW+
      +_M_PACKUSWB+ +_MM_CVTI64_SD+ +_M_PUNPCKHBW+ +_MM_CVTI64_SS+
      +_MM_CVTSD_I64+ +_M_PUNPCKHWD+ +_MM_CVTSS_I64+ +_M_PUNPCKHDQ+
      +_M_PUNPCKLWD+ +_MM_CVTI32_SS+ +_M_PUNPCKLBW+ +_M_PUNPCKLDQ+
      +_MM_CVTI32_SD+ +_M_PADDB+ +_MM_CVTSD_I32+ +_M_PADDW+ +_MM_CVTSS_I32+
      +_M_PADDD+ +_M_PADDSB+ +_M_PADDSW+ +_M_PADDUSW+ +_M_PADDUSB+ +_M_PSUBB+
      +_M_PSUBW+ +_M_PSUBD+ +_M_PSUBSB+ +_M_PSUBSW+ +_M_PSUBUSB+ +_M_PSUBUSW+
      +_M_PMADDWD+ +_M_PMULHW+ +_M_PMULLW+ +_M_PSLLW+ +_M_PSLLWI+ +_M_PSLLD+
      +_M_PSLLDI+ +_M_PSLLQ+ +__DEFAULT_FN_ATTRS_F+ +_M_PSLLQI+ +_M_PSRAW+
      +_M_PSRAWI+ +_M_PSRAD+ +_M_PSRADI+ +_M_PSRLW+ +__MATH_DECLARING_DOUBLE+
      +__MATH_DECLARING_FLOATN+ +FP-ILOGB0+ +__FP_LOGBNAN_IS_MIN+ +FP-ILOGBNAN+
      +_STDLIB_H+ +_MDOUBLE_+ +_M_EMPTY+ +_M_FROM_INT64+ +_M_FROM_INT+
      +_M_PACKSSWB+ +_M_TO_INT+ +_M_TO_INT64+ +SDL-MAJOR-VERSION+
      +SDL-COMPILEDVERSION+ +SDL-PATCHLEVEL+ +SDL-MINOR-VERSION+
      +SDL-INIT-EVERYTHING+ +SDL-INIT-SENSOR+ +SDL-INIT-NOPARACHUTE+
      +SDL-INIT-HAPTIC+ +SDL-INIT-EVENTS+ +SDL-INIT-GAMECONTROLLER+
      +SDL-INIT-VIDEO+ +SDL-INIT-JOYSTICK+ +SDL-INIT-TIMER+ +SDL-MIX-MAXVOLUME+
      +SDL-INIT-AUDIO+ +_SIDD_POSITIVE_POLARITY+ +_SIDD_NEGATIVE_POLARITY+
      +_SIDD_CMP_EQUAL_EACH+ +_SIDD_CMP_EQUAL_ORDERED+ +_SIDD_CMP_EQUAL_ANY+
      +_SIDD_CMP_RANGES+ +_SIDD_SBYTE_OPS+ +_SIDD_SWORD_OPS+ +_SIDD_UBYTE_OPS+
      +_SIDD_UWORD_OPS+ +_SIDD_UNIT_MASK+ +_SIDD_BIT_MASK+
      +_SIDD_MASKED_NEGATIVE_POLARITY+ +_SIDD_MASKED_POSITIVE_POLARITY+
      +_SIDD_MOST_SIGNIFICANT+ +_SIDD_LEAST_SIGNIFICANT+
      +__DEFAULT_FN_ATTRS_CONSTEXPR+ +HAVE-STRRCHR+ +HAVE-STRSTR+ +HAVE-STRCHR+
      +HAVE-RINDEX+ +HAVE-INDEX+ +HAVE-STRTOUL+ +HAVE-STRTOL+ +HAVE-WCSCMP+
      +HAVE-STRTOK-R+ +HAVE-WCSSTR+ +HAVE-WCSDUP+ +HAVE-WCSLEN+ +HAVE-MEMCMP+
      +HAVE-STRLEN+ +HAVE-WCSNCASECMP+ +HAVE-WCSCASECMP+ +HAVE-WCSNCMP+
      +SDL-BUTTON-X2+ +HAVE-BSEARCH+ +HAVE-QSORT+ +HAVE-UNSETENV+ +HAVE-PUTENV+
      +HAVE-MEMMOVE+ +HAVE-MEMCPY+ +HAVE-MEMSET+ +HAVE-BCOPY+ +HAVE-ABS+
      +HAVE-CALLOC+ +HAVE-MALLOC+ +HAVE-DLOPEN+ +HAVE-LINUX-INPUT-H+
      +HAVE-SETENV+ +__DEFAULT_FN_ATTRS_MMX+ +HAVE-GETENV+ +HAVE-ALLOCA+
      +HAVE-FREE+ +HAVE-REALLOC+ +HAVE-STDLIB-H+ +HAVE-STRINGS-H+
      +HAVE-STRING-H+ +HAVE-SYS-TYPES-H+ +HAVE-WCHAR-H+ +HAVE-SIGNAL-H+
      +HAVE-STDARG-H+ +HAVE-STDINT-H+ +HAVE-STDIO-H+ +HAVE-INTTYPES-H+
      +HAVE-LIMITS-H+ +HAVE-MALLOC-H+ +HAVE-MATH-H+ +HAVE-MEMORY-H+
      +HAVE-ALLOCA-H+ +HAVE-CTYPE-H+ +HAVE-FLOAT-H+ +HAVE-ICONV-H+
      +_XABORT_NESTED+ +_XABORT_RETRY+ +SIZEOF-VOIDP+ +HAVE-LIBC+
      +HAVE-GCC-ATOMICS+ +_XABORT_CAPACITY+ +_XABORT_DEBUG+ +STDC-HEADERS+
      +SDL-RWOPS-MEMORY-RO+ +SDL-FALLTHROUGH+ +SDL-RWOPS-MEMORY+
      +SDL-HAS-FALLTHROUGH+ +_XABORT_CONFLICT+ +SDL-RWOPS-JNIFILE+
      +_XABORT_EXPLICIT+ +_XBEGIN_STARTED+ +SDL-RWOPS-STDFILE+
      +SDL-RWOPS-WINFILE+ +SDL-RWOPS-UNKNOWN+ +NULL+ +SDL-FORCE-INLINE+
      +L-TMPNAM+ +TMP-MAX+ +FILENAME-MAX+ +L-CTERMID+ +FOPEN-MAX+ +STDIN+
      +STDOUT+ +STDERR+ +__DEFAULT_FN_ATTRS+ +_IOFBF+ +_IOLBF+ +_IONBF+
      +BUFSIZ+ +EOF+ +SEEK-SET+ +__INLINE+ +SEEK-CUR+ +SEEK-END+ +P-TMPDIR+
      +_BITS_STDIO_LIM_H+ +_IO_USER_LOCK+ +_IO_EOF_SEEN+ +_IO_ERR_SEEN+
