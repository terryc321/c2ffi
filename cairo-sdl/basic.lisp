...
#|
how do i setup a project properly in common lisp then ? cl-project or ql-quickproject ?

basic sdl application

dependency on [woman.jpeg] file being present - dont ask if it is not .

mainly all CFFI hand coded using routines from CL-AUTOWRAP
anything i needed I coded up at same time .
...
looking at modifier of keypress now -
namely ALT left , CTRL left , CTRL right , ALT right , SHIFT left , SHIFT right 
