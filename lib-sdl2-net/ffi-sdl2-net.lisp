 ...
 (EVAL-WHEN (:COMPILE-TOPLEVEL :LOAD-TOPLEVEL :EXECUTE)
   ...
   (PROGN
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8327 42
                                   '((:UPPER . 256) (:LOWER . 512)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8450 43
                                   '((:NAN . 0) (:INFINITE . 1) (:ZERO . 2)
                                     (:SUBNORMAL . 3) (:NORMAL . 4))))
    (PROGN
     (DEFPARAMETER +SDL-FALSE+ 0)
     (DEFPARAMETER +SDL-TRUE+ 1)
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8451 44
                                   '((:FALSE . 0) (:TRUE . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8452 45
                                   '((:DUMMY-ENUM-VALUE . 0))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8453 47
    ...
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     ...
     '((#:P8454 (:POINTER SDL-ASSERT-DATA)) (#:P8455 (:STRING))
       (#:P8456 (:STRING)) (#:P8457 :INT)))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8458 50
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8459 55
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8460 63
                                   '((:STOPPED . 0) (:PLAYING . 1)
                                     (:PAUSED . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8461 65
                                   '((:O . 0) (:NO . 1) (:B . 2) (:NB . 3)
                                     (:Z . 4) (:NZ . 5) (:BE . 6) (:NBE . 7)
                                     (:S . 8) (:NS . 9) (:P . 10) (:NP . 11)
                                     (:L . 12) (:NL . 13) (:LE . 14)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8462 66
                                   '((:EQ . 0) (:LT . 1) (:LE . 2)
                                     (:UNUSED . 3) (:NE . 4) (:NLT . 5)
                                     (:NLE . 6))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8463 67
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8464 68
                                   '((:|1_2| . 0) (:P5_2 . 1) (:P5_1 . 2)
                                     (:P75_1P5 . 3))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8465 69
                                   '((:SRC . 0) (:ZERO . 1) (:NAN . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8466 70
                                   '((:A . 240) (:B . 204) (:C . 170))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8467 72
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8468 73
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8469 74
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8470 75
                                   '((:NONE . 0) (:RGB . 1) (:RGBA . 2)
                                     (:ARGB . 3) (:BGR . 4) (:BGRA . 5)
                                     (:ABGR . 6))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8471 76
                                   '((:NONE . 0) (:|332| . 1) (:|4444| . 2)
                                     (:|1555| . 3) (:|5551| . 4) (:|565| . 5)
                                     (:|8888| . 6) (:|2101010| . 7)
                                     (:|1010102| . 8))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8472 77
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8473 85
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8474 86
                                   '((:ADD . 1) (:SUBTRACT . 2)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8475 87
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8476 90
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8477 93
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8478 94
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8479 95
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8480 96
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8481 97
                                   '((:CANCEL . 0) (:BRIEFLY . 1)
                                     (:UNTIL-FOCUSED . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8482 98
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8483 99
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8484 100
                                   '((:DEBUG-FLAG . 1)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8485 101
                                   '((:NONE . 0) (:FLUSH . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8486 102
                                   '((:NO-NOTIFICATION . 0)
                                     (:LOSE-CONTEXT . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8487 103
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8488 104
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8489 105
                                   '((:UNKNOWN . 0) (:RETURN . 13)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8490 106
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8491 109
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8492 110
                                   '((:NORMAL . 0) (:FLIPPED . 1))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8493 113
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8494 114
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8495 117
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8496 119
                                   '((:UNKNOWN . 0) (:XBOX360 . 1)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8497 120
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8498 124
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8499 125
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8500 126
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8501 128
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8502 161
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8503 173
                                   '((:DEFAULT . 0) (:NORMAL . 1)
                                     (:OVERRIDE . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8504 174
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8505 175
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8506 176
                                   '((:ERROR . 16) (:WARNING . 32)
                                     (:INFORMATION . 64)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8507 177
                                   '((:RETURNKEY-DEFAULT . 1)
                                     (:ESCAPEKEY-DEFAULT . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8508 180
                                   '((:BACKGROUND . 0) (:TEXT . 1)
                                     (:BUTTON-BORDER . 2)
                                     (:BUTTON-BACKGROUND . 3)
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8509 183
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8510 184
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8511 187
                                   '((:NEAREST . 0) (:LINEAR . 1)
                                     (:BEST . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8512 188
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8513 189
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8514 190
                                   '((:NONE . 0) (:HORIZONTAL . 1)
                                     (:VERTICAL . 2))))
    ...
    (PROGN
     ...
     (AUTOWRAP:DEFINE-FOREIGN-ENUM '#:ANON-TYPE-8515 193
    ...
    (AUTOWRAP:DEFINE-FOREIGN-ALIAS 'SDL-NET-VERSION 'SDL-VERSION)
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-LINKED-VERSION "SDLNet_Linked_Version")
     '(:POINTER SDL-NET-VERSION) 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-INIT "SDLNet_Init") ':INT 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-QUIT "SDLNet_Quit") ':VOID
                                      'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-ALIAS 'I-PADDRESS
                                   '(AUTOWRAP::STRUCT
                                     (NIL :ID 198 :BIT-SIZE 64 :BIT-ALIGNMENT
                                      32)
                                     (:HOST UINT32 :BIT-SIZE 32 :BIT-OFFSET 0
                                      :BIT-ALIGNMENT 32)
                                     (:PORT UINT16 :BIT-SIZE 16 :BIT-OFFSET 32
                                      :BIT-ALIGNMENT 16)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-RESOLVE-HOST "SDLNet_ResolveHost") ':INT
     '((|address| (:POINTER I-PADDRESS)) (|host| (:STRING)) (|port| UINT16)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-RESOLVE-IP "SDLNet_ResolveIP")
                                      '(:STRING)
                                      '((|ip| (:POINTER I-PADDRESS))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-GET-LOCAL-ADDRESSES "SDLNet_GetLocalAddresses") ':INT
     '((|addresses| (:POINTER I-PADDRESS)) (|maxcount| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-RECORD '_TC_PSOCKET :STRUCT 0 0 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-ALIAS 'TC-PSOCKET
                                   '(:POINTER
                                     (AUTOWRAP::STRUCT
                                      (_TC_PSOCKET :BIT-SIZE 0 :BIT-ALIGNMENT
                                       0))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-TCP-OPEN "SDLNet_TCP_Open")
                                      'TC-PSOCKET
                                      '((|ip| (:POINTER I-PADDRESS))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-TCP-ACCEPT "SDLNet_TCP_Accept")
                                      'TC-PSOCKET '((|server| TC-PSOCKET)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-TCP-GET-PEER-ADDRESS "SDLNet_TCP_GetPeerAddress")
     '(:POINTER I-PADDRESS) '((|sock| TC-PSOCKET)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-TCP-SEND "SDLNet_TCP_Send")
                                      ':INT
                                      '((|sock| TC-PSOCKET)
                                        (|data| (:POINTER :VOID))
                                        (|len| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-TCP-RECV "SDLNet_TCP_Recv")
                                      ':INT
                                      '((|sock| TC-PSOCKET)
                                        (|data| (:POINTER :VOID))
                                        (|maxlen| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-TCP-CLOSE "SDLNet_TCP_Close")
                                      ':VOID '((|sock| TC-PSOCKET)))
    (AUTOWRAP:DEFINE-FOREIGN-RECORD '_UD_PSOCKET :STRUCT 0 0 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-ALIAS 'UD-PSOCKET
                                   '(:POINTER
                                     (AUTOWRAP::STRUCT
                                      (_UD_PSOCKET :BIT-SIZE 0 :BIT-ALIGNMENT
                                       0))))
    (AUTOWRAP:DEFINE-FOREIGN-ALIAS 'UD-PPACKET
                                   '(AUTOWRAP::STRUCT
                                     (NIL :ID 201 :BIT-SIZE 320 :BIT-ALIGNMENT
                                      64)
                                     (:CHANNEL :INT :BIT-SIZE 32 :BIT-OFFSET 0
                                      :BIT-ALIGNMENT 32)
                                     (:DATA (:POINTER UINT8) :BIT-SIZE 64
                                      :BIT-OFFSET 64 :BIT-ALIGNMENT 64)
                                     (:LEN :INT :BIT-SIZE 32 :BIT-OFFSET 128
                                      :BIT-ALIGNMENT 32)
                                     (:MAXLEN :INT :BIT-SIZE 32 :BIT-OFFSET 160
                                      :BIT-ALIGNMENT 32)
                                     (:STATUS :INT :BIT-SIZE 32 :BIT-OFFSET 192
                                      :BIT-ALIGNMENT 32)
                                     (:ADDRESS I-PADDRESS :BIT-SIZE 64
                                      :BIT-OFFSET 224 :BIT-ALIGNMENT 32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-ALLOC-PACKET "SDLNet_AllocPacket") '(:POINTER UD-PPACKET)
     '((|size| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-RESIZE-PACKET "SDLNet_ResizePacket") ':INT
     '((|packet| (:POINTER UD-PPACKET)) (|newsize| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-FREE-PACKET "SDLNet_FreePacket") ':VOID
     '((|packet| (:POINTER UD-PPACKET))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-ALLOC-PACKET-V "SDLNet_AllocPacketV")
     '(:POINTER (:POINTER UD-PPACKET)) '((|howmany| :INT) (|size| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-FREE-PACKET-V "SDLNet_FreePacketV") ':VOID
     '((|packetV| (:POINTER (:POINTER UD-PPACKET)))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-UDP-OPEN "SDLNet_UDP_Open")
                                      'UD-PSOCKET '((|port| UINT16)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-UDP-SET-PACKET-LOSS "SDLNet_UDP_SetPacketLoss") ':VOID
     '((|sock| UD-PSOCKET) (|percent| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-UDP-BIND "SDLNet_UDP_Bind")
                                      ':INT
                                      '((|sock| UD-PSOCKET) (|channel| :INT)
                                        (|address| (:POINTER I-PADDRESS))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-UDP-UNBIND "SDLNet_UDP_Unbind")
                                      ':VOID
                                      '((|sock| UD-PSOCKET) (|channel| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-UDP-GET-PEER-ADDRESS "SDLNet_UDP_GetPeerAddress")
     '(:POINTER I-PADDRESS) '((|sock| UD-PSOCKET) (|channel| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-UDP-SEND-V "SDLNet_UDP_SendV")
                                      ':INT
                                      '((|sock| UD-PSOCKET)
                                        (|packets|
                                         (:POINTER (:POINTER UD-PPACKET)))
                                        (|npackets| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-UDP-SEND "SDLNet_UDP_Send")
                                      ':INT
                                      '((|sock| UD-PSOCKET) (|channel| :INT)
                                        (|packet| (:POINTER UD-PPACKET))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-UDP-RECV-V "SDLNet_UDP_RecvV")
                                      ':INT
                                      '((|sock| UD-PSOCKET)
                                        (|packets|
                                         (:POINTER (:POINTER UD-PPACKET)))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-UDP-RECV "SDLNet_UDP_Recv")
                                      ':INT
                                      '((|sock| UD-PSOCKET)
                                        (|packet| (:POINTER UD-PPACKET))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-UDP-CLOSE "SDLNet_UDP_Close")
                                      ':VOID '((|sock| UD-PSOCKET)))
    (AUTOWRAP:DEFINE-FOREIGN-RECORD '_SDL_NET_SOCKET_SET :STRUCT 0 0 'NIL)
    (AUTOWRAP:DEFINE-FOREIGN-ALIAS 'SDL-NET-SOCKET-SET
                                   '(:POINTER
                                     (AUTOWRAP::STRUCT
                                      (_SDL_NET_SOCKET_SET :BIT-SIZE 0
                                       :BIT-ALIGNMENT 0))))
    (AUTOWRAP:DEFINE-FOREIGN-RECORD '_SDL_NET_GENERIC_SOCKET :STRUCT 32 32
                                    '((:READY :INT :BIT-SIZE 32 :BIT-OFFSET 0
                                       :BIT-ALIGNMENT 32)))
    (AUTOWRAP:DEFINE-FOREIGN-ALIAS 'SDL-NET-GENERIC-SOCKET
                                   '(:POINTER
                                     (:STRUCT (_SDL_NET_GENERIC_SOCKET))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-ALLOC-SOCKET-SET "SDLNet_AllocSocketSet") 'SDL-NET-SOCKET-SET
     '((|maxsockets| :INT)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-ADD-SOCKET "SDLNet_AddSocket")
                                      ':INT
                                      '((|set| SDL-NET-SOCKET-SET)
                                        (|sock| SDL-NET-GENERIC-SOCKET)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-DEL-SOCKET "SDLNet_DelSocket")
                                      ':INT
                                      '((|set| SDL-NET-SOCKET-SET)
                                        (|sock| SDL-NET-GENERIC-SOCKET)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-CHECK-SOCKETS "SDLNet_CheckSockets") ':INT
     '((|set| SDL-NET-SOCKET-SET) (|timeout| UINT32)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-FREE-SOCKET-SET "SDLNet_FreeSocketSet") ':VOID
     '((|set| SDL-NET-SOCKET-SET)))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION
     '(SDL-NET-SET-ERROR "SDLNet_SetError" :VARIADIC-P T) ':VOID
     '((|fmt| (:STRING))))
    (AUTOWRAP:DEFINE-FOREIGN-FUNCTION '(SDL-NET-GET-ERROR "SDLNet_GetError")
                                      '(:STRING) 'NIL)
    ...
    (DEFPARAMETER +SDL-NET-COMPILEDVERSION+ 2200)
    (DEFPARAMETER +__FSFILCNT64_T_TYPE+ NIL)
    (DEFPARAMETER +SDL-NET-MAJOR-VERSION+ 2)
    (DEFPARAMETER +SDL-NET-PATCHLEVEL+ 0)
    (DEFPARAMETER +SDL-NET-MINOR-VERSION+ 2)
    ...
    (DEFPARAMETER +INADDR-LOOPBACK+ 2130706433)
    (DEFPARAMETER +INADDR-BROADCAST+ 4294967295)
    (DEFPARAMETER +INADDR-ANY+ 0)
    (DEFPARAMETER +INADDR-NONE+ 4294967295)
    (DEFPARAMETER +SDLNET-MAX-UDPADDRESSES+ 4)
    (DEFPARAMETER +SDLNET-MAX-UDPCHANNELS+ 32)
    ...
    (DEFPARAMETER +SDL-DATA-ALIGNED+ 0)
   ...
   (AUTOWRAP:DEFINE-WRAPPER I-PADDRESS #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER (:STRUCT (_TC_PSOCKET)) #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER TC-PSOCKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER (:STRUCT (_UD_PSOCKET)) #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER UD-PSOCKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER UD-PPACKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER (:STRUCT (_SDL_NET_SOCKET_SET)) #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER SDL-NET-SOCKET-SET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER (:STRUCT (_SDL_NET_GENERIC_SOCKET))
                            #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-WRAPPER SDL-NET-GENERIC-SOCKET #<PACKAGE "DUMMY">)
   ...
   (AUTOWRAP:DEFINE-ACCESSORS I-PADDRESS #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS (:STRUCT (_TC_PSOCKET)) #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS TC-PSOCKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS (:STRUCT (_UD_PSOCKET)) #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS UD-PSOCKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS UD-PPACKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS (:STRUCT (_SDL_NET_SOCKET_SET))
                              #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS SDL-NET-SOCKET-SET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS (:STRUCT (_SDL_NET_GENERIC_SOCKET))
                              #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-ACCESSORS SDL-NET-GENERIC-SOCKET #<PACKAGE "DUMMY">)
   ...
   (AUTOWRAP:DEFINE-CFUN SDL-NET-LINKED-VERSION #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-INIT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-QUIT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-RESOLVE-HOST #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-RESOLVE-IP #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-GET-LOCAL-ADDRESSES #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-TCP-OPEN #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-TCP-ACCEPT #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-TCP-GET-PEER-ADDRESS #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-TCP-SEND #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-TCP-RECV #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-TCP-CLOSE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-ALLOC-PACKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-RESIZE-PACKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-FREE-PACKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-ALLOC-PACKET-V #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-FREE-PACKET-V #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-OPEN #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-SET-PACKET-LOSS #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-BIND #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-UNBIND #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-GET-PEER-ADDRESS #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-SEND-V #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-SEND #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-RECV-V #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-RECV #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-UDP-CLOSE #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-ALLOC-SOCKET-SET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-ADD-SOCKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-DEL-SOCKET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-CHECK-SOCKETS #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-FREE-SOCKET-SET #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-SET-ERROR #<PACKAGE "DUMMY">)
   (AUTOWRAP:DEFINE-CFUN SDL-NET-GET-ERROR #<PACKAGE "DUMMY">)
   ...
   (EXPORT
    '(SDL-NET-GENERIC-SOCKET _SDL_NET_GENERIC_SOCKET SDL-NET-SOCKET-SET
      _SDL_NET_SOCKET_SET UD-PPACKET UD-PSOCKET _UD_PSOCKET TC-PSOCKET
      _TC_PSOCKET I-PADDRESS SDL-LOCALE SDL-LOCALE SDL-VERSION SDL-VERSION
    ...
    #<PACKAGE "DUMMY">)
   (EXPORT
    '(SDL-NET-GET-ERROR SDL-NET-SET-ERROR SDL-NET-FREE-SOCKET-SET
                        SDL-NET-CHECK-SOCKETS SDL-NET-DEL-SOCKET
                        SDL-NET-ADD-SOCKET SDL-NET-ALLOC-SOCKET-SET
                        SDL-NET-UDP-CLOSE SDL-NET-UDP-RECV SDL-NET-UDP-RECV-V
                        SDL-NET-UDP-SEND SDL-NET-UDP-SEND-V
                        SDL-NET-UDP-GET-PEER-ADDRESS SDL-NET-UDP-UNBIND
                        SDL-NET-UDP-BIND SDL-NET-UDP-SET-PACKET-LOSS
                        SDL-NET-UDP-OPEN SDL-NET-FREE-PACKET-V
                        SDL-NET-ALLOC-PACKET-V SDL-NET-FREE-PACKET
                        SDL-NET-RESIZE-PACKET SDL-NET-ALLOC-PACKET
                        SDL-NET-TCP-CLOSE SDL-NET-TCP-RECV SDL-NET-TCP-SEND
                        SDL-NET-TCP-GET-PEER-ADDRESS SDL-NET-TCP-ACCEPT
                        SDL-NET-TCP-OPEN SDL-NET-GET-LOCAL-ADDRESSES
                        SDL-NET-RESOLVE-IP SDL-NET-RESOLVE-HOST SDL-NET-QUIT
                        SDL-NET-INIT SDL-NET-LINKED-VERSION SDL-QUIT
                        SDL-WAS-INIT SDL-QUIT-SUB-SYSTEM SDL-INIT-SUB-SYSTEM
                        SDL-INIT SDL-OPEN-URL SDL-GET-PREFERRED-LOCALES
                        ...
                        SDL-GET-TICKS SDL-ON-APPLICATION-DID-BECOME-ACTIVE
                        SDL-ON-APPLICATION-WILL-ENTER-FOREGROUND
                        SDL-ON-APPLICATION-DID-ENTER-BACKGROUND
                        SDL-ON-APPLICATION-WILL-RESIGN-ACTIVE
                        SDL-ON-APPLICATION-DID-RECEIVE-MEMORY-WARNING
                        ...
                        SDL-RENDER-WINDOW-TO-LOGICAL SDL-RENDER-GET-SCALE
                        SDL-RENDER-SET-SCALE SDL-RENDER-IS-CLIP-ENABLED
                        SDL-RENDER-GET-CLIP-RECT SDL-RENDER-SET-CLIP-RECT
                        SDL-RENDER-GET-VIEWPORT SDL-RENDER-SET-VIEWPORT
                        SDL-RENDER-GET-INTEGER-SCALE
                        SDL-RENDER-SET-INTEGER-SCALE
                        SDL-RENDER-GET-LOGICAL-SIZE SDL-RENDER-SET-LOGICAL-SIZE
                        ...
                        SDL-GET-RENDER-DRIVER-INFO SDL-GET-NUM-RENDER-DRIVERS
                        SDL-GET-POWER-INFO SDL-METAL-GET-DRAWABLE-SIZE
                        SDL-METAL-GET-LAYER SDL-METAL-DESTROY-VIEW
                        SDL-METAL-CREATE-VIEW SDL-SHOW-SIMPLE-MESSAGE-BOX
                        SDL-SHOW-MESSAGE-BOX SDL-LOG-SET-OUTPUT-FUNCTION
                        SDL-LOG-GET-OUTPUT-FUNCTION SDL-LOG-MESSAGE-V
                        SDL-LOG-MESSAGE SDL-LOG-CRITICAL SDL-LOG-ERROR
                        SDL-LOG-WARN SDL-LOG-INFO SDL-LOG-DEBUG SDL-LOG-VERBOSE
                        SDL-LOG SDL-LOG-RESET-PRIORITIES SDL-LOG-GET-PRIORITY
                        SDL-LOG-SET-PRIORITY SDL-LOG-SET-ALL-PRIORITY
                        SDL-UNLOAD-OBJECT SDL-LOAD-FUNCTION SDL-LOAD-OBJECT
                        ...
                        SDL-HID-GET-FEATURE-REPORT SDL-HID-SEND-FEATURE-REPORT
                        SDL-HID-SET-NONBLOCKING SDL-HID-READ
                        SDL-HID-READ-TIMEOUT SDL-HID-WRITE SDL-HID-OPEN-PATH
                        SDL-HID-OPEN SDL-HID-FREE-ENUMERATION SDL-HID-ENUMERATE
                        SDL-HID-DEVICE-CHANGE-COUNT SDL-HID-EXIT SDL-HID-INIT
                        SDL-HAPTIC-RUMBLE-STOP SDL-HAPTIC-RUMBLE-PLAY
                        ...
                        SDL-FLUSH-EVENTS SDL-FLUSH-EVENT SDL-HAS-EVENTS
                        SDL-HAS-EVENT SDL-PEEP-EVENTS SDL-PUMP-EVENTS
                        SDL-LOAD-DOLLAR-TEMPLATES SDL-SAVE-DOLLAR-TEMPLATE
                        ...
                        SDL-IS-GAME-CONTROLLER SDL-GAME-CONTROLLER-MAPPING
                        ...
                        SDL-SENSOR-GET-DATA-WITH-TIMESTAMP SDL-SENSOR-GET-DATA
                        ...
                        SDL-JOYSTICK-GET-ATTACHED SDL-GET-JOYSTICK-GUID-INFO
                        ...
                        SDL-JOYSTICK-GET-GUID SDL-JOYSTICK-SET-PLAYER-INDEX
                        ...
                        SDL-NUM-JOYSTICKS SDL-UNLOCK-JOYSTICKS
                        SDL-LOCK-JOYSTICKS SDL-GUID-FROM-STRING
                        SDL-GUID-TO-STRING SDL-SHOW-CURSOR SDL-FREE-CURSOR
                        SDL-GET-DEFAULT-CURSOR SDL-GET-CURSOR SDL-SET-CURSOR
                        SDL-CREATE-SYSTEM-CURSOR SDL-CREATE-COLOR-CURSOR
                        SDL-CREATE-CURSOR SDL-GET-RELATIVE-MOUSE-MODE
                        SDL-CAPTURE-MOUSE SDL-SET-RELATIVE-MOUSE-MODE
                        SDL-WARP-MOUSE-GLOBAL SDL-WARP-MOUSE-IN-WINDOW
                        SDL-GET-RELATIVE-MOUSE-STATE SDL-GET-GLOBAL-MOUSE-STATE
                        SDL-GET-MOUSE-STATE SDL-GET-MOUSE-FOCUS
                        ...
                        SDL-GET-SCANCODE-NAME SDL-GET-SCANCODE-FROM-KEY
                        ...
                        SDL-MAXIMIZE-WINDOW SDL-RAISE-WINDOW SDL-HIDE-WINDOW
                        ...
                        SDL-GET-WINDOW-ICC-PROFILE SDL-GET-WINDOW-DISPLAY-MODE
                        ...
                        SDL-GET-DESKTOP-DISPLAY-MODE SDL-GET-DISPLAY-MODE
                        SDL-GET-NUM-DISPLAY-MODES SDL-GET-DISPLAY-ORIENTATION
                        SDL-GET-DISPLAY-DPI SDL-GET-DISPLAY-USABLE-BOUNDS
                        SDL-GET-DISPLAY-BOUNDS SDL-GET-DISPLAY-NAME
                        SDL-GET-NUM-VIDEO-DISPLAYS SDL-GET-CURRENT-VIDEO-DRIVER
                        SDL-VIDEO-QUIT SDL-VIDEO-INIT SDL-GET-VIDEO-DRIVER
                        ...
                        SDL-DUPLICATE-SURFACE SDL-GET-CLIP-RECT
                        SDL-SET-CLIP-RECT SDL-GET-SURFACE-BLEND-MODE
                        SDL-SET-SURFACE-BLEND-MODE SDL-GET-SURFACE-ALPHA-MOD
                        SDL-SET-SURFACE-ALPHA-MOD SDL-GET-SURFACE-COLOR-MOD
                        SDL-SET-SURFACE-COLOR-MOD SDL-GET-COLOR-KEY
                        SDL-HAS-COLOR-KEY SDL-SET-COLOR-KEY SDL-HAS-SURFACE-RLE
                        SDL-SET-SURFACE-RLE SDL-SAVE-BMP-RW SDL-LOAD-BMP-RW
                        ...
                        SDL-CREATE-RGB-SURFACE SDL-COMPOSE-CUSTOM-BLEND-MODE
                        SDL-INTERSECT-F-RECT-AND-LINE SDL-ENCLOSE-F-POINTS
                        SDL-UNION-F-RECT SDL-INTERSECT-F-RECT
                        ...
                        SDL-GET-RGBA SDL-GET-RGB SDL-MAP-RGBA SDL-MAP-RGB
                        SDL-FREE-PALETTE SDL-SET-PALETTE-COLORS
                        ...
                        SDL-SIMD-REALLOC SDL-SIMD-ALLOC SDL-SIMD-GET-ALIGNMENT
                        SDL-GET-SYSTEM-RAM SDL-HAS-LASX SDL-HAS-LSX
                        SDL-HAS-NEON SDL-HAS-ARMSIMD SDL-HAS-AVX512F
                        SDL-HAS-AVX2 SDL-HAS-AVX SDL-HAS-SSE42 SDL-HAS-SSE41
                        SDL-HAS-SSE3 SDL-HAS-SSE2 SDL-HAS-SSE SDL-HAS3D-NOW
                        SDL-HAS-MMX SDL-HAS-ALTI-VEC SDL-HAS-RDTSC
                        SDL-GET-CPU-CACHE-LINE-SIZE SDL-GET-CPU-COUNT
                        __TILE_CMMRLFP16PS __TILE_CMMIMFP16PS _MM_PAUSE
                        _MM_MFENCE _MM_LFENCE _MM_CLFLUSH _MM_SETCSR _MM_GETCSR
                        _MM_SFENCE POSIX-MEMALIGN
                        SDL-HAS-PRIMARY-SELECTION-TEXT
                        SDL-GET-PRIMARY-SELECTION-TEXT
                        SDL-SET-PRIMARY-SELECTION-TEXT SDL-HAS-CLIPBOARD-TEXT
                        SDL-GET-CLIPBOARD-TEXT SDL-SET-CLIPBOARD-TEXT
                        SDL-CLOSE-AUDIO-DEVICE SDL-CLOSE-AUDIO
                        ...
                        SDL-GET-NUM-AUDIO-DRIVERS SDL-WRITE-BE64 SDL-WRITE-LE64
                        SDL-WRITE-BE32 SDL-WRITE-LE32 SDL-WRITE-BE16
                        ...
                        SDL-R-WWRITE SDL-R-WREAD SDL-R-WTELL SDL-R-WSEEK
                        SDL-R-WSIZE SDL-FREE-RW SDL-ALLOC-RW
                        ...
                        SDL-TRY-LOCK-MUTEX SDL-LOCK-MUTEX SDL-CREATE-MUTEX
                        SDL-ERROR SDL-CLEAR-ERROR SDL-GET-ERROR-MSG
                        SDL-GET-ERROR SDL-SET-ERROR SDL-ATOMIC-GET-PTR
                        SDL-ATOMIC-SET-PTR SDL-ATOMIC-CAS-PTR SDL-ATOMIC-ADD
                        SDL-ATOMIC-GET SDL-ATOMIC-SET SDL-ATOMIC-CAS
                        ...
                        SDL-ICONV-CLOSE SDL-ICONV-OPEN SDL-TANF SDL-TAN
                        SDL-SQRTF SDL-SQRT SDL-SINF SDL-SIN SDL-SCALBNF
                        SDL-SCALBN SDL-LROUNDF SDL-LROUND SDL-ROUNDF SDL-ROUND
                        SDL-POWF SDL-POW SDL-LOG10F SDL-LOG10 SDL-LOGF SDL-LOG
                        SDL-FMODF SDL-FMOD SDL-TRUNCF SDL-TRUNC SDL-FLOORF
                        SDL-FLOOR SDL-FABSF SDL-FABS SDL-EXPF SDL-EXP SDL-COSF
                        SDL-COS SDL-COPYSIGNF SDL-COPYSIGN SDL-CEILF SDL-CEIL
                        SDL-ATAN2F SDL-ATAN2 SDL-ATANF SDL-ATAN SDL-ASINF
                        ...
                        SDL-STRTOD SDL-STRTOULL SDL-STRTOLL SDL-STRTOUL
                        SDL-STRTOL SDL-ATOF SDL-ATOI SDL-ULLTOA SDL-LLTOA
                        SDL-ULTOA SDL-LTOA SDL-UITOA SDL-ITOA SDL-UTF8STRNLEN
                        SDL-UTF8STRLEN SDL-STRTOKR SDL-STRCASESTR SDL-STRSTR
                        SDL-STRRCHR SDL-STRCHR SDL-STRLWR SDL-STRUPR SDL-STRREV
                        SDL-STRDUP SDL-STRLCAT SDL-UTF8STRLCPY SDL-STRLCPY
                        SDL-STRLEN SDL-WCSNCASECMP SDL-WCSCASECMP SDL-WCSNCMP
                        SDL-WCSCMP SDL-WCSSTR SDL-WCSDUP SDL-WCSLCAT
                        SDL-WCSLCPY SDL-WCSLEN SDL-MEMCMP SDL-MEMMOVE
                        SDL-MEMCPY SDL-MEMSET SDL-CRC32 SDL-CRC16 SDL-TOLOWER
                        SDL-TOUPPER SDL-ISGRAPH SDL-ISPRINT SDL-ISLOWER
                        SDL-ISUPPER SDL-ISSPACE SDL-ISPUNCT SDL-ISXDIGIT
                        SDL-ISDIGIT SDL-ISCNTRL SDL-ISBLANK SDL-ISALNUM
                        SDL-ISALPHA SDL-ABS SDL-BSEARCH SDL-QSORT SDL-SETENV
                        SDL-GETENV SDL-GET-NUM-ALLOCATIONS
                        SDL-SET-MEMORY-FUNCTIONS SDL-GET-MEMORY-FUNCTIONS
                        SDL-GET-ORIGINAL-MEMORY-FUNCTIONS SDL-FREE SDL-REALLOC
                        SDL-CALLOC SDL-MALLOC __SCALBL SCALBL __FMAL FMAL
                        __FMINL FMINL __FMAXL FMAXL __FDIML FDIML __LLROUNDL
                        LLROUNDL __LROUNDL LROUNDL __LLRINTL LLRINTL __LRINTL
                        LRINTL __REMQUOL REMQUOL __TRUNCL TRUNCL __ROUNDL
                        ROUNDL __NEARBYINTL NEARBYINTL __SCALBLNL SCALBLNL
                        __ILOGBL ILOGBL __SCALBNL SCALBNL __REMAINDERL
                        REMAINDERL __NEXTTOWARDL NEXTTOWARDL __NEXTAFTERL
                        NEXTAFTERL __RINTL RINTL __LGAMMAL_R LGAMMAL-R __GAMMAL
                        GAMMAL __TGAMMAL TGAMMAL __LGAMMAL LGAMMAL __ERFCL
                        ERFCL __ERFL ERFL __YNL YNL |__Y1L| Y1L |__Y0L| Y0L
                        __JNL JNL |__J1L| J1L |__J0L| J0L ISNANL __NANL NANL
                        __COPYSIGNL COPYSIGNL __SIGNIFICANDL SIGNIFICANDL
                        __DREML DREML FINITEL ISINFL __FMODL FMODL __FLOORL
                        FLOORL __FABSL FABSL __CEILL CEILL __CBRTL CBRTL
                        __HYPOTL HYPOTL __SQRTL SQRTL __POWL POWL __LOG2L LOG2L
                        __EXP2L EXP2L __LOGBL LOGBL __LOG1PL LOG1PL __EXPM1L
                        ...
                        LLRINTF __LRINTF LRINTF __REMQUOF REMQUOF __TRUNCF
                        TRUNCF __ROUNDF ROUNDF __NEARBYINTF NEARBYINTF
                        __SCALBLNF SCALBLNF __ILOGBF ILOGBF __SCALBNF SCALBNF
                        __REMAINDERF REMAINDERF __NEXTTOWARDF NEXTTOWARDF
                        __NEXTAFTERF NEXTAFTERF __RINTF RINTF __LGAMMAF_R
                        LGAMMAF-R __GAMMAF GAMMAF __TGAMMAF TGAMMAF __LGAMMAF
                        LGAMMAF __ERFCF ERFCF __ERFF ERFF __YNF YNF |__Y1F| Y1F
                        |__Y0F| Y0F __JNF JNF |__J1F| J1F |__J0F| J0F ISNANF
                        __NANF NANF __COPYSIGNF COPYSIGNF __SIGNIFICANDF
                        SIGNIFICANDF __DREMF DREMF FINITEF ISINFF __FMODF FMODF
                        __FLOORF FLOORF __FABSF FABSF __CEILF CEILF __CBRTF
                        CBRTF __HYPOTF HYPOTF __SQRTF SQRTF __POWF POWF __LOG2F
                        LOG2F __EXP2F EXP2F __LOGBF LOGBF __LOG1PF LOG1PF
                        __EXPM1F EXPM1F __MODFF MODFF __LOG10F LOG10F __LOGF
                        LOGF __LDEXPF LDEXPF __FREXPF FREXPF __EXPF EXPF
                        __ATANHF ATANHF __ASINHF ASINHF __ACOSHF ACOSHF __TANHF
                        TANHF __SINHF SINHF __COSHF COSHF __TANF TANF __SINF
                        SINF __COSF COSF __ATAN2F ATAN2F __ATANF ATANF __ASINF
                        ASINF __ACOSF ACOSF __ISSIGNALINGF __ISEQSIGF __ISNANF
                        __FINITEF __ISINFF __SIGNBITF __FPCLASSIFYF __SCALB
                        SCALB __FMA FMA __FMIN FMIN __FMAX FMAX __FDIM FDIM
                        __LLROUND LLROUND __LROUND LROUND __LLRINT LLRINT
                        __LRINT LRINT __REMQUO REMQUO __TRUNC TRUNC __ROUND
                        ROUND __NEARBYINT NEARBYINT __SCALBLN SCALBLN __ILOGB
                        ILOGB __SCALBN SCALBN __REMAINDER REMAINDER
                        __NEXTTOWARD NEXTTOWARD __NEXTAFTER NEXTAFTER __RINT
                        RINT __LGAMMA_R LGAMMA-R __GAMMA GAMMA __TGAMMA TGAMMA
                        __LGAMMA LGAMMA __ERFC ERFC __ERF ERF __YN YN |__Y1| Y1
                        |__Y0| Y0 __JN JN |__J1| J1 |__J0| J0 ISNAN __NAN NAN
                        __COPYSIGN COPYSIGN __SIGNIFICAND SIGNIFICAND __DREM
                        DREM FINITE ISINF __FMOD FMOD __FLOOR FLOOR __FABS FABS
                        __CEIL CEIL __CBRT CBRT __HYPOT HYPOT __SQRT SQRT __POW
                        POW __LOG2 LOG2 __EXP2 EXP2 __LOGB LOGB __LOG1P LOG1P
                        __EXPM1 EXPM1 __MODF MODF __LOG10 LOG10 __LOG LOG
                        ...
                        __ISEQSIG __ISNAN __FINITE __ISINF __SIGNBIT
                        __FPCLASSIFY TOUPPER-L __TOUPPER_L TOLOWER-L
                        __TOLOWER_L ISBLANK-L ISXDIGIT-L ISUPPER-L ISSPACE-L
                        ISPUNCT-L ISPRINT-L ISGRAPH-L ISLOWER-L ISDIGIT-L
                        ISCNTRL-L ISALPHA-L ISALNUM-L _TOLOWER _TOUPPER TOASCII
                        ISASCII ISBLANK TOUPPER TOLOWER ISXDIGIT ISUPPER
                        ISSPACE ISPUNCT ISPRINT ISGRAPH ISLOWER ISDIGIT ISCNTRL
                        ISALPHA ISALNUM __CTYPE_TOUPPER_LOC __CTYPE_TOLOWER_LOC
                        __CTYPE_B_LOC WCSTOUMAX WCSTOIMAX STRTOUMAX STRTOIMAX
                        IMAXDIV IMAXABS WCSFTIME UNGETWC FPUTWS FGETWS PUTWCHAR
                        PUTWC FPUTWC GETWCHAR GETWC FGETWC VSWSCANF VWSCANF
                        VFWSCANF VSWSCANF VWSCANF VFWSCANF SWSCANF WSCANF
                        FWSCANF SWSCANF WSCANF FWSCANF VSWPRINTF VWPRINTF
                        VFWPRINTF SWPRINTF WPRINTF FWPRINTF FWIDE
                        OPEN-WMEMSTREAM WCPNCPY WCPCPY WCSTOULL WCSTOLL WCSTOUL
                        WCSTOL WCSTOLD WCSTOF WCSTOD WCSNRTOMBS MBSNRTOWCS
                        WCSRTOMBS MBSRTOWCS MBRLEN __MBRLEN WCRTOMB MBRTOWC
                        MBSINIT WCTOB BTOWC WMEMSET WMEMMOVE WMEMCPY WMEMCMP
                        WMEMCHR WCSNLEN WCSLEN WCSTOK WCSSTR WCSPBRK WCSSPN
                        WCSCSPN WCSRCHR WCSCHR WCSDUP WCSXFRM-L WCSCOLL-L
                        ...
                        STRCHR STRNDUP STRDUP STRXFRM-L STRCOLL-L STRXFRM
                        STRCOLL STRNCMP STRCMP STRNCAT STRCAT STRNCPY STRCPY
                        MEMCHR __MEMCMPEQ MEMCMP MEMSET MEMCCPY MEMMOVE MEMCPY
                        GETLOADAVG GETSUBOPT RPMATCH WCSTOMBS MBSTOWCS WCTOMB
                        MBTOWC MBLEN QFCVT-R QECVT-R FCVT-R ECVT-R QGCVT QFCVT
                        QECVT GCVT FCVT ECVT LLDIV LDIV DIV LLABS LABS ABS
                        QSORT BSEARCH REALPATH SYSTEM MKDTEMP MKSTEMPS MKSTEMP
                        MKTEMP CLEARENV UNSETENV SETENV PUTENV GETENV _EXIT
                        QUICK-EXIT EXIT ON-EXIT AT-QUICK-EXIT ATEXIT ABORT
                        ALIGNED-ALLOC POSIX-MEMALIGN VALLOC ALLOCA REALLOCARRAY
                        REALLOCARRAY FREE REALLOC CALLOC MALLOC
                        ARC4RANDOM-UNIFORM ARC4RANDOM-BUF ARC4RANDOM LCONG48-R
                        SEED48-R SRAND48-R JRAND48-R MRAND48-R NRAND48-R
                        LRAND48-R ERAND48-R DRAND48-R LCONG48 SEED48 SRAND48
                        JRAND48 MRAND48 NRAND48 LRAND48 ERAND48 DRAND48 RAND-R
                        SRAND RAND SETSTATE-R INITSTATE-R SRANDOM-R RANDOM-R
                        SETSTATE INITSTATE SRANDOM RANDOM A64L L64A STRTOULL
                        STRTOLL STRTOUQ STRTOQ STRTOUL STRTOL STRTOLD STRTOF
                        STRTOD ATOLL ATOL ATOI ATOF __CTYPE_GET_MB_CUR_MAX
                        __OVERFLOW __UFLOW FUNLOCKFILE FTRYLOCKFILE FLOCKFILE
                        CTERMID POPEN PCLOSE FILENO-UNLOCKED FILENO PERROR
                        FERROR-UNLOCKED FEOF-UNLOCKED CLEARERR-UNLOCKED FERROR
                        FEOF CLEARERR FSETPOS FGETPOS FTELLO FSEEKO REWIND
                        FTELL FSEEK FWRITE-UNLOCKED FREAD-UNLOCKED FWRITE FREAD
                        UNGETC PUTS FPUTS GETLINE GETDELIM __GETDELIM FGETS
                        PUTW GETW PUTCHAR-UNLOCKED PUTC-UNLOCKED FPUTC-UNLOCKED
                        PUTCHAR PUTC FPUTC FGETC-UNLOCKED GETCHAR-UNLOCKED
                        GETC-UNLOCKED GETCHAR GETC FGETC VSSCANF VSCANF VFSCANF
                        VSSCANF VSCANF VFSCANF SSCANF SCANF FSCANF SSCANF SCANF
                        FSCANF DPRINTF VDPRINTF VSNPRINTF SNPRINTF VSPRINTF
                        VPRINTF VFPRINTF SPRINTF PRINTF FPRINTF SETLINEBUF
                        SETBUFFER SETVBUF SETBUF OPEN-MEMSTREAM FMEMOPEN FDOPEN
                        FREOPEN FOPEN FFLUSH-UNLOCKED FFLUSH TEMPNAM TMPNAM-R
                        TMPNAM TMPFILE FCLOSE RENAMEAT RENAME REMOVE PSELECT
                        SELECT SDL-GET-PLATFORM)
    #<PACKAGE "DUMMY">)
   (EXPORT '(SIGNGAM STDERR STDOUT STDIN) #<PACKAGE "DUMMY">)
   (EXPORT
    '(+PRIXPTR+ +PR-IX-PTR+ +PR-IU-PTR+ +_IO_EOF_SEEN+ +SC-ND16+ +SC-ND8+
      +_IO_ERR_SEEN+ +PRIXMAX+ +PR-IX-MAX+ +PR-IO-PTR+ +PR-II-PTR+ +PR-ID-PTR+
      +SC-ND-FAST8+ +SC-ND-LEAST64+ +SC-ND-FAST64+ +SC-ND-FAST32+
      +SC-ND-FAST16+ +SC-ND-LEAST8+ +SC-ND64+ +SC-ND32+ +SC-ND-LEAST32+
      +SC-ND-LEAST16+ +SC-NI-LEAST32+ +SDL-TOUCH-MOUSEID+ +SC-NI-LEAST16+
      +SC-NI-FAST8+ +SDL-MOUSE-TOUCHID+ +SC-NI-LEAST64+ +SC-NI16+ +SC-NI8+
      +SC-NI-LEAST8+ +SC-NI32+ +__LINUX__+ +SC-NI64+ +SC-NU-LEAST8+ +SC-NU32+
      +SC-NU64+ +SC-NU-LEAST32+ +SC-NU-LEAST16+ +SC-NI-FAST64+ +SC-NI-FAST16+
      +SC-NI-FAST32+ +SC-NU16+ +SC-NU8+ +SC-NO8+ +SC-NO16+ +SC-NO64+ +SC-NO32+
      +SC-NO-LEAST8+ +SC-NU-LEAST64+ +SC-NU-FAST32+ +SC-NU-FAST8+
      +SC-NU-FAST64+ +SC-NU-FAST16+ +SC-NO-FAST32+ +SC-NO-FAST16+
      +SC-NO-FAST64+ +SC-NX8+ +SC-NX16+ +SC-NO-LEAST16+ +SC-NO-LEAST32+
      +SC-NO-LEAST64+ +_INTTYPES_H+ +SC-NO-FAST8+ +SC-NX-LEAST64+
      +_BITS_STDINT_UINTN_H+ +SC-NX-FAST8+ +SC-NX-FAST16+ +SC-NX-FAST32+
      +_STDINT_H+ +SC-NX-FAST64+ +SC-NX32+ +SC-NX64+ +SC-NX-LEAST8+
      +SC-NX-LEAST16+ +SC-NX-LEAST32+ +SC-ND-MAX+ +__GCC_HAVE_DWARF2_CFI_ASM+
      +_THREAD_MUTEX_INTERNAL_H+ +HAVE-STRTOL+ +HAVE-STRTOUL+ +HAVE-ATOF+
      +HAVE-STRCMP+ +HAVE-STRNCMP+ +__DEFAULT_FN_ATTRS256+ +HAVE-STRCASECMP+
      +HAVE-STRNCASECMP+ +HAVE-STRTOLL+ +HAVE-STRTOULL+ +HAVE-STRTOD+
      +HAVE-ATOI+ +__SIZEOF_PTHREAD_MUTEXATTR_T+ +__SIZEOF_PTHREAD_COND_T+
      +__SIZEOF_PTHREAD_CONDATTR_T+ +__SIZEOF_PTHREAD_RWLOCKATTR_T+
      +__SIZEOF_PTHREAD_BARRIERATTR_T+ +_BITS_PTHREADTYPES_COMMON_H+
      +_THREAD_SHARED_TYPES_H+ +_BITS_PTHREADTYPES_ARCH_H+
      +__SIZEOF_PTHREAD_MUTEX_T+ +__SIZEOF_PTHREAD_ATTR_T+
      +__SIZEOF_PTHREAD_RWLOCK_T+ +__SIZEOF_PTHREAD_BARRIER_T+ +PR-II-MAX+
      +PR-IO-MAX+ +PR-IU-MAX+ +PRIXFAST64+ +PR-ID-MAX+ +PRIXFAST8+ +PRIXFAST16+
      +PRIXFAST32+ +PRIXLEAST64+ +HAVE-ICONV+
      +__KERNEL_OLD_TIMEVAL_MATCHES_TIMEVAL64+ +__FD_SETSIZE+
      +HAVE-PTHREAD-SETNAME-NP+ +HAVE-CLOCK-GETTIME+ +_BITS_TIME64_H+
      +__TIME64_T_TYPE+ +HAVE-MPROTECT+ +__OFF_T_MATCHES_OFF64_T+
      +__INO_T_MATCHES_INO64_T+ +__RLIM_T_MATCHES_RLIM64_T+
      +HAVE-SEM-TIMEDWAIT+ +HAVE-GETAUXVAL+ +__STATFS_MATCHES_STATFS64+
      +HAVE-POLL+ +__FSID_T_TYPE+ +__SSIZE_T_TYPE+ +__CPU_MASK_TYPE+
      +__KEY_T_TYPE+ +__CLOCKID_T_TYPE+ +__TIMER_T_TYPE+ +__BLKSIZE_T_TYPE+
      +HAVE-SINF+ +__TIME_T_TYPE+ +HAVE-SIN+ +HAVE-SQRT+ +__USECONDS_T_TYPE+
      +__SUSECONDS_T_TYPE+ +HAVE-SCALBN+ +__DADDR_T_TYPE+
      +__SUSECONDS64_T_TYPE+ +HAVE-SCALBNF+ +HAVE-TANF+ +HAVE-TRUNC+
      +HAVE-SQRTF+ +__ID_T_TYPE+ +HAVE-TAN+ +__CLOCK_T_TYPE+ +HAVE-FSEEKO64+
      +HAVE-SIGACTION+ +HAVE-TRUNCF+ +HAVE-FSEEKO+ +HAVE-FOPEN64+
      +HAVE-NANOSLEEP+ +HAVE-SYSCONF+ +HAVE-SA-SIGACTION+ +HAVE-SETJMP+
      +_MM_FROUND_NINT+ +HAVE-FABSF+ +HAVE-FABS+ +_MM_FROUND_NO_EXC+
      +HAVE-EXPF+ +_MM_FROUND_RAISE_EXC+ +_MM_FROUND_CUR_DIRECTION+ +HAVE-EXP+
      +_MM_FROUND_TO_ZERO+ +HAVE-LOG+ +_MM_FROUND_TO_POS_INF+ +HAVE-FMODF+
      +_MM_FROUND_TO_NEG_INF+ +HAVE-FMOD+ +_MM_FROUND_TO_NEAREST_INT+
      +HAVE-FLOOR+ +HAVE-FLOORF+ +HAVE-LROUND+ +HAVE-LROUNDF+ +HAVE-LOG10F+
      +HAVE-LOG10+ +HAVE-LOGF+ +HAVE-ROUNDF+ +HAVE-ROUND+ +HAVE-POWF+
      +HAVE-POW+ +HAVE-VSNPRINTF+ +HAVE-VSSCANF+ +HAVE-STRCASESTR+
      +SDL-MAX-LOG-MESSAGE+ +HAVE-ATAN+ +HAVE-ASINF+ +SC-NO-PTR+ +HAVE-ASIN+
      +HAVE-ACOSF+ +HAVE-ACOS+ +HAVE-CEIL+ +SC-NI-MAX+ +HAVE-ATAN2F+
      +HAVE-ATAN2+ +SC-NO-MAX+ +HAVE-ATANF+ +SC-NU-MAX+ +HAVE-COSF+ +SC-NX-MAX+
      +SC-ND-PTR+ +HAVE-COS+ +_MM_FROUND_TRUNC+ +SC-NI-PTR+ +HAVE-COPYSIGNF+
      +HAVE-COPYSIGN+ +_MM_FROUND_CEIL+ +SC-NU-PTR+ +HAVE-CEILF+
      +_MM_FROUND_FLOOR+ +__ATTR_DEALLOC_FCLOSE+ +SDL-PRESSED+ +SDL-RELEASED+
      +FILENAME-MAX+ +TMP-MAX+ +L-TMPNAM+ +_BITS_STDIO_LIM_H+ +STDERR+ +STDOUT+
      +FOPEN-MAX+ +STDIN+ +L-CTERMID+ +BUFSIZ+ +_IONBF+ +_IOLBF+ +_IOFBF+
      +P-TMPDIR+ +SEEK-END+ +SEEK-CUR+ +SEEK-SET+ +EOF+ +_IO_USER_LOCK+
      +__DEFAULT_FN_ATTRS128+ +HAVE-STRSTR+ +HAVE-STRTOK-R+ +HAVE-STRCHR+
      +HAVE-STRRCHR+ +HAVE-INDEX+ +HAVE-WCSNCASECMP+ +HAVE-RINDEX+
      +HAVE-STRLEN+ +HAVE-WCSNCMP+ +HAVE-WCSCASECMP+ +HAVE-WCSCMP+
      +__DEFAULT_FN_ATTRS_MMX+ +HAVE-WCSSTR+ +HAVE-WCSDUP+ +HAVE-WCSLEN+
      +HAVE-MEMCMP+ +HAVE-MEMMOVE+ +HAVE-MEMSET+ +HAVE-MEMCPY+ +HAVE-BCOPY+
      +HAVE-ABS+ +__MATHCALL_NARROW_ARGS_1+ +HAVE-BSEARCH+ +HAVE-QSORT+
      +__MATHCALL_NARROW_ARGS_3+ +HAVE-UNSETENV+ +HAVE-PUTENV+ +HAVE-GETENV+
      +HAVE-SETENV+ +SDL-HINT-JOYSTICK-RAWINPUT+ +HAVE-ALLOCA+
      +__MATHCALL_NARROW_ARGS_2+ +HAVE-FREE+ +HAVE-REALLOC+ +HAVE-CALLOC+
      +HAVE-MALLOC+ +HAVE-DLOPEN+ +HAVE-LINUX-INPUT-H+ +HAVE-WCHAR-H+
      +HAVE-SYS-TYPES-H+ +RW-SEEK-SET+ +HAVE-STRING-H+ +RW-SEEK-CUR+
      +HAVE-STRINGS-H+ +HAVE-STDLIB-H+ +RW-SEEK-END+ +HAVE-STDIO-H+
      +HAVE-STDINT-H+ +HAVE-STDARG-H+ +HAVE-SIGNAL-H+
      +SDL-HINT-MAC-CTRL-CLICK-EMULATE-RIGHT-CLICK+ +HAVE-MEMORY-H+
      +SDL-HINT-MAC-BACKGROUND-APP+ +HAVE-MATH-H+ +_M_PEXTRW+ +HAVE-MALLOC-H+
      +_M_PINSRW+ +SDL-HINT-LOGGING+ +_M_PMAXSW+ +_M_PMAXUB+ +_M_PMINSW+
      +_M_PMOVMSKB+ +_M_PMINUB+ +SDL-HINT-MAC-OPENGL-ASYNC-DISPATCH+
      +_M_PMULHUW+ +_M_PSHUFW+ +M-PI-2+ +M-LN10+ +M-PI+ +M-1-PI+ +M-2-PI+
      +M-PI-4+ +SDL-HINT-JOYSTICK-HIDAPI-XBOX-360+ +M-SQRT2+ +M-2-SQRTPI+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-360-PLAYER-LED+ +M-SQRT1-2+ +MATH-ERRNO+
      +SDL-HINT-LINUX-JOYSTICK-DEADZONES+ +MATH-ERREXCEPT+ +M-LOG2E+ +M-E+
      +MATH-ERRHANDLING+ +M-LN2+ +M-LOG10E+ +SDL-HINT-JOYSTICK-HIDAPI-XBOX+
      +_M_MASKMOVQ+ +_M_PAVGB+ +_M_PAVGW+ +SDL-HINT-LINUX-DIGITAL-HATS+
      +SDL-HINT-JOYSTICK-HIDAPI-SWITCH-PLAYER-LED+ +_MM_EXCEPT_INEXACT+
      +SDL-HINT-JOYSTICK-HIDAPI-WII-PLAYER-LED+ +_MM_EXCEPT_UNDERFLOW+
      +SDL-HINT-JOYSTICK-HIDAPI-WII+ +_MM_MASK_INVALID+ +_MM_EXCEPT_MASK+
      +_MM_MASK_DIV_ZERO+ +_MM_MASK_DENORM+ +_MM_MASK_UNDERFLOW+
      +_MM_MASK_OVERFLOW+ +SDL-HINT-JOYSTICK-IOKIT+
      +SDL-HINT-KMSDRM-REQUIRE-DRM-MASTER+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-ONE-HOME-LED+ +_MM_ALIGN16+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-360-WIRELESS+
      +SDL-HINT-JOYSTICK-HIDAPI-XBOX-ONE+ +_MM_EXCEPT_DENORM+
      +SDL-HINT-JOYSTICK-RAWINPUT-CORRELATE-XINPUT+ +_MM_EXCEPT_INVALID+
      +_MM_EXCEPT_OVERFLOW+ +SDL-HINT-JOYSTICK-MFI+ +_MM_EXCEPT_DIV_ZERO+
      +SDL-HINT-JOYSTICK-THROTTLE-DEVICES+ +SDL-HINT-JOYSTICK-THREAD+
      +SDL-HINT-JOYSTICK-WGI+ +_MM_FLUSH_ZERO_OFF+
      +SDL-HINT-LINUX-JOYSTICK-CLASSIC+ +SDL-HINT-JOYSTICK-ROG-CHAKRAM+
      +SDL-HINT-JOYSTICK-WHEEL-DEVICES+
      +SDL-HINT-JOYSTICK-WHEEL-DEVICES-EXCLUDED+
      +SDL-HINT-JOYSTICK-THROTTLE-DEVICES-EXCLUDED+ +SDL-HINT-JOYSTICK-DEVICE+
      +_MM_MASK_MASK+ +_MM_MASK_INEXACT+
      +SDL-HINT-JOYSTICK-ZERO-CENTERED-DEVICES+ +_MM_ROUND_DOWN+ +_MM_ROUND_UP+
      +_MM_ROUND_NEAREST+ +_MM_ROUND_MASK+ +_MM_ROUND_TOWARD_ZERO+
      +SDL-HINT-LINUX-HAT-DEADZONES+ +_MM_FLUSH_ZERO_ON+ +_MM_FLUSH_ZERO_MASK+
      ...
      +SDL-HINT-JOYSTICK-HIDAPI-LUNA+ +SDL-HINT-JOYSTICK-GAMECUBE-RUMBLE-BRAKE+
      +SDL-HINT-JOYSTICK-HIDAPI-JOY-CONS+
      +SDL-HINT-JOYSTICK-HIDAPI-COMBINE-JOY-CONS+
      +SDL-HINT-JOYSTICK-HIDAPI-PS4-RUMBLE+ +SDL-HINT-JOYSTICK-HIDAPI-PS5+
      +SDL-HINT-JOYSTICK-HIDAPI-PS5-PLAYER-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-PS5-RUMBLE+ +SDL-HINT-JOYSTICK-HIDAPI-SHIELD+
      +SDL-HINT-JOYSTICK-HIDAPI-PS3+ +SDL-HINT-JOYSTICK-HIDAPI-PS4+
      +SDL-HINT-JOYSTICK-HIDAPI-SWITCH+
      +SDL-HINT-JOYSTICK-HIDAPI-SWITCH-HOME-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-JOYCON-HOME-LED+
      +SDL-HINT-JOYSTICK-HIDAPI-STEAMDECK+ +SDL-HINT-JOYSTICK-HIDAPI-STADIA+
      +SDL-HINT-JOYSTICK-HIDAPI-STEAM+ +SDL-HINT-ENABLE-SCREEN-KEYBOARD+
      +SDL-HINT-EMSCRIPTEN-KEYBOARD-ELEMENT+ +SDL-HINT-EVENT-LOGGING+
      +SDL-HINT-ENABLE-STEAM-CONTROLLERS+ +SDL-HINT-BMP-SAVE-LEGACY-FORMAT+
      +SDL-HINT-EMSCRIPTEN-ASYNCIFY+ +__PTHREAD_RWLOCK_ELISION_EXTRA+
      +SDL-HINT-DISPLAY-USABLE-BOUNDS+ +SDL-HINT-GAMECONTROLLERTYPE+
      +SDL-HINT-GAMECONTROLLERCONFIG-FILE+
      +SDL-HINT-GAMECONTROLLER-IGNORE-DEVICES+ +SDL-HINT-FORCE-RAISEWINDOW+
      +SDL-HINT-ANDROID-BLOCK-ON-PAUSE+
      +SDL-HINT-JOYSTICK-ALLOW-BACKGROUND-EVENTS+
      +SDL-HINT-JOYSTICK-BLACKLIST-DEVICES+ +SDL-HINT-GRAB-KEYBOARD+
      +SDL-HINT-GAMECONTROLLERCONFIG+ +SDL-HINT-IME-SUPPORT-EXTENDED-TEXT+
      +SDL-HINT-FRAMEBUFFER-ACCELERATION+ +SDL-HINT-IDLE-TIMER-DISABLED+
      +SDL-HINT-IME-SHOW-UI+ +SDL-HINT-IME-INTERNAL-EDITING+
      +SDL-HINT-ANDROID-BLOCK-ON-PAUSE-PAUSEAUDIO+
      +SDL-HINT-IOS-HIDE-HOME-INDICATOR+ +__PTHREAD_MUTEX_HAVE_PREV+
      ...
      +SDL-HINT-HIDAPI-IGNORE-DEVICES+ +SDL-HINT-JOYSTICK-ARCADESTICK-DEVICES+
      ...
      +SDL-HINT-APP-NAME+ +_MM512_PERMUTEVAR_EPI32+
      +_MM512_MASK_PERMUTEVAR_EPI32+ +SDL-HINT-APPLE-TV-CONTROLLER-UI-EVENTS+
      +SDL-HINT-ANDROID-TRAP-BACK-BUTTON+ +SDL-HINT-AUTO-UPDATE-JOYSTICKS+
      +SDL-HINT-AUTO-UPDATE-SENSORS+ +SDL-HINT-AUDIO-DEVICE-STREAM-ROLE+
      +SDL-HINT-AUDIO-RESAMPLING-MODE+ +SDL-HINT-AUDIO-DEVICE-APP-NAME+
      +SDL-HINT-AUDIO-DEVICE-STREAM-NAME+ +SDL-HINT-AUDIO-CATEGORY+ +_MDOUBLE_+
      +__MATH_DECLARING_FLOATN+ +__MATH_DECLARING_DOUBLE+ +FP-ILOGB0+
      +__FP_LOGBNAN_IS_MIN+ +_KAND_MASK16+ +__FP_LOGB0_IS_MIN+ +_KANDN_MASK16+
      +__GLIBC_FLT_EVAL_METHOD+ +NAN+ +INFINITY+ +HUGE-VALL+ +HUGE-VALF+
      +HUGE-VAL+ +_KNOT_MASK16+ +_KOR_MASK16+ +_KXNOR_MASK16+ +_KXOR_MASK16+
      +FP-ILOGBNAN+ +SDL-TEXTEDITINGEVENT-TEXT-SIZE+
      +SDL-TEXTINPUTEVENT-TEXT-SIZE+ +SDL-COLOUR+ +SDL-HAPTIC-STEERING-AXIS+
      +SDL-HAPTIC-INFINITY+ +SDL-HAPTIC-AUTOCENTER+ +SDL-HAPTIC-STATUS+
      +SDL-HAPTIC-CUSTOM+ +SDL-HAPTIC-GAIN+ +SDL-HAPTIC-CARTESIAN+
      +SDL-HAPTIC-SPHERICAL+ +SDL-HAPTIC-PAUSE+ +SDL-HAPTIC-POLAR+
      +SDL-HAPTIC-SAWTOOTHDOWN+ +SDL-HAPTIC-RAMP+ +SDL-INVALID-SHAPE-ARGUMENT+
      +SDL-HAPTIC-TRIANGLE+ +SDL-WINDOW-LACKS-SHAPE+ +SDL-HAPTIC-SAWTOOTHUP+
      +SDL-HAPTIC-INERTIA+ +SDL-NONSHAPEABLE-WINDOW+ +SDL-HAPTIC-FRICTION+
      +SDL-HAPTIC-SPRING+ +SDL-HAPTIC-DAMPER+ +SDL-DISABLE+ +SDL-HAPTIC-SINE+
      +SDL-IGNORE+ +SDL-HAPTIC-LEFTRIGHT+ +SDL-HAPTIC-CONSTANT+ +SDL-ENABLE+
      +_BITS_LIBM_SIMD_DECL_STUBS_H+ +__SAVE_GPRBX+ +__RESTORE_GPRBX+
      +__TMPGPR+ +_MATH_H+ +_MM_CMPINT_GE+ +_MM_CMPINT_GT+ +SDL-QUERY+
      +AUDIO-S16MSB+ +AUDIO-U16MSB+ +AUDIO-S16LSB+
      +__HAVE_FLOAT128_UNLIKE_LDBL+ +AUDIO-U16LSB+ +__HAVE_FLOATN_NOT_TYPEDEF+
      +AUDIO-S8+ +AUDIO-U8+ +__CFLOAT32+ +__HAVE_DISTINCT_FLOAT16+
      +__HAVE_DISTINCT_FLOAT32+ +__HAVE_FLOAT32X+ +__HAVE_FLOAT128X+
      +__HAVE_DISTINCT_FLOAT64X+ +SDL-AUDIO-MASK-SIGNED+
      +__HAVE_DISTINCT_FLOAT128X+ +SDL-AUDIO-MASK-ENDIAN+
      +SDL-AUDIO-MASK-DATATYPE+ +__HAVE_DISTINCT_FLOAT64+
      +__HAVE_DISTINCT_FLOAT32X+ +SDL-AUDIO-MASK-BITSIZE+ +__W_CONTINUED+
      +WNOHANG+ +WUNTRACED+ +WSTOPPED+ +__CFLOAT64+ +__CFLOAT32X+ +WEXITED+
      +WCONTINUED+ +__CFLOAT64X+ +WNOWAIT+ +__WNOTHREAD+ +__WALL+ +__WCLONE+
      +AUDIO-U16+ +_WCHAR_H+ +__HAVE_FLOAT64X_LONG_DOUBLE+ +__HAVE_FLOAT64X+
      +__HAVE_DISTINCT_FLOAT128+ +__HAVE_FLOAT128+ +__HAVE_FLOAT64+
      +__HAVE_FLOAT32+ +__HAVE_FLOAT16+ +SDLK-SCANCODE-MASK+ +HAVE-INOTIFY+
      +HAVE-IBUS-IBUS-H+ +HAVE-INOTIFY-INIT+ +__ONCE_FLAG_INIT+
      +HAVE-INOTIFY-INIT1+ +_MM_FROUND_RINT+ +HAVE-FCITX+
      +_MM_FROUND_NEARBYINT+ +HAVE-SYS-INOTIFY-H+ +HAVE-O-CLOEXEC+
      +HAVE-DBUS-DBUS-H+ +HAVE--EXIT+ +__HAVE_PTHREAD_ATTR_T+ +__WCOREFLAG+
      +__LLDIV_T_DEFINED+ +__LDIV_T_DEFINED+ +SDL-HINT-KMSDRM-DEVICE-INDEX+
      +SDL-HINT-TRACKPAD-IS-TOUCH-ONLY+ +SDL-HINT-VIDEODRIVER+
      +SDL-HINT-AUDIODRIVER+ +SDL-HINT-QUIT-ON-LAST-WINDOW-CLOSE+
      +SDL-HINT-AUDIO-INCLUDE-MONITORS+ +SDL-HINT-X11-WINDOW-TYPE+
      +SDL-HINT-XINPUT-USE-OLD-JOYSTICK-MAPPING+ +MB-CUR-MAX+ +EXIT-FAILURE+
      +EXIT-SUCCESS+ +RAND-MAX+ +SDL-HINT-SHUTDOWN-DBUS-ON-QUIT+
      +SDL-ASSERT-DATA+ +SDL-SWSURFACE+ +SDL-PREALLOC+ +SDL-STANDARD-GRAVITY+
      +SDL-DONTFREE+ +SDL-ASSERT-STATE+ +SDL-VIDEO-RENDER-OGL-ES2+
      +SDL-RLEACCEL+ +____FILE_DEFINED+ +SDL-VIDEO-OPENGL+
      +SDL-VIDEO-OPENGL-ES2+ +SDL-SIMD-ALIGNED+ +SDL-VIDEO-OPENGL-EGL+
      +__FILE_DEFINED+ +__STRUCT_FILE_DEFINED+
      +SDL-VIDEO-DRIVER-X11-SUPPORTS-GENERIC-EVENTS+
      +SDL-VIDEO-DRIVER-X11-HAS-XKBKEYCODETOKEYSYM+ +SDL-VIDEO-RENDER-OGL+
      +SDL-VIDEO-DRIVER-X11-XFIXES+ +__MATH_DECLARE_LDOUBLE+
      +SDL-VIDEO-DRIVER-X11-XRANDR+ +SDL-VIDEO-DRIVER-X11-XSCRNSAVER+
      +SDL-VIDEO-DRIVER-X11-XSHAPE+ +SDL-VIDEO-DRIVER-X11-XDBE+
      +SDL-VIDEO-DRIVER-X11-XINPUT2+
      +SDL-VIDEO-DRIVER-X11-XINPUT2-SUPPORTS-MULTITOUCH+
      +SDL-HINT-POLL-SENTINEL+ +SDL-CACHELINE-SIZE+ +DYNAPI-NEEDS-DLOPEN+
      +SDL-USE-IME+ +SDL-HINT-QTWAYLAND-WINDOW-FLAGS+
      +SDL-HINT-MOUSE-RELATIVE-MODE-CENTER+ +SDL-UDEV-DYNAMIC+
      +_DEFAULT_FN_ATTRS+ +SDL-VIDEO-OPENGL-GLX+
      +SDL-HINT-RENDER-DIRECT3D11-DEBUG+ +SDL-VIDEO-VULKAN+ +SDL-POWER-LINUX+
      +SDL-FILESYSTEM-UNIX+ +SDL-INPUT-LINUXEV+
      +SDL-AUDIO-DRIVER-SNDIO-DYNAMIC+ +_STDIO_H+ +SDL-JOYSTICK-LINUX+
      +_MM_DENORMALS_ZERO_ON+ +__GLIBC_USE_LIB_EXT2+ +SDL-INPUT-LINUXKD+
      +SDL-AUDIO-DRIVER-PIPEWIRE-DYNAMIC+ +_MM_DENORMALS_ZERO_MASK+
      +__GLIBC_USE_IEC_60559_BFP_EXT+ +_MM_DENORMALS_ZERO_OFF+
      +SDL-AUDIO-DRIVER-PIPEWIRE+ +SDL-AUDIO-DRIVER-SNDIO+
      +__GLIBC_USE_IEC_60559_BFP_EXT_C2X+ +SDL-AUDIO-DRIVER-PULSEAUDIO+
      +SDL-BIG-ENDIAN+ +SDL-AUDIO-DRIVER-DISK+ +SDL-BYTEORDER+
      +SDL-AUDIO-DRIVER-ALSA+ +SDL-HINT-RENDER-BATCHING+
      +SDL-HINT-MOUSE-AUTO-CAPTURE+
      +SDL-HINT-WINDOW-FRAME-USABLE-WHILE-CURSOR-HIDDEN+ +SDL-AUDIO-DRIVER-OSS+
      +SDL-HINT-NO-SIGNAL-HANDLERS+ +__GLIBC_USE_IEC_60559_EXT+
      +SDL-AUDIO-DRIVER-DUMMY+ +SDL-HINT-ROG-GAMEPAD-MICE-EXCLUDED+
      +HAVE-LIBUDEV-H+ +HAVE-IMMINTRIN-H+ +__GLIBC_USE_IEC_60559_FUNCS_EXT+
      +SDL-LIL-ENDIAN+ +HAVE-LIBDECOR-H+ +SDL-HINT-RPI-VIDEO-LAYER+
      +__GLIBC_USE_IEC_60559_FUNCS_EXT_C2X+ +HAVE-LIBSAMPLERATE-H+
      +SDL-HINT-RENDER-OPENGL-SHADERS+ +SDL-VIDEO-DRIVER-KMSDRM+
      +SDL-HINT-RENDER-SCALE-QUALITY+ +SDL-VIDEO-DRIVER-X11+
      +__GLIBC_USE_IEC_60559_TYPES_EXT+ +SDL-HINT-MOUSE-TOUCH-EVENTS+
      +SDL-HINT-RENDER-DRIVER+ +SDL-VIDEO-DRIVER-X11-XCURSOR+
      +SDL-VIDEO-DRIVER-OFFSCREEN+ +SDL-HINT-MOUSE-RELATIVE-MODE-WARP+
      +SDL-HINT-RENDER-VSYNC+ +SDL-BLIT-SCALED+ +SDL-HINT-RETURN-KEY-HIDES-IME+
      +SDL-VIDEO-DRIVER-DUMMY+ +SDL-HINT-ROG-GAMEPAD-MICE+
      +SDL-VIDEO-DRIVER-WAYLAND-QT-TOUCH+ +____MBSTATE_T_DEFINED+
      +SDL-VIDEO-DRIVER-WAYLAND+ +SDL-BLIT-SURFACE+ +_____FPOS_T_DEFINED+
      +SDL-HINT-OPENGL-ES-DRIVER+ +SDL-HINT-RENDER-LOGICAL-SIZE-MODE+
      +SDL-HINT-QTWAYLAND-CONTENT-ORIENTATION+ +SDL-THREAD-PTHREAD+
      +SDL-HINT-RENDER-METAL-PREFER-LOW-POWER-DEVICE+
      +SDL-HINT-RENDER-DIRECT3D-THREADSAFE+ +SDL-LOADSO-DLOPEN+
      +SDL-THREAD-PTHREAD-RECURSIVE-MUTEX+ +SDL-TIMER-UNIX+
      +SDL-HINT-MOUSE-DOUBLE-CLICK-RADIUS+ +SDL-JOYSTICK-VIRTUAL+
      +SDL-ALPHA-OPAQUE+ +SDL-JOYSTICK-HIDAPI+ +_____FPOS64_T_DEFINED+
      +SDL-SENSOR-DUMMY+ +SDL-ALPHA-TRANSPARENT+ +SDL-HAPTIC-LINUX+
      +SDL-HINT-PS2-DYNAMIC-VSYNC+ +UINT-LEAST32-MAX+
      +SDL-HINT-RENDER-LINE-METHOD+ +UINT-LEAST16-MAX+ +INT-FAST8-MIN+
      +UINT-LEAST64-MAX+ +INT-FAST32-MIN+ +INT-FAST16-MIN+ +INT-FAST16-MAX+
      +INT-FAST64-MIN+ +INT-FAST8-MAX+ +INT-LEAST16-MIN+ +_MM512_CVTPS_PH+
      +_MM512_MASKZ_CVTPS_PH+ +INT-LEAST8-MIN+ +_MM512_MASK_CVTPS_PH+
      +INT-LEAST64-MIN+ +INT-LEAST32-MIN+ +INT-LEAST32-MAX+ +INT-LEAST16-MAX+
      +INT-LEAST8-MAX+ +UINT-LEAST8-MAX+ +INT-LEAST64-MAX+ +INT8-MAX+
      +_FEATURES_H+ +INT64-MIN+ +__USE_ISOC11+
      +SDL-HINT-MOUSE-RELATIVE-SYSTEM-SCALE+
      +SDL-HINT-MOUSE-RELATIVE-WARP-MOTION+ +SDL-HAVE-LIBDECOR-GET-MIN-MAX+
      +INT32-MAX+ +_SYS_TYPES_H+ +INT16-MAX+ +UINT8-MAX+ +UINT16-MAX+
      +__USE_POSIX+ +INT64-MAX+ +SDL-HINT-MOUSE-RELATIVE-SCALING+
      +__USE_POSIX2+ +UINT64-MAX+ +__USE_ISOC99+
      +SDL-HINT-MOUSE-DOUBLE-CLICK-TIME+ +__USE_ISOC95+
      +SDL-HINT-MOUSE-RELATIVE-SPEED-SCALE+ +UINT32-MAX+
      +SDL-HINT-MOUSE-NORMAL-SPEED-SCALE+ +SDL-HINT-PREFERRED-LOCALES+
      +SDL-HINT-MOUSE-FOCUS-CLICKTHROUGH+ +INT32-MIN+ +SDL-HINT-ORIENTATIONS+
      +INT16-MIN+ +INT8-MIN+ +WINT-MAX+ +INTMAX-MIN+ +INTMAX-MAX+ +UINTMAX-MAX+
      +PTRDIFF-MIN+ +SIG-ATOMIC-MIN+ +PTRDIFF-MAX+ +SIG-ATOMIC-MAX+ +SIZE-MAX+
      +WINT-MIN+ +INT-FAST32-MAX+ +INT-FAST64-MAX+ +UINT-FAST8-MAX+
      +UINT-FAST16-MAX+ +UINT-FAST32-MAX+ +INTPTR-MIN+ +UINT-FAST64-MAX+
      +INTPTR-MAX+ +SDL-HINT-WINDOWS-DPI-SCALING+ +UINTPTR-MAX+ +_CMP_NEQ_OQ+
      +_ATFILE_SOURCE+ +_CMP_GE_OS+ +_CMP_NGT_US+ +_CMP_NGE_US+ +_CMP_FALSE_OQ+
      +SDL-HINT-WINDOWS-NO-CLOSE-ON-ALT-F4+
      +SDL-HINT-WINDOW-NO-ACTIVATION-WHEN-SHOWN+
      +SDL-HINT-WINDOWS-INTRESOURCE-ICON-SMALL+ +SDL-HINT-WINDOWS-USE-D3D9EX+
      +_CMP_ORD_Q+ +__WORDSIZE+ +_CMP_EQ_UQ+ +_CMP_NLT_US+
      +__WORDSIZE_TIME64_COMPAT32+ +SDL-HINT-DIRECTINPUT-ENABLED+
      +__SYSCALL_WORDSIZE+ +SDL-HINT-WINDOWS-DPI-AWARENESS+ +_CMP_NLE_US+
      +_CMP_UNORD_Q+ +SDL-HINT-X11-FORCE-OVERRIDE-REDIRECT+ +_CMP_NEQ_UQ+
      +SDL-HINT-XINPUT-ENABLED+ +_CMP_EQ_OQ+ +_CMP_LE_OS+ +_POSIX_SOURCE+
      +_CMP_LT_OS+ +_POSIX_C_SOURCE+ +SDL-HINT-WINRT-HANDLE-BACK-BUTTON+
      +SDL-HINT-WINRT-PRIVACY-POLICY-LABEL+ +__USE_POSIX_IMPLICITLY+
      +SDL-HINT-WINRT-PRIVACY-POLICY-URL+ +SDL-HINT-WAVE-FACT-CHUNK+
      +_CMP_GT_OQ+ +_CMP_TRUE_US+ +SDL-HINT-WINDOWS-ENABLE-MENU-MNEMONICS+
      +_CMP_NEQ_OS+ +SDL-HINT-WAVE-RIFF-CHUNK-SIZE+ +SDL-HINT-WAVE-TRUNCATION+
      +_CMP_GE_OQ+ +_CMP_NGE_UQ+ +SDL-HINT-VIDEO-X11-WINDOW-VISUALID+
      +_CMP_NGT_UQ+ +SDL-HINT-VIDEO-X11-XINERAMA+ +SDL-HINT-VIDEO-X11-XRANDR+
      +_CMP_FALSE_OS+ +_CMP_ORD_S+ +SDL-HINT-VIDEO-X11-XVIDMODE+ +_CMP_EQ_US+
      +SDL-HINT-WINDOWS-ENABLE-MESSAGELOOP+
      +SDL-HINT-WINDOWS-FORCE-SEMAPHORE-KERNEL+
      +SDL-HINT-WINDOWS-FORCE-MUTEX-CRITICAL-SECTIONS+ +_CMP_NLT_UQ+
      +__TIMESIZE+ +_CMP_NLE_UQ+ +SDL-HAT-LEFTUP+
      +SDL-HINT-WINDOWS-INTRESOURCE-ICON+ +SDL-HAT-LEFTDOWN+ +_CMP_UNORD_S+
      +_CMP_NEQ_US+ +SDL-HINT-WINDOWS-DISABLE-THREAD-NAMING+ +_CMP_EQ_OS+
      +_CMP_LT_OQ+ +_CMP_LE_OQ+ +_CMP_GT_OS+ +_STDC_PREDEF_H+ +_CMP_TRUE_UQ+
      +SDL-HINT-VIDEO-WAYLAND-MODE-EMULATION+
      +SDL-HINT-VIDEO-WINDOW-SHARE-PIXEL-FORMAT+ +__USE_MISC+
      +SDL-HINT-VIDEO-WAYLAND-EMULATE-MOUSE-WARP+
      +SDL-HINT-VIDEO-MINIMIZE-ON-FOCUS-LOSS+ +__USE_ATFILE+
      +SDL-HINT-VIDEO-MAC-FULLSCREEN-SPACES+ +__USE_FORTIFY_LEVEL+
      +SDL-HINT-VIDEO-WAYLAND-PREFER-LIBDECOR+
      +SDL-HINT-VIDEO-WAYLAND-ALLOW-LIBDECOR+ +__USE_POSIX199506+
      +__USE_POSIX199309+ +SDL-HINT-VIDEO-X11-FORCE-EGL+
      +SDL-HINT-VIDEO-X11-NET-WM-PING+ +SDL-HINT-VIDEO-FOREIGN-WINDOW-OPENGL+
      +SDL-HINT-VIDEO-X11-NET-WM-BYPASS-COMPOSITOR+
      +SDL-HINT-VIDEO-EGL-ALLOW-TRANSPARENCY+ +SDL-HINT-TV-REMOTE-AS-JOYSTICK+
      +__USE_XOPEN2K+ +SDL-HINT-VIDEO-EXTERNAL-CONTEXT+
      +SDL-HINT-VIDEO-WIN-D3DCOMPILER+ +__USE_XOPEN2K8+
      +SDL-HINT-VIDEO-FOREIGN-WINDOW-VULKAN+ +SDL-HINT-TIMER-RESOLUTION+
      +SDL-HINT-THREAD-STACK-SIZE+ +SDL-HINT-VIDEO-DOUBLE-BUFFER+
      +SDL-HINT-VITA-TOUCH-MOUSE-DEVICE+ +SDL-HINT-TOUCH-MOUSE-EVENTS+
      +SDL-HINT-THREAD-PRIORITY-POLICY+
      +SDL-HINT-SCREENSAVER-INHIBIT-ACTIVITY-NAME+ +_DEFAULT_SOURCE+
      +SDL-HINT-THREAD-FORCE-REALTIME-TIME-CRITICAL+ +__GLIBC_USE_ISOC2X+
      +__GLIBC_USE_DEPRECATED_SCANF+ +SDL-HINT-VIDEO-HIGHDPI-DISABLED+
      +__GLIBC_USE_DEPRECATED_GETS+ +SDL-HINT-VIDEO-ALLOW-SCREENSAVER+
      +SDL-AUDIOCVT-MAX-FILTERS+ +SDL-AUDIO-ALLOW-SAMPLES-CHANGE+
      +SDL-AUDIO-ALLOW-CHANNELS-CHANGE+ +SDL-AUDIO-ALLOW-FORMAT-CHANGE+
      +SDL-AUDIO-ALLOW-FREQUENCY-CHANGE+ +SDL-AUDIO-ALLOW-ANY-CHANGE+
      +AUDIO-F32+ +AUDIO-F32MSB+ +AUDIO-F32LSB+ +AUDIO-S32+ +AUDIO-S32MSB+
      +AUDIO-F32SYS+ +AUDIO-S32SYS+ +AUDIO-S16SYS+ +AUDIO-U16SYS+
      +SDL-DATA-ALIGNED+ +AUDIO-S32LSB+ +AUDIO-S16+ +SDL-WINDOWPOS-CENTERED+
      +SDL-WINDOWPOS-CENTERED-MASK+ +SDL-WINDOWPOS-UNDEFINED+
      +SDL-WINDOWPOS-UNDEFINED-MASK+ +DECIMAL-DIG+ +FLT-DIG+
      +__RETURNS_NONNULL+ +DBL-DIG+ +LDBL-DIG+ +FLT-MIN-EXP+ +__ALWAYS_INLINE+
      +DBL-MIN-EXP+ +LDBL-MIN-EXP+ +FLT-MIN-10-EXP+ +DBL-MIN-10-EXP+
      +__ATTRIBUTE_WARN_UNUSED_RESULT__+ +LDBL-MIN-10-EXP+ +FLT-MAX-EXP+
      +DBL-MAX-EXP+ +__ATTRIBUTE_ARTIFICIAL__+ +LDBL-MAX-EXP+ +FLT-MAX-10-EXP+
      +DBL-MAX-10-EXP+ +__FORTIFY_FUNCTION+ +LDBL-MAX-10-EXP+ +__RESTRICT_ARR+
      +__EXTERN_ALWAYS_INLINE+ +FLT-MAX+ +DBL-MAX+ +__EXTERN_INLINE+ +LDBL-MAX+
      +__ATTRIBUTE_NOINLINE__+ +__ATTRIBUTE_DEPRECATED__+ +FLT-EVAL-METHOD+
      +FLT-ROUNDS+ +FLT-RADIX+ +FLT-MANT-DIG+ +LDBL-MANT-DIG+ +DBL-MANT-DIG+
      +__HAVE_GENERIC_SELECTION+ +__LDOUBLE_REDIRECTS_TO_FLOAT128_ABI+
      +BYTE-ORDER+ +LITTLE-ENDIAN+ +PDP-ENDIAN+ +BIG-ENDIAN+ +__BYTE_ORDER+
      +_BITS_ENDIANNESS_H+ +__FLOAT_WORD_ORDER+ +__LITTLE_ENDIAN+
      +_BITS_ENDIAN_H+ +__PDP_ENDIAN+ +__BIG_ENDIAN+ +_ENDIAN_H+
      +__BIT_TYPES_DEFINED__+ +__DEFAULT_FN_ATTRS_F+ +_BITS_STDINT_INTN_H+
      +__DEFAULT_FN_ATTRS_INT8+ +__DEFAULT_FN_ATTRS_TILE+
      +__DEFAULT_FN_ATTRS_FP16+ +__DEFAULT_FN_ATTRS_BF16+ +__GLIBC_MINOR__+
      +__GLIBC__+ +_SYS_CDEFS_H+ +__STDC_IEC_60559_COMPLEX__+
      +__STDC_IEC_559_COMPLEX__+ +__GNU_LIBRARY__+ +__STDC_ISO_10646__+
      +__STDC_IEC_559__+ +__PCONFIG_KEY_PROGRAM+ +__STDC_IEC_60559_BFP__+
      +SDL-ICONV-ERROR+ +__TIMER_T_DEFINED+ +__FLEXARR+
      +__GLIBC_C99_FLEXARR_AVAILABLE+ +__TIME_T_DEFINED+ +HAS-BROKEN-BSWAP+
      +HAS-BUILTIN-BSWAP64+ +__CLOCKID_T_DEFINED+ +HAS-BUILTIN-BSWAP32+
      +__CLOCK_T_DEFINED+ +__PTR_T+ +__THROW+ +__THROWNL+
      +SDL-SCOPED-CAPABILITY+ +_STRUCT_TIMESPEC+ +_SIGSET_NWORDS+
      +__TIMEVAL_DEFINED+ +FD-SETSIZE+ +NFDBITS+ +_BITS_TYPES___LOCALE_T_H+
      +__NFDBITS+ +__ATTRIBUTE_CONST__+ +__ATTRIBUTE_PURE__+
      +HAS-BUILTIN-BSWAP16+ +__ATTRIBUTE_USED__+ +SDL-FLOATWORDORDER+
      +_SYS_SELECT_H+ +__ATTRIBUTE_MAYBE_UNUSED__+ +__SIGSET_T_DEFINED+
      +__ATTRIBUTE_MALLOC__+ +_BITS_TYPES_LOCALE_T_H+ +_STRING_H+
      +SDL-HAT-RIGHTDOWN+ +SDL-HAT-RIGHTUP+ +SDL-HAT-LEFT+
      +_BITS_UINTN_IDENTITY_H+ +__DEFAULT_FN_ATTRS_VL256+
      +__DEFAULT_FN_ATTRS_Z+ +__DEFAULT_FN_ATTRS_Y+
      +__DEFAULT_FN_ATTRS_COMPLEX+ +__DEFAULT_FN_ATTRS_VL128+
      +__DEFAULT_FN_ATTRS_Z_MASK+ +_BITS_BYTESWAP_H+ +PR-II-FAST64+
      +_STRINGS_H+ +PR-II-FAST32+ +PR-II-FAST16+ +PR-II-FAST8+ +PR-IO-LEAST8+
      +SDL-VIRTUAL-JOYSTICK-DESC-VERSION+ +PR-IO64+ +PR-IO32+ +PR-IO16+
      +PR-IO8+ +PR-II32+ +PR-II16+ +PR-II8+ +PR-ID-FAST64+ +PR-ID-FAST32+
      +PR-II-LEAST64+ +PR-II-LEAST32+ +PR-II-LEAST16+ +PR-II-LEAST8+ +PR-II64+
      +PR-IU-LEAST64+ +PR-IU-LEAST16+ +__DEFAULT_FN_ATTRS512+ +PR-IU-LEAST32+
      +PR-IU-LEAST8+ +PR-IU64+ +_MM512_SETZERO_EPI32+ +PR-IU-FAST64+
      +PR-IU-FAST32+ +PR-IU-FAST16+ +PR-IU-FAST8+ +PR-IO-FAST16+ +PR-IO-FAST8+
      +_M_+ +PR-IO-LEAST64+ +PR-IO-LEAST16+ +PR-IO-LEAST32+ +_M_PSADBW+
      +PR-IU32+ +PR-IU8+ +PR-IU16+ +PR-IO-FAST64+ +PR-IO-FAST32+ +SDL-FUNCTION+
      +PRIX16+ +PRIX8+ +PRIX32+ +PR-IX-FAST32+ +PR-IX-FAST64+ +PRIXLEAST32+
      +PRIXLEAST16+ +SDL-ASSERT-LEVEL+ +PRIX64+ +_MM512_SETZERO+ +PRIXLEAST8+
      +PR-IX64+ +SDL-JOYSTICK-AXIS-MAX+ +SDL-JOYSTICK-AXIS-MIN+ +PR-IX-LEAST8+
      +PR-IX16+ +SDL-HAT-UP+ +PR-IX8+ +SDL-HAT-RIGHT+ +PR-IX32+ +PR-IX-FAST8+
      +SDL-NULL-WHILE-LOOP-CONDITION+ +SDL-HAT-CENTERED+ +PR-IX-FAST16+
      +SDL-LINE+ +PR-IX-LEAST32+ +PR-IX-LEAST16+ +PR-IX-LEAST64+ +SDL-FILE+
      +SDL-HAT-DOWN+ +SDL-BUTTON-X1+ +SDL-BUTTON-RIGHT+ +SDL-BUTTON-LEFT+
      +_M_PACKSSWB+ +_M_PACKSSDW+ +_M_PACKUSWB+ +_M_PUNPCKHBW+ +_M_PUNPCKHWD+
      +_M_EMPTY+ +_M_FROM_INT+ +_M_FROM_INT64+ +SDL-BUTTON-MIDDLE+ +_M_TO_INT+
      +_M_TO_INT64+ +SDL-BUTTON-RMASK+ +SDL-BUTTON-MMASK+ +SDL-BUTTON-LMASK+
      +SDL-BUTTON-X2+ +SDL-BUTTON-X2MASK+ +SDL-BUTTON-X1MASK+ +_ALLOCA_H+
      +__RELAXED_FN_ATTRS+ +_BITS_WCHAR_H+ +__WCHAR_MAX+ +__WINT_T_DEFINED+
      +__WCHAR_MIN+ +__MBSTATE_T_DEFINED+ +_WINT_T+ +WCHAR-MIN+ +WEOF+
      +WCHAR-MAX+ +SDL-IPHONE-MAX-GFORCE+ +_M_PCMPGTD+ +__INLINE__+ +_M_POR+
      +_M_PXOR+ +_M_PSRLQI+ +_M_PANDN+ +_M_PAND+ +_M_PCMPGTB+ +_M_PCMPEQD+
      +_M_PCMPGTW+ +_M_PCMPEQB+ +_M_PCMPEQW+ +_M_PSUBW+ +_M_PSUBB+ +_M_PADDUSW+
      +_MM_MASKZ_CVTPS_PH+ +_M_PADDUSB+ +_MM_MASK_CVTPS_PH+ +_M_PSUBUSW+
      +_M_PSUBUSB+ +_M_PSUBSW+ +_M_PSUBSB+ +_M_PSUBD+ +_M_PUNPCKLDQ+
      +SDL-INLINE+ +_M_PUNPCKLWD+ +_M_PUNPCKLBW+ +_M_PUNPCKHDQ+
      +_MM256_MASKZ_CVTPS_PH+ +_M_PADDSW+ +_M_PADDSB+ +SDL-FORCE-INLINE+
      +_M_PADDD+ +_M_PADDW+ +_MM256_MASK_CVTPS_PH+ +_M_PADDB+ +_M_PSRADI+
      +_M_PSRLW+ +_M_PSRAD+ +NULL+ +_M_PSRAWI+ +SDL-FALLTHROUGH+ +_M_PSRAW+
      +SDL-HAS-FALLTHROUGH+ +_M_PSRLQ+ +_M_PSRLDI+ +_M_PSRLD+ +SIZEOF-VOIDP+
      +_M_PSRLWI+ +_M_PSLLW+ +HAVE-GCC-ATOMICS+ +_M_PMULLW+ +HAVE-LIBC+
      +_M_PMULHW+ +STDC-HEADERS+ +HAVE-ALLOCA-H+ +_M_PMADDWD+ +HAVE-CTYPE-H+
      +HAVE-FLOAT-H+ +_M_PSLLQI+ +HAVE-ICONV-H+ +_M_PSLLQ+ +HAVE-INTTYPES-H+
      +_M_PSLLDI+ +_M_PSLLWI+ +HAVE-LIMITS-H+ +_M_PSLLD+ +SDL-MAX-SINT64+
      +SDL-MIN-UINT32+ +SDL-MIN-SINT32+ +SDL-MAX-UINT32+ +SDL-MIN-UINT64+
      +SDL-FLT-EPSILON+ +SDL-MIN-SINT64+ +SDL-MAX-UINT64+ +SDL-PR-IU64+
      +SDL-PR-IX64+ +SDL-PR-IS64+ +SDL-PR-IS32+ +SDL-PR-IX32+ +SDL-PRIX32+
      +SDL-PRIX64+ +SDL-PR-IU32+ +_MM_HINT_ET0+ +_MM_HINT_ET1+ +PR-ID-LEAST16+
      +_MM_HINT_T0+ +PR-ID-LEAST32+ +PR-ID-LEAST64+ +PR-ID-FAST8+
      +PR-ID-FAST16+ +PR-ID8+ +PR-ID16+ +PR-ID32+ +PR-ID64+ +PR-ID-LEAST8+
      +____GWCHAR_T_DEFINED+ +__PRI64_PREFIX+ +__PRIPTR_PREFIX+ +_MM_HINT_NTA+
      +_MM_HINT_T1+ +_MM_HINT_T2+ +_STDLIB_H+ +_SIDD_UWORD_OPS+
      +_SIDD_SBYTE_OPS+ +_SIDD_SWORD_OPS+ +_SIDD_CMP_EQUAL_ANY+
      +_SIDD_UBYTE_OPS+ +_CTYPE_H+ +__DEFAULT_FN_ATTRS+ +SC-NX-PTR+
      +SDL-MAX-SINT32+ +SDL-MIN-UINT16+ +SDL-MAX-UINT16+ +SDL-MIN-SINT16+
      +SDL-MAX-UINT8+ +SDL-MAX-SINT16+ +SDL-MIN-UINT8+ +SDL-MIN-SINT8+
      +SDL-SIZE-MAX+ +LDBL-HAS-SUBNORM+ +DBL-HAS-SUBNORM+ +FLT-HAS-SUBNORM+
      +LDBL-DECIMAL-DIG+ +DBL-DECIMAL-DIG+ +__INLINE+ +FLT-DECIMAL-DIG+
      +SDL-RWOPS-JNIFILE+ +LDBL-TRUE-MIN+ +SDL-RWOPS-STDFILE+ +DBL-TRUE-MIN+
      +FLT-TRUE-MIN+ +SDL-RWOPS-WINFILE+ +LDBL-MIN+ +SDL-RWOPS-UNKNOWN+
      +DBL-MIN+ +FLT-MIN+ +LDBL-EPSILON+ +SDL-RWOPS-MEMORY-RO+ +DBL-EPSILON+
      +FLT-EPSILON+ +SDL-RWOPS-MEMORY+ +SDL-MAX-SINT8+ +SDLNET-MAX-UDPCHANNELS+
      +SDLNET-MAX-UDPADDRESSES+ +INADDR-NONE+ +INADDR-ANY+ +INADDR-BROADCAST+
      +INADDR-LOOPBACK+ +_BITS_TYPES_H+ +SDL-NO-THREAD-SAFETY-ANALYSIS+
      +SDL-COMPILEDVERSION+ +_MM_CVTSD_I32+ +_MM_CVTSS_I32+ +SDL-MINOR-VERSION+
      +SDL-MAJOR-VERSION+ +SDL-MUTEX-TIMEDOUT+ +_MM_CVTI64_SD+ +_MM_CVTSD_I64+
      +_XABORT_NESTED+ +_MM_CVTSS_I64+ +_MM_CVTI32_SS+ +_MM_CVTI32_SD+
      +SDL-MUTEX-MAXWAIT+ +_XABORT_DEBUG+ +_XABORT_CONFLICT+ +_XABORT_RETRY+
      +_XABORT_EXPLICIT+ +_XABORT_CAPACITY+ +_XBEGIN_STARTED+ +_MM_CVTI64_SS+
      +__ULONG32_TYPE+ +__SLONG32_TYPE+ +__UWORD_TYPE+ +__U64_TYPE+
      +SDL-PATCHLEVEL+ +__S64_TYPE+ +_BITS_TYPESIZES_H+ +__STD_TYPE+
      +__SYSCALL_ULONG_TYPE+ +__SYSCALL_SLONG_TYPE+ +__S32_TYPE+
      +SDL-ICONV-EINVAL+ +__U16_TYPE+ +__DEFAULT_FN_ATTRS_CONSTEXPR+
      +__S16_TYPE+ +__SLONGWORD_TYPE+ +__U32_TYPE+ +__SQUAD_TYPE+
      +_SIDD_BIT_MASK+ +__ULONGWORD_TYPE+ +__SWORD_TYPE+ +__UQUAD_TYPE+
      +__PID_T_TYPE+ +_SIDD_POSITIVE_POLARITY+ +__OFF64_T_TYPE+
      +SDL-MIX-MAXVOLUME+ +_SIDD_CMP_EQUAL_ORDERED+ +_SIDD_CMP_EQUAL_EACH+
      +__BLKCNT_T_TYPE+ +__RLIM_T_TYPE+ +_SIDD_CMP_RANGES+ +__RLIM64_T_TYPE+
      +_SIDD_LEAST_SIGNIFICANT+ +__FSBLKCNT_T_TYPE+
      +_SIDD_MASKED_NEGATIVE_POLARITY+ +__BLKCNT64_T_TYPE+
      +_SIDD_MASKED_POSITIVE_POLARITY+ +__FSFILCNT_T_TYPE+
      +_SIDD_NEGATIVE_POLARITY+ +__FSBLKCNT64_T_TYPE+ +__UID_T_TYPE+
      +__DEV_T_TYPE+ +_SIDD_UNIT_MASK+ +__INO_T_TYPE+ +__INO64_T_TYPE+
      +__GID_T_TYPE+ +_SIDD_MOST_SIGNIFICANT+ +__NLINK_T_TYPE+ +__MODE_T_TYPE+
      +__OFF_T_TYPE+ +__FSWORD_T_TYPE+ +SDL-NET-MINOR-VERSION+
      +SDL-NET-PATCHLEVEL+ +SDL-NET-MAJOR-VERSION+ +__FSFILCNT64_T_TYPE+
      +SDL-NET-COMPILEDVERSION+ +SDL-INIT-TIMER+ +SDL-INIT-AUDIO+
      +SDL-ICONV-EILSEQ+ +SDL-ICONV-E2BIG+ +SDL-INIT-HAPTIC+
      +SDL-INIT-GAMECONTROLLER+ +SDL-INIT-VIDEO+ +SDL-INIT-JOYSTICK+
      +SDL-INIT-NOPARACHUTE+ +SDL-INIT-EVERYTHING+ +SDL-INIT-EVENTS+
      +SDL-INIT-SENSOR+ +SHAPE-MODE-COLOR-KEY+
      +SHAPE-MODE-REVERSE-BINARIZE-ALPHA+ +SHAPE-MODE-BINARIZE-ALPHA+
      +SHAPE-MODE-DEFAULT+ +SDL-FLIP-VERTICAL+ +SDL-FLIP-HORIZONTAL+
      +SDL-FLIP-NONE+ +SDL-TEXTUREMODULATE-ALPHA+ +SDL-TEXTUREMODULATE-COLOR+
      +SDL-TEXTUREMODULATE-NONE+ +SDL-TEXTUREACCESS-TARGET+
      +SDL-TEXTUREACCESS-STREAMING+ +SDL-TEXTUREACCESS-STATIC+
      +SDL-SCALE-MODE-BEST+ +SDL-SCALE-MODE-LINEAR+ +SDL-SCALE-MODE-NEAREST+
      +SDL-RENDERER-TARGETTEXTURE+ +SDL-RENDERER-PRESENTVSYNC+
      +SDL-RENDERER-ACCELERATED+ +SDL-RENDERER-SOFTWARE+
      +SDL-POWERSTATE-CHARGED+ +SDL-POWERSTATE-CHARGING+
      +SDL-POWERSTATE-NO-BATTERY+ +SDL-POWERSTATE-ON-BATTERY+
      +SDL-POWERSTATE-UNKNOWN+ +SDL-MESSAGEBOX-COLOR-MAX+
    ...
    #<PACKAGE "DUMMY">)
   (EXPORT
    '(SDL-NET-VERSION SDL-TIMER-ID SDL-TIMER-CALLBACK WINDOW-SHAPE-MODE
