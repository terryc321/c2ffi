...
(autowrap:c-include "/usr/include/SDL2/SDL_net.h" 
		    :spec-path #P"/home/terry/code/c2ffi/lib-sdl2-net/spec/")
...
(cffi:define-foreign-library libsdl2-net
  (t (:default "/usr/lib/x86_64-linux-gnu/libSDL2_net")))

(cffi:use-foreign-library libsdl2-net)
